    ...
    tooltips: [
      {
        ...
        title: "次回セッション",
        description:
          "コーチとの面談予定がここに表示されます。Meet リンクからすぐ参加できます。",
      },
      {
        selector: "[data-tour='target-universities']",
        title: "志望校",
        description:
          "登録した志望校のアドミッションポリシーや日程が常に手元に表示されます。",
      },
      {
    ...
    tooltips: [
      {
        ...
        title: "自己分析の木",
        description:
          "AIとの対話で自分の価値観・強み・原体験を 7 ステップで深掘りします。",
      },
      {
        selector: "[data-tour='sa-tab-workshop']",
        title: "ワークショップ",
        description:
          "ステップごとに AI がソクラテス式で質問を重ね、自分の言葉を引き出します。",
      },
    ],
  },
  "/tour/universities": {
    ...
    tooltips: [
      {
        ...
        title: "プロフィール入力",
        description:
          "GPA・英語資格・興味を入れると、合致度の高い大学を自動で並べます。",
      },
    ],
  },
  "/tour/essay/new": {
    ...
    tooltips: [
      {
        ...
        title: "答案入力",
        description:
          "テーマ選択後、ここに答案を書く or 写真でアップロードします。",
      },
      {
        selector: "[data-tour='essay-coach']",
        title: "AIコーチ",
        description:
          "書きながらリアルタイムでヒントをもらえます。志望校 AP に合わせた添削。",
      },
    ],
  },
  "/tour/documents": {
    ...
    tooltips: [
      {
        ...
        title: "書類一覧",
        description:
          "志望理由書・活動報告書など、大学別に必要書類が整理されています。",
      },
    ],
  },
  "/tour/interview/new": {
    ...
    tooltips: [
      {
        ...
        title: "面接モード選択",
        description:
          "個人・集団討論・プレゼンの 3 形式から本番に近いものを選べます。",
      },
      {
