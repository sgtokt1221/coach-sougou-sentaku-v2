...
- **followUpQuestions** (面接 type="interview" のみ、**必ず 2-3 件**): 最初の質問(title)への回答を深掘りする想定質問。授業での面接指導台本として使う。例: ["それを通じて何を学びましたか？", "その経験は志望学部でどう活きますか？", "他に同様の経験はありますか？"]。小論文(type="essay")には付けない。
  ...
  "secondaryQuestions": [
    {
      ...
      "followUpQuestions": ["その経験で最も苦労したことは？", "そこから何を学び、今どう活かしていますか？"]
    }
  ]
}
\`\`\`
