...
- 10: その分野で大事にされている見方を自分の言葉で使い、具体例まで落とし込めている。数十枚に1枚。
- 8: 分野の見方を使えているが、具体例や理由の掘り下げがあと一歩（上位1〜2割）。
- 6: 分野は意識できているが、どの分野にも当てはまる一般論に寄っている。**平均的な答案はここ**。
- 4: その分野ならではの視点が出ていない。
...
- **設問が明示的に求めている要素**（「〜の具体的なシナリオを示せ」「〜を比較せよ」
  ...
  この場合 logic と apAlignment は **4点を上限**とする。
${wordLimitRule}
