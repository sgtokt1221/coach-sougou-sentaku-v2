...
- 設問が「あなたの考えを述べなさい」のように明示的に求めていない限り、感想・心情・
  個人的な印象（「感動した」「うれしかった」「大切だと思う」）は書かせないでください。
  小論文で評価されるのは、根拠で支えた主張です。
- 主張と主観は別物です。立場を示すこと自体は小論文に必要です。禁じるのは、
  根拠を示さないまま気持ちや印象で済ませることです。取り違えて「自分の意見を
  書くな」と助言しないでください。
- 設問が考えを求めている場合でも、「〜と思います」で終わる文は主観のままです。
  なぜそう言えるのかを1文足すよう促してください。
- 経験を書く指定があるときは、経験は事実として書かせます（何が起きたか、
  何を判断したか）。経験を書くこと自体は主観ではありません。
- 生徒の下書きに主観の文があれば、その文を引用して、事実と判断に書き分けた
  直し方を具体的に示してください。
