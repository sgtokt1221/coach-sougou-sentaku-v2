...
export const PAST_QUESTIONS: PastQuestion[] = [
  // ===== 京都大学 =====
  {
    ...
    theme: "民主主義と多数決原理の限界",
    description:
      "民主主義における多数決原理の正当性と限界について、具体例を挙げながら論じなさい。少数者の権利保障との関係にも言及すること。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "法律",
  },
  {
    ...
    theme: "AIと法的責任",
    description:
      "自律的AI システムが引き起こした損害について、法的責任の所在をどのように考えるべきか論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "法律",
  },
  {
    ...
    theme: "教育における平等と公正",
    description:
      "教育の機会均等とは何か。形式的平等と実質的平等の違いを踏まえ、日本の教育制度の課題を論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "教育",
  },
  {
    ...
    theme: "翻訳と文化理解",
    description:
      "文学作品の翻訳において失われるものと得られるものについて、具体例を挙げて論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "文化",
  ...
  // ===== 東京大学 =====
  {
    ...
    theme: "国際秩序の変容",
    description:
      "冷戦後の国際秩序がどのように変容してきたか。多極化する世界における日本の役割について論じなさい。",
    type: "frequent",
    wordLimit: 600,
    timeLimit: 60,
    field: "国際",
  },
  {
    ...
    theme: "格差社会と再分配",
    description:
      "経済成長と所得格差の関係について、再分配政策の観点から論じなさい。",
    type: "frequent",
    wordLimit: 600,
    timeLimit: 60,
    field: "経済",
  },
  {
    ...
    theme: "科学技術と倫理",
    description:
      "先端科学技術の研究において、研究の自由と社会的責任のバランスをどう取るべきか論じなさい。",
    type: "frequent",
    wordLimit: 600,
    timeLimit: 60,
    field: "倫理",
  ...
  // ===== 大阪大学 =====
  {
    ...
    facultyName: "法学部",
    year: 2024,
    theme: "表現の自由とヘイトスピーチ規制",
    description:
      "表現の自由の保障と差別的表現の規制について、各国の事例を参照しながら論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "法律",
  },
  {
    ...
    theme: "多文化共生社会の課題",
    description:
      "日本における多文化共生社会の実現に向けた課題と方策について論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "社会",
  ...
  // ===== 北海道大学 =====
  {
    ...
    theme: "持続可能な都市開発",
    description:
      "人口減少社会における持続可能な都市開発のあり方について、コンパクトシティの概念を踏まえて論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "環境",
  ...
  {
    id: "pq-tohoku-law-1",
    universityId: "tohoku-u",
    universityName: "東北大学",
    facultyName: "法学部",
    year: 2024,
    theme: "災害と法制度",
    description:
      "大規模自然災害時における法制度の役割と課題について、東日本大震災の経験を踏まえて論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "法律",
  ...
  // ===== 早稲田大学 =====
  {
    ...
    theme: "デジタル民主主義",
    description:
      "デジタル技術の発展が民主主義のあり方にどのような影響を与えるか。メリットとリスクの両面から論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "政治",
  },
  {
    ...
    theme: "記憶と歴史認識",
    description:
      "個人の記憶と集合的記憶の関係について論じ、歴史認識の形成過程を考察しなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "文化",
  },
  {
    ...
    theme: "eスポーツはスポーツか",
    description:
      "eスポーツをスポーツと認めるべきかどうか、スポーツの定義を踏まえて論じなさい。",
    type: "frequent",
    wordLimit: 600,
    timeLimit: 60,
    field: "スポーツ",
  ...
  // ===== 慶應義塾大学 =====
  {
    ...
    facultyName: "法学部",
    year: 2024,
    theme: "プライバシー権とデジタル監視",
    description:
      "デジタル社会におけるプライバシー権の意義と、国家による監視技術の利用について論じなさい。",
    type: "frequent",
    wordLimit: 1000,
    timeLimit: 90,
    field: "法律",
  },
  {
    ...
    universityId: "keio-u",
    universityName: "慶應義塾大学",
    facultyName: "総合政策学部（SFC）",
    year: 2024,
    theme: "社会課題の解決策を提案せよ",
    description:
      "あなたが最も重要だと考える社会課題を一つ選び、その解決に向けた具体的な政策提案を行いなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 120,
    field: "社会",
  },
  {
    ...
    universityId: "keio-u",
    universityName: "慶應義塾大学",
    facultyName: "環境情報学部（SFC）",
    year: 2024,
    theme: "テクノロジーと人間の共存",
    description:
      "AI・ロボット技術の進展が人間の労働・生活・創造性にどのような影響を与えるか論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 120,
    field: "AI・テクノロジー",
  },
  {
    ...
    theme: "円安と日本経済",
    description:
      "近年の円安が日本経済に与える影響について、メリット・デメリットの両面から分析しなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "経済",
  ...
  {
    id: "pq-sophia-gc-1",
    universityId: "sophia-u",
    universityName: "上智大学",
    facultyName: "グローバル・スタディーズ",
    year: 2024,
    theme: "難民問題と国際協力",
    description:
      "世界の難民問題について、受入国の負担と人道的責任のバランスを論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "国際",
  ...
  // ===== 同志社大学 =====
  {
    ...
    year: 2024,
    theme: "異文化理解とコミュニケーション",
    description:
      "グローバル化が進む社会において、異文化間の相互理解を深めるために必要なことは何か論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 60,
    field: "国際",
  },
  {
    ...
    theme: "SNSと名誉毀損",
    description:
      "SNS上の誹謗中傷と表現の自由について、法規制のあるべき姿を論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 60,
    field: "法律",
  ...
  {
    id: "pq-kwansei-soc-1",
    universityId: "kwansei-u",
    universityName: "関西学院大学",
    facultyName: "社会学部",
    year: 2024,
    theme: "多様性と社会的包摂",
    description:
      "多様性を尊重する社会の実現に向けて、日本社会が取り組むべき課題について論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "社会",
  },
  {
    ...
    theme: "サステナブル経営",
    description:
      "企業のサステナビリティ経営が注目される背景と、具体的な取り組み事例を挙げて論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 60,
    field: "経済",
  ...
  {
    id: "pq-kansai-soc-1",
    universityId: "kansai-u",
    universityName: "関西大学",
    facultyName: "社会安全学部",
    year: 2024,
    theme: "防災とコミュニティ",
    description:
      "大規模災害に対する地域コミュニティの備えと、行政との連携のあり方について論じなさい。",
    type: "frequent",
    wordLimit: 600,
    timeLimit: 60,
    field: "社会",
  ...
  // ===== 立命館大学 =====
  {
    ...
    theme: "経済安全保障",
    description:
      "経済安全保障の観点から、日本が直面する課題と今後の方向性について論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 60,
    field: "国際",
  ...
  {
    id: "pq-meiji-bun-1",
    universityId: "meiji-u",
    universityName: "明治大学",
    facultyName: "文学部",
    year: 2024,
    theme: "読書文化の変容",
    description:
      "デジタル時代における読書の意義と、読書文化の変容について論じなさい。",
    type: "frequent",
    wordLimit: 600,
    timeLimit: 60,
    field: "文化",
  },
  {
    ...
    theme: "若者の政治参加",
    description:
      "18歳選挙権導入後の若者の政治参加の現状と課題について、投票率向上の方策を含めて論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 60,
    field: "政治",
  ...
  {
    id: "pq-aoyama-com-1",
    universityId: "aoyama-u",
    universityName: "青山学院大学",
    facultyName: "コミュニティ人間科学部",
    year: 2024,
    theme: "地域の居場所づくり",
    description:
      "地域において人々が安心して過ごせる「居場所」をどのように創出していくべきか論じなさい。",
    type: "frequent",
    wordLimit: 600,
    timeLimit: 60,
    field: "地域",
  ...
  {
    id: "pq-rikkyo-soc-1",
    universityId: "rikkyo-u",
    universityName: "立教大学",
    facultyName: "社会学部",
    year: 2024,
    theme: "メディアリテラシー",
    description:
      "フェイクニュースが社会に与える影響と、メディアリテラシー教育の重要性について論じなさい。",
    type: "frequent",
    wordLimit: 600,
    timeLimit: 60,
    field: "メディア",
  ...
  // ===== 中央大学 =====
  {
    ...
    theme: "少年法の適用年齢引き下げ",
    description:
      "少年法の適用年齢引き下げの是非について、更生と処罰の観点から論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 60,
    field: "法律",
  ...
  {
    id: "pq-hosei-env-1",
    universityId: "hosei-u",
    universityName: "法政大学",
    facultyName: "人間環境学部",
    year: 2024,
    theme: "気候変動と世代間公平",
    description:
      "気候変動問題における世代間公平の観点から、現世代の責任と将来世代への配慮について論じなさい。",
    type: "frequent",
    wordLimit: 600,
    timeLimit: 60,
    field: "環境",
  ...
  {
    id: "pq-kindai-sci-1",
    universityId: "kindai-u",
    universityName: "近畿大学",
    facultyName: "理工学部",
    year: 2024,
    theme: "再生可能エネルギーの可能性と課題",
    description:
      "日本における再生可能エネルギーの普及促進に向けた技術的・制度的課題について論じなさい。",
    type: "frequent",
    wordLimit: 600,
    timeLimit: 60,
    field: "科学技術",
  ...
  {
    id: "pq-konan-eco-1",
    universityId: "konan-u",
    universityName: "甲南大学",
    facultyName: "経済学部",
    year: 2024,
    theme: "キャッシュレス社会",
    description:
      "キャッシュレス決済の普及が社会に与える影響について、メリットとデメリットの両面から論じなさい。",
    type: "frequent",
    wordLimit: 600,
    timeLimit: 60,
    field: "経済",
  ...
  {
    id: "pq-ryukoku-soc-1",
    universityId: "ryukoku-u",
    universityName: "龍谷大学",
    facultyName: "社会学部",
    year: 2024,
    theme: "孤独・孤立問題",
    description:
      "現代日本における孤独・孤立問題の実態と、社会全体での対策について論じなさい。",
    type: "frequent",
    wordLimit: 600,
    timeLimit: 60,
    field: "福祉",
  ...
  {
    id: "pq-kyosan-biz-1",
    universityId: "kyoto-sangyo-u",
    universityName: "京都産業大学",
    facultyName: "経営学部",
    year: 2024,
    theme: "ソーシャルビジネス",
    description:
      "社会課題の解決とビジネスの両立について、ソーシャルビジネスの具体例を挙げて論じなさい。",
    type: "frequent",
    wordLimit: 600,
    timeLimit: 60,
    field: "経済",
  ...
  // ===== 九州大学 =====
  {
    ...
    facultyName: "工学部",
    year: 2024,
    theme: "カーボンニュートラル実現への技術的アプローチ",
    description:
      "2050年カーボンニュートラル実現に向けて、工学的にどのようなアプローチが可能か論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "環境",
  ...
  // ===== 名古屋大学 =====
  {
    ...
    theme: "個人情報保護とデータ利活用",
    description:
      "ビッグデータの利活用と個人情報保護のバランスについて、具体的な事例を踏まえて論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "AI・テクノロジー",
  ...
  // 法学部
  {
    id: "pq-cross-law-1",
    universityId: "",
    universityName: "全大学共通",
    facultyName: "法学部",
    year: 2025,
    theme: "一票の格差",
    description:
      "地域ごとの有権者数の差による一票の格差問題について、最高裁判例も踏まえて論じなさい。",
    type: "frequent",
    wordLimit: 800,
    field: "法律",
  },
  {
    ...
    theme: "裁判員制度の是非",
    description:
      "裁判員制度の現状と課題を踏まえ、制度の意義と改善すべき点について論じなさい。",
    type: "frequent",
    wordLimit: 800,
    field: "法律",
  },
  {
    ...
    theme: "死刑制度",
    description:
      "死刑制度のメリット・デメリットを示した上で、あなたの立場を明確にして論じなさい。",
    type: "frequent",
    wordLimit: 800,
    field: "法律",
  },
  ...
  // 経済・経営学部
  {
    ...
    theme: "最低賃金の引き上げ",
    description:
      "最低賃金の引き上げがもたらすメリット・デメリットを示し、あなたの立場を明確にして論じなさい。",
    type: "frequent",
    wordLimit: 800,
    field: "経済",
  },
  {
    ...
    theme: "教育格差と所得格差",
    description:
      "教育格差が所得格差を再生産するメカニズムについて分析し、その解決策を提案しなさい。",
    type: "frequent",
    wordLimit: 800,
    field: "経済",
  },
  ...
  // 医・看護学部
  {
    ...
    theme: "安楽死・尊厳死",
    description:
      "終末期医療における安楽死・尊厳死の是非について、患者の自己決定権と生命倫理の観点から論じなさい。",
    type: "frequent",
    wordLimit: 800,
    field: "医療",
  },
  {
    ...
    theme: "医師の地域偏在",
    description:
      "大都市集中と地方の医師不足の問題について、具体的な解決策を提案しなさい。",
    type: "frequent",
    wordLimit: 800,
    field: "医療",
  },
  {
    ...
    facultyName: "看護学部",
    year: 2025,
    theme: "チーム医療における看護師の役割",
    description:
      "チーム医療の推進において看護師に求められる素質と役割について論じなさい。",
    type: "frequent",
    wordLimit: 600,
    field: "医療",
  },
  ...
  // 外国語・国際学部
  {
    ...
    theme: "英語の公用語化",
    description:
      "日本で英語を公用語化することのメリット・デメリットについて論じなさい。",
    type: "frequent",
    wordLimit: 800,
    field: "国際",
  },
  {
    ...
    theme: "難民受け入れ問題",
    description:
      "グローバル化と紛争による難民増加に対して、日本はどのように対応すべきか論じなさい。",
    type: "frequent",
    wordLimit: 800,
    field: "国際",
  },
  ...
  // 教育学部
  {
    ...
    facultyName: "教育学部",
    year: 2025,
    theme: "ICT教育のメリット・デメリット",
    description:
      "学校教育におけるICT活用（タブレット端末、電子黒板等）のメリット・デメリットについて論じなさい。",
    type: "frequent",
    wordLimit: 800,
    field: "教育",
  },
  {
    ...
    year: 2025,
    theme: "教員の働き方改革",
    description: "教員の長時間労働問題について、その原因と解決策を論じなさい。",
    type: "frequent",
    wordLimit: 800,
    field: "教育",
  },
  ...
  // 理工学部
  {
    ...
    facultyName: "理工学部",
    year: 2025,
    theme: "ゲノム編集技術の可能性と課題",
    description:
      "ゲノム編集技術（CRISPR-Cas9等）の応用可能性と倫理的課題について論じなさい。",
    type: "frequent",
    wordLimit: 800,
    field: "科学技術",
  },
  ...
  // 農・環境学部
  {
    ...
    theme: "日本の食料自給率",
    description:
      "日本の食料自給率の低下について、その原因と改善策を論じなさい。",
    type: "frequent",
    wordLimit: 600,
    field: "環境",
  },
  ...
  // 芸術学部
  {
    ...
    theme: "AIと芸術創作",
    description:
      "AIが芸術作品を創作することは可能か。人間の創造性とAIの関係について論じなさい。",
    type: "frequent",
    wordLimit: 600,
    field: "芸術",
  },
  ...
  // スポーツ学部
  {
    ...
    theme: "ドーピング問題",
    description:
      "スポーツにおけるドーピング問題と、パラスポーツにおける補助器具の改良の限度について論じなさい。",
    type: "frequent",
    wordLimit: 600,
    field: "スポーツ",
  },
  ...
  // ===== 英文読解型 =====
  {
    ...
    description:
      "以下の英文を読み、法の支配と民主主義の関係について、筆者の主張を踏まえて日本語800字以内で論じなさい。",
    type: "past",
...

  {
    ...
    description:
      "Read the following passage and answer in Japanese (600 words): What are the key human rights challenges posed by AI, and how should society address them?",
    type: "past",
    questionType: "english-reading",
    wordLimit: 600,
    timeLimit: 90,
...

  {
    ...
    description:
      "以下の英文を読んで、グローバル化が文化的アイデンティティに与える影響について、あなたの考えを日本語600字以内で述べなさい。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 600,
    timeLimit: 60,
...

  {
    ...
    description:
      "Read the passage below and discuss in Japanese (800 words): To what extent do current generations have an obligation to future generations regarding climate change?",
    type: "past",
    questionType: "english-reading",
    wordLimit: 800,
    timeLimit: 90,
...

  {
    ...
    description:
      "以下の英文を読み、言語教育の将来について、AIの影響を踏まえて日本語600字以内で論じなさい。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 600,
    timeLimit: 60,
  ...
  // ===== 資料・データ読解型 =====
  {
    ...
    description:
      "以下のデータを読み取り、日本の人口構造の変化が社会保障制度に与える影響と、今後の対策について800字以内で論じなさい。",
    type: "past",
...

  {
    ...
    description:
      "以下の資料を分析し、世界のエネルギー政策の課題と日本が果たすべき役割について600字以内で論じなさい。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 600,
    timeLimit: 60,
    ...
    chartData: [
      ...
      },
      {
        ...
        data: [
          ...
          { name: "水力", value: 7.1 },
          { name: "原子力", value: 5.6 },
          { name: "その他再エネ", value: 4.9 },
          { name: "その他", value: 2.1 },
        ],
        yKeys: [
          { key: "value", name: "LNG", color: "#6366F1" },
          { key: "value", name: "石炭", color: "#374151" },
          { key: "value", name: "石油", color: "#F59E0B" },
          { key: "value", name: "太陽光", color: "#FBBF24" },
          { key: "value", name: "水力", color: "#3B82F6" },
          { key: "value", name: "原子力", color: "#10B981" },
          { key: "value", name: "その他再エネ", color: "#34D399" },
...

  {
    ...
    description:
      "以下のデータから読み取れる日本経済の課題を分析し、賃金上昇のために必要な政策を800字以内で提案しなさい。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 90,
    ...
    chartData: [
      ...
      {
        type: "line",
        title: "日本の実質賃金指数（2015年=100）",
        xKey: "year",
        data: [
          { year: "2000", 賃金指数: 107.2 },
          { year: "2010", 賃金指数: 101.3 },
          { year: "2015", 賃金指数: 100.0 },
          { year: "2020", 賃金指数: 98.6 },
          { year: "2023", 賃金指数: 96.1 },
        ],
...

  {
    ...
    description:
      "以下の資料を読み取り、デジタルデバイド（情報格差）の現状と解消に向けた方策を600字以内で論じなさい。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 600,
    timeLimit: 60,
    ...
    chartData: [
      ...
      {
        type: "bar",
        title: "世帯年収別インターネット利用率（%）",
        xKey: "income",
        data: [
          { income: "~200万", 利用率: 73.2 },
          { income: "200-400万", 利用率: 85.1 },
          { income: "400-600万", 利用率: 93.7 },
          { income: "600-800万", 利用率: 96.8 },
  ...
  // ===== 複合型（英文＋資料） =====
  {
    ...
    description:
      "以下の英文と資料を読み、SDGsの達成に向けた課題と、テクノロジーの活用による解決策を日本語800字以内で提案しなさい。",
    type: "past",
    questionType: "mixed",
    wordLimit: 800,
    timeLimit: 120,
    ...
    chartData: [
      {
        type: "bar",
        title: "SDGs Progress Index 2024（達成見込み %）",
        xKey: "goal",
        data: [
          { goal: "G1 貧困", 達成率: 68 },
          { goal: "G4 教育", 達成率: 54 },
          { goal: "G7 エネルギー", 達成率: 41 },
          { goal: "G10 不平等", 達成率: 28 },
          { goal: "G13 気候", 達成率: 22 },
          { goal: "G14 海洋", 達成率: 19 },
        ],
  ...
  // ===== 上智大学 =====
  {
    id: "pq-sophia-global-001",
    universityId: "sophia-u",
    universityName: "上智大学",
    facultyName: "総合グローバル学部",
    year: 2020,
    theme: "地質年代の定説変化と学説の衝突",
    description:
      "公募推薦（90分）。以下の課題文を読み、科学の定説がどう変化してきたか、学説の衝突をどう理解すべきかについて、日本語1000字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 90,
  ...
  {
    id: "pq-sophia-foreign-001",
    universityId: "sophia-u",
    universityName: "上智大学",
    facultyName: "外国語学部イスパニア語学科",
    year: 2020,
    theme: "勤勉さの概念と文化的解釈",
    description:
      "公募推薦（90分）。以下の課題文を読み、勤勉さの概念が文化によってどう異なるか、自身の文化的経験を踏まえて日本語1000字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 90,
  ...
  {
    id: "pq-sophia-foreign-002",
    universityId: "sophia-u",
    universityName: "上智大学",
    facultyName: "外国語学部フランス語学科",
    year: 2020,
    theme: "難民2世が直面する多様な課題",
    description:
      "公募推薦。難民2世が社会で直面するアイデンティティや差別等の課題について論述。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "国際",
  ...
  {
    id: "pq-sophia-law-001",
    universityId: "sophia-u",
    universityName: "上智大学",
    facultyName: "法学部国際関係法学科",
    year: 2020,
    theme: "平和の実現における矛盾",
    description:
      "公募推薦。平和を追求する過程で生じる矛盾について、国際法・国際関係の観点から論述。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "国際",
  ...
  {
    id: "pq-sophia-human-001",
    universityId: "sophia-u",
    universityName: "上智大学",
    facultyName: "総合人間科学部看護学科",
    year: 2020,
    theme: "『覚える』と『分かる』の違い",
    description:
      "公募推薦。『覚える』ことと『分かる』ことの本質的な違いについて、学びの観点から論述。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "教育",
  ...
  {
    id: "pq-sophia-human-002",
    universityId: "sophia-u",
    universityName: "上智大学",
    facultyName: "総合人間科学部社会福祉学科",
    year: 2020,
    theme: "貧困の定義の時代的変化",
    description:
      "公募推薦（90分）。以下の課題文を読み、貧困の定義が時代とともにどう変化してきたか、現代社会における貧困への対応のあり方について日本語1000字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 90,
  ...
  },
  {
    ...
    theme: "愛国心の概念と問題性",
    description:
      "公募推薦（90分）。以下の課題文を読み、愛国心の概念とその問題性について、ジャーナリズムの観点から日本語1000字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 90,
  ...
  {
    id: "pq-sophia-lit-002",
    universityId: "sophia-u",
    universityName: "上智大学",
    facultyName: "文学部ドイツ文学科",
    year: 2020,
    theme: "教養の変遷と現代的課題",
    description:
      "公募推薦。教養の概念がどう変遷してきたか、現代における教養の意義と課題について論述。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "文化",
  },
  {
    ...
    description:
      "公募推薦（90分）。以下の課題文を読み、現代社会において哲学を学ぶことの意義について、あなた自身の経験や関心と結びつけて日本語1000字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 90,
  ...
  },
  {
    ...
    theme: "罪、福音、救済の聖書的解釈",
    description:
      "公募推薦（90分）。以下の課題文を読み、罪・福音・救済という概念が現代社会に問いかけるものについて、日本語1000字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 90,
  ...
  {
    id: "pq-sophia-freq-001",
    universityId: "sophia-u",
    universityName: "上智大学",
    facultyName: "全学部共通",
    year: 2024,
    theme: "異文化理解・国際問題・多様性",
    description:
      "上智大学全体として、異文化理解、国際的課題、多様性に関するテーマが頻出。学科の専門性に応じた切り口で出題。",
    type: "frequent",
    field: "国際",
  },
  {
    id: "pq-sophia-freq-002",
    universityId: "sophia-u",
    universityName: "上智大学",
    facultyName: "全学部共通",
    year: 2024,
    theme: "言語・文化・社会の関係性",
    description:
      "文学部・外国語学部を中心に、言語と文化、社会の相互関係を問うテーマが安定的に出題。",
    type: "frequent",
    field: "文化",
  },
  ...
  // ===== 中央大学 =====
  {
    ...
    theme: "グローバル化とデータ分析",
    description:
      "総合型選抜（自己推薦入試）。以下の資料を読み解き、グローバル化の現状と日本企業が取り組むべき戦略について、社会科学的視点から800字程度で論述しなさい。※サンプル資料は練習用に生成された架空データです。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    theme: "数量データの社会科学的分析",
    description:
      "総合型選抜。以下の課題文を読み、社会科学における数値・数量によるデータ分析の意義と限界、そして経営判断への応用について800字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    theme: "スポーツと社会政策",
    description:
      "スポーツ推薦入学試験。スポーツと社会政策の関連について小論文を執筆。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "社会",
  },
  {
    ...
    theme: "法と社会の現代的課題",
    description:
      "総合型選抜。以下の課題文を読み、法と社会の関係における現代的課題について自身の見解を800字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    facultyName: "全学部共通",
    year: 2024,
    theme: "グローバル化・データリテラシー・政策提案",
    description:
      "国際経営学部と総合政策学部を中心に、グローバル化の課題、データに基づく分析力、政策提案力が問われるテーマが頻出。",
    type: "frequent",
    field: "経済",
  },
  ...
  // ===== 九州大学 =====
  {
    ...
    description:
      "前期日程（180分）。以下の図表資料を分析し、鳥獣被害防止政策の課題を抽出した上で、自分の意見を800字程度で論述しなさい。※サンプル資料は練習用に生成された架空データです。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 180,
  ...
  },
  {
    ...
    theme: "ジェンダーギャップ改善策",
    description:
      "前期日程（180分）。以下の図表資料を分析し、日本のジェンダー格差の現状と改善策について800字程度で論述しなさい。※サンプル資料は練習用に生成された架空データです。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 180,
  ...
  {
    id: "pq-kyushu-kyoso-003",
    universityId: "kyushu-u",
    universityName: "九州大学",
    facultyName: "共創学部",
    year: 2024,
    theme: "総合型選抜: 講義に基づく小論文",
    description:
      "総合型選抜I。100分。人文社会系と自然科学系の2つの講義を受講した上で執筆するレポートと小論文。多角的思考力・論理的記述力を評価。",
    type: "past",
    timeLimit: 100,
    field: "社会",
  },
  {
    id: "pq-kyushu-lit-001",
    universityId: "kyushu-u",
    universityName: "九州大学",
    facultyName: "文学部",
    year: 2024,
    ...
    description:
      "後期日程・小論文I（150分）。以下の課題文を読み、国語が叡智を表現する言語としてどのような意義を持つかについて、800字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 150,
  ...
  },
  {
    ...
    theme: "志望動機（テーマ型小論文）",
    description:
      "後期日程。小論文II: 90分、テーマ型（人文系）。志望動機に関する論述。",
    type: "past",
    timeLimit: 90,
    field: "文化",
  },
  {
    id: "pq-kyushu-econ-001",
    universityId: "kyushu-u",
    universityName: "九州大学",
    facultyName: "経済学部（経済・経営学科）",
    year: 2024,
    theme: "経済史における経済成長の条件",
    description:
      "後期日程（180分）。以下の英文を読み、長期的経済成長の条件について、制度や所有権の観点から日本語1000字程度で論述しなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 1000,
    timeLimit: 180,
  ...
  },
  {
    ...
    theme: "芸術と経済学の交差点",
    description:
      "後期日程（180分）。以下の英文を読み、芸術活動を経済学的に分析することの意義と限界について日本語1000字程度で論述しなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 1000,
    timeLimit: 180,
  ...
  },
  {
    ...
    description:
      "後期日程（180分）。以下の英文を読み、人工光が生態系と人間の健康に及ぼす影響について日本語1000字程度で論述しなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 1000,
    timeLimit: 180,
  ...
  {
    id: "pq-kyushu-freq-001",
    universityId: "kyushu-u",
    universityName: "九州大学",
    facultyName: "共創学部",
    year: 2025,
    theme: "持続可能な社会の実現に向けた学際的アプローチ",
    description:
      "共創学部の頻出テーマ。環境・社会・経済の統合的視点、SDGs、地域課題と国際課題の接続などが問われる。",
    type: "frequent",
    timeLimit: 100,
    field: "社会",
  },
  ...
  // ===== 京都大学 =====
  {
    ...
    theme: "災害対策と社会的資源",
    description:
      "特色入試。以下の課題文を読み、(1)筆者の主張を400字程度で要約しなさい、(2)社会が災害に備えるために必要な資源について、あなたの考えを2,000字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 2400,
    field: "社会",
  ...
  },
  {
    ...
    theme: "言語のジレンマ",
    description:
      "特色入試。以下の課題文を読み、言語がもたらす「ジレンマ」について、あなた自身の関心や経験と結びつけて日本語1,200字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1600,
    field: "文化",
  ...
  },
  {
    ...
    description:
      "特色入試。以下の課題文を読み、歴史における個人と全体の関係について、あなたの関心と結びつけて日本語1,200字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1600,
    field: "文化",
  ...
  },
  {
    ...
    theme: "教育と人間形成に関する論述",
    description:
      "特色入試。2025年度は資料集が廃止され英語長文が削除、字数が増加（2,000〜2,500字）。以下の課題文を読み、教育が人間形成に果たす役割について、心・社会との関係を踏まえつつ日本語2,000字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 2500,
    field: "教育",
  ...
  },
  {
    ...
    description:
      "特色入試。以下の英文を読み、家族関係への国家介入の正当性と限界について日本語1500字程度で論述しなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 1500,
    field: "法律",
  ...
  },
  {
    ...
    universityId: "kyoto-u",
    universityName: "京都大学",
    facultyName: "医学部人間健康科学科",
    year: 2024,
    theme: "医療倫理とコミュニケーション",
    description:
      "特色入試。以下の課題文（日本語抜粋）を読み、医療現場におけるコミュニケーションのあり方と障害観について、日本語2,000字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 2500,
    field: "医療",
  ...
  },
  {
    ...
    description:
      "特色入試。以下の課題文を読み、創薬研究における化学とバイオインフォマティクスの統合について日本語800字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    field: "科学",
  ...
  },
  {
    ...
    universityId: "kyoto-u",
    universityName: "京都大学",
    facultyName: "農学部応用生命科学科",
    year: 2024,
    theme: "科学技術のメリット・デメリット",
    description: "科学技術の利点と課題について論じる。具体的字数指定なし。",
    type: "past",
    field: "科学",
  },
  {
    ...
    universityId: "kyoto-u",
    universityName: "京都大学",
    facultyName: "農学部森林科学科",
    year: 2025,
    theme: "環境・生態系と森林保全",
    description:
      "特色入試。以下の英文を読み、気候変動時代における森林生態系の保全戦略について日本語800字程度で論述しなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 800,
    field: "環境",
  ...
  },
  {
    ...
    universityId: "kyoto-u",
    universityName: "京都大学",
    facultyName: "農学部食料・環境経済学科",
    year: 2025,
    theme: "食料問題と環境経済",
    description:
      "特色入試。以下の英文を読み、持続可能な食料システムを構築する上での経済的課題と政策的選択肢について日本語800字程度で論述しなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 800,
    field: "環境",
  ...
  // ===== 京都産業大学 =====
  {
    id: "pq-kyoto-sangyo-law-001",
    universityId: "kyoto-sangyo-u",
    universityName: "京都産業大学",
    facultyName: "法学部",
    year: 2024,
    theme: "性犯罪者へのGPS装着の是非",
    description:
      "総合型選抜。法的・倫理的観点から性犯罪者へのGPS装着義務について論じる。人権と公共の安全のバランスが問われる。",
    type: "past",
    field: "法律",
  },
  {
    id: "pq-kyoto-sangyo-general-001",
    universityId: "kyoto-sangyo-u",
    universityName: "京都産業大学",
    facultyName: "全学部",
    year: 2024,
    theme: "面接・小論文・プレゼンテーション",
    description:
      "総合型選抜入試は全学部で実施。選考方法は学部により異なり、面接・書類審査・小論文・プレゼンテーション・グループディスカッション等。過去問は公式サイトでダウンロード可能。",
    type: "frequent",
    field: "総合",
  },
  {
    id: "pq-kyoto-sangyo-econ-001",
    universityId: "kyoto-sangyo-u",
    universityName: "京都産業大学",
    facultyName: "経済学部",
    year: 2024,
    theme: "現代経済の課題に関する論述",
    description:
      "総合型選抜。日本経済・グローバル経済の課題について自分の意見を論述する。時事問題への関心が問われる。",
    type: "frequent",
    field: "経済学",
  },
  ...
  // ===== 全大学共通 =====
  {
    ...
    facultyName: "全学部",
    year: 2024,
    theme: "SDGs（持続可能な開発目標）",
    description:
      "頻出テーマ。貧困、飢餓、ジェンダー、教育、働きがいと経済、エネルギー、技術革新、平和など、SDGsの各目標に関連するテーマが多くの大学で出題。",
    type: "frequent",
    field: "社会・国際",
  },
  {
    id: "pq-freq-environment-001",
    universityId: "",
    universityName: "全大学共通",
    facultyName: "全学部",
    year: 2024,
    theme: "環境問題（温暖化・脱炭素）",
    description:
      "頻出テーマ。地球温暖化、脱炭素社会、再生可能エネルギー、サステナビリティに関する出題が増加傾向。",
    type: "frequent",
    field: "環境学",
  },
  {
    ...
    facultyName: "全学部",
    year: 2024,
    theme: "生成AI・デジタル社会の課題",
    description:
      "頻出テーマ。ChatGPT等の生成AIが社会・教育・経済に与える影響。AIと人間の共存、著作権、雇用への影響。2024年以降急増。",
    type: "frequent",
    field: "テクノロジー・社会",
  },
  {
    id: "pq-freq-diversity-001",
    universityId: "",
    universityName: "全大学共通",
    facultyName: "全学部",
    year: 2024,
    theme: "多様性・ジェンダー・インクルージョン",
    description:
      "頻出テーマ。ダイバーシティ＆インクルージョン、ジェンダー平等、LGBTQ+の権利、多文化共生に関する出題。",
    type: "frequent",
    field: "社会",
  },
  {
    id: "pq-freq-disaster-001",
    universityId: "",
    universityName: "全大学共通",
    facultyName: "全学部",
    year: 2024,
    theme: "日本の自然災害と防災",
    description:
      "頻出テーマ。地震・台風・豪雨等の自然災害への備え、防災教育、コミュニティレジリエンスについて。",
    type: "frequent",
    field: "防災・社会安全",
  },
  {
    id: "pq-freq-aging-001",
    universityId: "",
    universityName: "全大学共通",
    facultyName: "全学部",
    year: 2024,
    theme: "少子高齢化と社会保障",
    description:
      "頻出テーマ。日本の少子高齢化問題、年金・医療・介護制度の持続可能性、地方創生との関連。",
    type: "frequent",
    field: "社会政策",
  },
  ...
  // ===== 北海道大学 =====
  {
    ...
    theme: "「不要不急」と消費社会の論理",
    description:
      "課題文読解型（人文系・180分）。以下の課題文を読み、コロナ禍を契機として浮上した「不要不急」という線引きが、消費社会の論理とどう関わるかについて、800字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 180,
  ...
  },
  {
    ...
    description:
      "課題文読解型（人文系・180分）。以下の課題文を読み、デジタルコミュニケーション時代における身体性の意義について、教育学的視点から800字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 180,
  ...
  },
  {
    ...
    description:
      "課題文読解型（社会科学系・180分）。以下の課題文を読み、現代社会における「縁食」の意義について、教育や地域社会のあり方を踏まえて800字程度で論じなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 180,
  ...
  },
  {
    ...
    description:
      "課題文読解型（社会科学系・180分）。以下の課題文を読み、「治外法権」をめぐる一般的誤解と国際法上の実際の制度との差異を整理し、その問題が現代日本に投げかける論点について800字程度で論じなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 180,
  ...
  },
  {
    ...
    theme: "「移民」のもたらす経済的影響",
    description:
      "課題文読解型（社会科学系・180分）。以下の課題文を読み、移民受入が日本経済にもたらす影響について、賛否双方の論拠を踏まえ800字程度で論じなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 180,
  ...
  },
  {
    ...
    description:
      "課題文読解型（社会科学系・180分）。以下の課題文を読み、医療サービスの質を評価することの難しさと、その上で望ましい評価制度のあり方について、800字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 180,
  ...
  {
    id: "pq-hokkaido-med-001",
    universityId: "hokkaido-u",
    universityName: "北海道大学",
    facultyName: "医学部医学科",
    year: 2024,
    theme: "医学・生命科学に関する課題論文",
    description:
      "フロンティア入試（総合型選抜）で課題論文を出題。提出書類・課題論文・面接・共通テストで総合評価。",
    type: "past",
    field: "医療",
  },
  ...
  // ===== 同志社大学 =====
  {
    id: "pq-doshisha-commerce-ao-001",
    universityId: "doshisha-u",
    universityName: "同志社大学",
    facultyName: "商学部",
    year: 2025,
    theme: "ビジネスに関連した自由テーマエッセイ",
    description:
      "AO入試。自由テーマによる日本語エッセイ。ビジネスに関連したテーマで2,000字以内。独自の視点と論理的構成が求められる。",
    type: "past",
    wordLimit: 2000,
    field: "経済",
  },
  {
    id: "pq-doshisha-sports-ao-001",
    universityId: "doshisha-u",
    universityName: "同志社大学",
    facultyName: "スポーツ健康科学部",
    year: 2025,
    theme: "スポーツに関連した自由テーマエッセイ",
    description:
      "AO入試。自由テーマによる日本語エッセイ。スポーツに関連したテーマで2,000字以内。スポーツ科学・健康に関する独自の考察が求められる。",
    type: "past",
    wordLimit: 2000,
    field: "スポーツ",
  },
  {
    id: "pq-doshisha-law-self-001",
    universityId: "doshisha-u",
    universityName: "同志社大学",
    facultyName: "法学部",
    year: 2024,
    theme: "夫婦別姓について",
    description:
      "自己推薦入試。法的・社会的観点から夫婦別姓制度について自分の意見を論述。面接でも小論文内容について質問される。",
    type: "past",
    field: "法律",
  },
  {
    id: "pq-doshisha-psychology-001",
    universityId: "doshisha-u",
    universityName: "同志社大学",
    facultyName: "心理学部",
    year: 2024,
    theme: "心理学的テーマに関する論述",
    description:
      "筆者は「心理学はむしろ自らの方法を点検する勇気を持つ成熟した学問だ」と述べ、事前登録制度やオープンデータの推進をその根拠として挙げている。この筆者の評価を踏まえ、心理学を学ぶ意義についてあなたの考えを600字程度で論述しなさい。",
    type: "past",
    field: "社会",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    description:
      "自己推薦入試。以下の英文を読み、グローバル社会における異文化コミュニケーションの可能性と課題について日本語600字程度で論じなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 600,
    field: "国際",
  ...
  {
    id: "pq-doshisha-social-self-001",
    universityId: "doshisha-u",
    universityName: "同志社大学",
    facultyName: "社会学部教育文化学科",
    year: 2024,
    theme: "高校時代の社会活動に関するレポート",
    description:
      "自己推薦入試。高校時代に継続的に関わったボランティア活動、福祉活動、社会活動について2,000字のレポートを提出。",
    type: "past",
    wordLimit: 2000,
    field: "社会",
  },
  ...
  // ===== 名古屋大学 =====
  {
    ...
    description:
      "学校推薦型選抜（120分）。以下の英文を読み、筆者の主張を踏まえて、AI 時代における人文学の意義について日本語800字程度で論述しなさい。第1次選考は書類審査、第2次選考で小論文と面接。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 800,
    timeLimit: 120,
  ...
  },
  {
    ...
    description:
      "学校推薦型選抜。現代社会における子ども・若者の発達課題（不登校、ヤングケアラー、SNS依存、学力格差など）から一つを取り上げ、学校教育と家庭・地域社会がどのように関わるべきか、自身の関心と結びつけて800字以内で論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "教育",
  ...
  },
  {
    ...
    description:
      "学校推薦型選抜。高等学校の地歴・公民の学習を前提に、日本国憲法における基本的人権の保障から一つの論点（例: 表現の自由、法の下の平等、生存権、知る権利など）を取り上げ、その意義と現代社会における課題について800字以内で論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "法律",
  ...
  {
    id: "pq-nagoya-sci-001",
    universityId: "nagoya-u",
    universityName: "名古屋大学",
    facultyName: "理学部",
    year: 2025,
    theme: "数理・物理・地球惑星科学の適性検査",
    description:
      "2025年度より新設の総合型選抜。数理学科・物理学科・地球惑星科学科で共通テスト課す方式、化学科・生命理学科で課さない方式。",
    type: "past",
    field: "科学",
  },
  {
    id: "pq-nagoya-freq-001",
    universityId: "nagoya-u",
    universityName: "名古屋大学",
    facultyName: "文学部",
    year: 2025,
    theme: "異文化理解と言語コミュニケーション",
    description:
      "文学部推薦では英語課題文が定番。異文化理解、言語・翻訳論、文学批評などが頻出テーマ。",
    type: "frequent",
    timeLimit: 120,
    field: "文化",
  },
  ...
  // ===== 大阪大学 =====
  {
    ...
    description:
      "以下の日本語課題文を読み、現代社会における伝統文化の継承と変容について800字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    facultyName: "文学部",
    year: 2025,
    theme: "文学・哲学・歴史学に関する論述",
    description:
      "総合型選抜の第2次選考で実施。提出書類50点＋小論文＋面接＋共通テストで総合評価。",
    type: "past",
    field: "文化",
  },
  {
    id: "pq-osaka-human-001",
    universityId: "osaka-u",
    universityName: "大阪大学",
    facultyName: "人間科学部",
    year: 2024,
    theme: "文理融合的視点からの社会課題分析",
    description:
      "人間科学部は「文理融合」の理念を掲げる。学際性・実践性・国際性を評価。特定の教科の枠にとらわれない問題が出題。",
    type: "past",
    field: "社会",
  },
  {
    id: "pq-osaka-human-002",
    universityId: "osaka-u",
    universityName: "大阪大学",
    facultyName: "人間科学部",
    year: 2025,
    theme: "グローバルな諸課題と人間行動",
    description:
      "グローバルな諸課題に積極的に関与する意欲や能力を評価。フィールドでの実践的活動に関する問題。",
    type: "past",
    field: "国際",
  },
  {
    id: "pq-osaka-lang-001",
    universityId: "osaka-u",
    universityName: "大阪大学",
    facultyName: "外国語学部",
    year: 2024,
    ...
    description:
      "以下の日本語課題文を読み、多文化共生社会における外国語学習と翻訳の意義について800字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    description:
      "学校推薦型選抜。以下の日本語課題文を読み、ゲノム医療時代における薬学研究者の役割について800字程度で論述しなさい（本問は和文編。別途英文編も出題されるが、サンプルは和文のみ提示）。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  {
    id: "pq-osaka-freq-001",
    universityId: "osaka-u",
    universityName: "大阪大学",
    facultyName: "文学部",
    year: 2025,
    theme: "AI時代における人文学の意義",
    description:
      "近年の頻出テーマ。技術革新と人文科学の関係、デジタル社会における文化の変容などが問われる傾向。",
    type: "frequent",
    field: "文化",
  },
  ...
  // ===== 専修大学 =====
  {
    id: "pq-senshu-econ-001",
    universityId: "senshu-u",
    universityName: "専修大学",
    facultyName: "経済学部",
    year: 2024,
    theme: "経済政策・市場分析に関する論述",
    description:
      "総合型選抜。経済学部向け論文対策では30テーマ収録。各テーマについて背景・問題点・キーワードが出題される。志望理由書と論文の2本立て。",
    type: "frequent",
    field: "経済学",
  },
  {
    id: "pq-senshu-law-001",
    universityId: "senshu-u",
    universityName: "専修大学",
    facultyName: "法学部",
    year: 2024,
    theme: "法律・社会問題に関する論述",
    description:
      "総合型選抜。憲法・法制度に関する社会問題についての論述が中心。法的思考力と論理的表現力が求められる。",
    type: "frequent",
    field: "法律",
  },
  {
    id: "pq-senshu-business-001",
    universityId: "senshu-u",
    universityName: "専修大学",
    facultyName: "経営学部",
    year: 2024,
    theme: "経営・ビジネスに関する論述",
    description:
      "総合型選抜。企業経営やマーケティングに関するテーマで論述。経済・経営学部向け対策教材では専門知識30テーマが扱われる。",
    type: "frequent",
    field: "経済",
  },
  {
    id: "pq-senshu-lit-001",
    universityId: "senshu-u",
    universityName: "専修大学",
    facultyName: "文学部",
    year: 2024,
    theme: "人文科学に関する課題文型小論文",
    description:
      "総合型選抜。課題文を読んだ上で人文学的視点から自分の意見を論述する形式。",
    type: "frequent",
    field: "文化",
  },
  ...
  // ===== 慶應義塾大学 =====
  {
    ...
    theme: "『人間』と『未来社会』",
    description:
      "総合政策学部・小論文試験を想定した課題。以下の課題文を読み、『人間』とは何か、そして『未来社会』においてどう生きるべきかについて、SFCで先導者を目指す学生の視点から日本語1000字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 120,
  ...
  },
  {
    ...
    description:
      "総合政策学部・小論文試験を想定した課題。以下の5つの資料のうち少なくとも4つに言及しつつ、10年後の日本について米中との相対的関係を展望し、日本経済を活性化させるイノベーション施策を3つ提案する形で日本語800字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 120,
  ...
  },
  {
    ...
    theme: "大学教育と知への態度",
    description:
      "総合政策学部・小論文試験を想定した課題。以下の4つの文章を読み、現代における大学教育の意義と「知に向き合う態度」について、自身の見解を日本語1000字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 120,
  ...
  },
  {
    ...
    theme: "トレードオフ",
    description:
      "総合政策学部・小論文試験を想定した課題。以下の課題文を読み、社会におけるトレードオフを一つ取り上げて分析し、問題発見と解決策の提案を日本語1000字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 120,
  ...
  },
  {
    ...
    theme: "定性的分析",
    description:
      "総合政策学部・小論文試験を想定した課題。以下の課題文を読み、定性的分析手法の意義と限界について、自身の見解を日本語1000字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 120,
  ...
  },
  {
    ...
    theme: "民主主義の後退",
    description:
      "総合政策学部・小論文試験を想定した課題。以下の課題文を読み、世界各地で見られる民主主義の後退現象について、原因の分析と解決策の提案を日本語1000字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 120,
  ...
  },
  {
    ...
    description:
      "環境情報学部・小論文試験を想定した課題。以下の課題文を読み、仮説演繹法の本質と、データ駆動型科学の時代における現代的意義について、自身の考えを日本語1000字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 120,
  ...
  {
    id: "pq-keio-sfc-env-002",
    universityId: "keio-u",
    universityName: "慶應義塾大学",
    facultyName: "環境情報学部",
    year: 2024,
    theme: "新しい大学入試のあり方の提案",
    description:
      "現在の大学入試制度の問題点を分析し、新しい入試のあり方を具体的に提案する。SFCの理念を踏まえた論述が求められる。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 120,
    field: "教育",
  },
  {
    ...
    theme: "定量的研究と定性的研究",
    description:
      "環境情報学部・小論文試験を想定した課題。以下の6つの文献を熟読し、『生きる』とは何か、科学とはどういう営みか、そして学問に向き合う態度のあり方について、自身の見解を日本語1000字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 120,
  ...
  },
  {
    ...
    theme: "未来からの留学生派遣制度",
    description:
      "未来からの留学生派遣制度を活用した問題発見・問題解決について、独創的なアイデアを論述。フェルミ推定的思考も求められる。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 120,
    field: "科学",
  ...
  {
    id: "pq-keio-sfc-env-005",
    universityId: "keio-u",
    universityName: "慶應義塾大学",
    facultyName: "環境情報学部",
    year: 2021,
    theme: "世の中の不条理に対する問題発見・解決",
    description:
      "社会に存在する不条理な現象を一つ取り上げ、その問題を発見・定義し、解決策を提案する。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 120,
    field: "社会",
  },
  {
    ...
    theme: "民主主義の意義と課題",
    description:
      "民主主義が直面する現代的課題について、法的・政治的観点から分析し、自身の見解を論述。FIT入試A方式・模擬講義後の論述。",
    type: "past",
    wordLimit: 400,
    timeLimit: 45,
    field: "法律",
  },
  {
    ...
    theme: "陰謀論と現代政治",
    description:
      "模擬講義「陰謀論と現代政治」を受講した後、講義内容を踏まえて論述。民主主義社会における情報リテラシーの重要性。",
    type: "past",
    wordLimit: 400,
    timeLimit: 45,
    field: "法律",
  },
  {
    ...
    theme: "道徳問題としての戦争と平和",
    description:
      "戦争と平和を道徳的観点から考察し、国際法や倫理の枠組みを用いて自身の意見を論述。",
    type: "past",
    wordLimit: 400,
    timeLimit: 45,
    field: "倫理",
  },
  {
    ...
    theme: "祝日の再配置による社会改善",
    description:
      "現在16ある祝日の日付と配置を自由に変更できるとして、社会と経済を改善するためにどう配置するか、その利点は何かを論述。",
    type: "past",
    wordLimit: 400,
    timeLimit: 45,
    field: "社会",
  },
  {
    ...
    theme: "競争について",
    description:
      "文学部・総合考査Iを想定した課題。以下の課題文を読み、現代社会における「競争」の意義と限界について、自身の見解を日本語800字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    theme: "人間の創造性について",
    description:
      "文学部・総合考査Iを想定した課題。以下の課題文を読み、人間の創造性の本質と、生成AI時代におけるその社会的意義について、言語と思考の関係に触れつつ日本語800字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    description:
      "文学部・総合考査Iを想定した課題。以下の課題文を読み、「正解が存在しない問題」に取り組むことの意義について、自身の見解を日本語800字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    theme: "問題発見・問題解決",
    description:
      "SFCを中心に、社会問題の発見と独創的な解決策の提案が最頻出テーマ。資料読解→分析→提案の流れ。",
    type: "frequent",
    field: "社会",
  },
  {
    ...
    theme: "民主主義・正義・法と倫理",
    description:
      "法学部を中心に、民主主義制度の課題、法と道徳の関係、社会正義のあり方が頻出。",
    type: "frequent",
    field: "法律",
  },
  ...
  {
    id: "pq-nihon-ir-001",
    universityId: "nihon-u",
    universityName: "日本大学",
    facultyName: "国際関係学部",
    year: 2024,
    theme: "キャッシュレス決済の普及と社会への影響",
    description:
      "総合型選抜。短い文章でテーマが示される形式。キャッシュレス社会の利点と課題について800字・60分で論述。知識量と論述力が求められる。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "国際関係・経済",
  },
  {
    ...
    theme: "日本の海外評価と国際的地位",
    description:
      "総合型選抜。日本が海外からどのように評価されているかについて分析・論述。800字・60分。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "国際",
  },
  {
    ...
    facultyName: "国際関係学部",
    year: 2023,
    theme: "自動運転技術の社会実装と課題",
    description:
      "総合型選抜。自動運転技術がもたらす社会変革と法的・倫理的課題について論述。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "テクノロジー・社会",
  },
  {
    ...
    theme: "生成AIの社会的影響",
    description:
      "総合型選抜。生成AIが社会・経済・教育に与える影響について多角的に論述。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "テクノロジー・社会",
  ...
  {
    id: "pq-nihon-econ-001",
    universityId: "nihon-u",
    universityName: "日本大学",
    facultyName: "経済学部",
    year: 2025,
    theme: "身近な人々を対象とした健康づくり",
    description:
      "総合型選抜プレゼン型。周囲の人々の健康上の問題点と解決のための取り組みについて検討。2,700〜3,000字のレポート形式。",
    type: "past",
    wordLimit: 3000,
    field: "経済学・健康",
  },
  {
    id: "pq-nihon-commerce-001",
    universityId: "nihon-u",
    universityName: "日本大学",
    facultyName: "商学部",
    year: 2025,
    theme: "少子化の状況と少子化対策",
    description:
      "総合型選抜。地域を選定し統計調査・フィールド調査を含めた少子化対策レポート。4,500〜5,000字。",
    type: "past",
    wordLimit: 5000,
    field: "商学・社会政策",
  },
  {
    id: "pq-nihon-junior-001",
    universityId: "nihon-u",
    universityName: "日本大学",
    facultyName: "短期大学部",
    year: 2025,
    theme: "日本の水道料金の独立採算制と値上げ",
    description:
      "総合型選抜第1期。水道料金制度の現状分析と将来への提案を論述。社会インフラの課題について。",
    type: "past",
    field: "公共政策",
  },
  ...
  // ===== 早稲田大学 =====
  {
    id: "pq-waseda-sports-001",
    universityId: "waseda-u",
    universityName: "早稲田大学",
    facultyName: "スポーツ科学部",
    year: 2025,
    theme: "スポーツにおける『運』の重要性",
    description:
      "スポーツにおける『運』の重要性について、自身の経験や考えを踏まえて論述。総合型選抜III群。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "社会",
  },
  {
    ...
    theme: "失敗の効用",
    description:
      "『失敗の効用』について、スポーツや人生における失敗の意義と学びを論述。総合型選抜III群。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "社会",
  ...
  {
    id: "pq-waseda-sports-003",
    universityId: "waseda-u",
    universityName: "早稲田大学",
    facultyName: "スポーツ科学部",
    year: 2025,
    theme: "大学生は『子ども』か『大人』か",
    description:
      "大学生は『子ども』なのか『大人』なのか、自分の考えを601字以上1000字以内で述べる。一般選抜・小論文。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "教育",
  ...
  {
    id: "pq-waseda-sports-004",
    universityId: "waseda-u",
    universityName: "早稲田大学",
    facultyName: "スポーツ科学部",
    year: 2024,
    theme: "この世からスポーツがなくなったら",
    description:
      "この世からスポーツがなくなったらどうなるか。601字以上1000字以内で論じる。一般選抜。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "社会",
  },
  {
    ...
    theme: "退屈の意味",
    description:
      "『退屈の意味』について、601字以上1000字以内で論じる。一般選抜・小論文。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "文化",
  },
  {
    ...
    theme: "日本と世界の政治経済課題",
    description:
      "グローバル入試（120分）。以下の課題文を読み、グローバル化が国民国家の経済政策に与える影響について日本語500字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 500,
    timeLimit: 120,
  ...
  },
  {
    ...
    theme: "格差と社会的公正",
    description:
      "グローバル入試(120分)。以下の課題文を読み、現代社会における経済的格差と社会的公正の関係について日本語500字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 500,
    timeLimit: 120,
  ...
  },
  {
    ...
    theme: "教育への関心と思考力",
    description:
      "共通テストC方式。以下の課題文を読み、これからの学校教育に求められる役割について日本語800字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    description:
      "共通テスト併用。以下の課題文を読み、現代社会における信頼の基盤の変容と、社会科学が果たすべき役割について日本語800字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    theme: "データ読解と論理的思考",
    description:
      "複数学部で資料・データの読解力と論理的思考力を問う総合問題形式が主流。図表やグラフの分析も含む。",
    type: "frequent",
    field: "社会",
  },
  {
    id: "pq-waseda-freq-002",
    universityId: "waseda-u",
    universityName: "早稲田大学",
    facultyName: "スポーツ科学部",
    year: 2024,
    theme: "抽象的概念とスポーツの関連",
    description:
      "スポーツ科学部では、抽象的な概念（運、失敗、退屈等）をスポーツや人生と結びつけて論じるテーマが頻出。",
    type: "frequent",
    wordLimit: 1000,
    timeLimit: 90,
    field: "社会",
  ...
  // ===== 明治大学 =====
  {
    ...
    theme: "日本の人口減少と社会的影響",
    description:
      "グローバル型特別入学試験。以下の資料を読み、日本の人口減少が社会・経済に与える影響と対策について800字程度で論述しなさい。※サンプル資料は練習用に生成された架空データです。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    description:
      "グローバル型特別入学試験。以下の資料を読み、SDGsに関する小規模事業者の取り組みと消費者の認知度のデータを踏まえて、課題と望ましい支援策について800字程度で分析・論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    theme: "在留外国人と多文化共生",
    description:
      "グローバル型特別入学試験。以下の資料を読み、日本における在留外国人の増加と多文化共生社会のあり方について、データを踏まえて800字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    theme: "文化と社会の関係性",
    description:
      "総合型選抜。以下の課題文を読み、文化と社会の相互関係について自身の考えを800字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  {
    id: "pq-meiji-freq-001",
    universityId: "meiji-u",
    universityName: "明治大学",
    facultyName: "政治経済学部",
    year: 2024,
    theme: "政治のリーダーシップと格差問題",
    description:
      "グローバル型で頻出。政治のリーダーに求められる資質、格差問題、日本と世界の関わりから生じる社会問題が繰り返し出題。",
    type: "frequent",
    field: "経済",
  },
  ...
  // ===== 東京大学 =====
  {
    ...
    theme: "法と社会秩序に関する論述",
    description:
      "法学部の学校推薦型選抜で出題。以下の課題文を読み、法と社会秩序の関係について、論理的に自身の見解を1000字程度で述べなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 90,
  ...
  },
  {
    ...
    theme: "法制度と現代社会の課題",
    description:
      "法学部の学校推薦型選抜で出題。以下の課題文を読解し、法制度が現代社会の変化にいかに対応すべきかについて1000字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 90,
  ...
  },
  {
    ...
    description:
      "推薦入試。以下の文章を踏まえながら、「奇跡」という概念を科学と宗教の双方の観点から検討し、文学部で学ぶ意味についてあなたの考えを1000字程度で述べなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 90,
  ...
  },
  {
    ...
    description:
      "推薦入試。以下の英文を読み、「メリトクラシー」の訳語として「能力主義」と「業績主義」のいずれが妥当か、筆者の主張を踏まえて日本語1000字程度で論じなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 1000,
    field: "社会",
  ...
  {
    id: "pq-tokyo-freq-001",
    universityId: "tokyo-u",
    universityName: "東京大学",
    facultyName: "教養学部",
    year: 2025,
    theme: "グローバル社会における多様性と共生",
    description:
      "東大推薦では国際的な視野、社会課題への関心が問われる。多文化共生、SDGs、グローバルガバナンスなどが頻出テーマ。",
    type: "frequent",
    wordLimit: 1000,
    field: "国際",
  },
  ...
  // ===== 東北大学 =====
  {
    ...
    description:
      "AO II期（180分）。以下の長文の課題文を読み、設問に答えなさい。問1は600〜800字、問2は1400〜1600字で論述すること。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1600,
    timeLimit: 180,
  ...
  {
    id: "pq-tohoku-edu-001",
    universityId: "tohoku-u",
    universityName: "東北大学",
    facultyName: "教育学部",
    year: 2024,
    theme: "資料読み取り型小論文（グラフ分析含む）",
    description:
      "AO II期。試験時間60分。100〜400文字の記述問題が4問。国語の読解問題的な要素が強く、グラフの読み取りが3年連続出題。",
    type: "past",
    wordLimit: 400,
    timeLimit: 60,
    field: "教育",
  },
  {
    ...
    description:
      "AO II期（90分）。以下の英文を読み、表現の自由と社会的責任の関係について日本語800字程度で論じなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    description:
      "AO III期。以下の英文を読み、自律システム時代における工学者の倫理的責任について日本語400字程度で論述しなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 400,
    field: "科学",
  ...
  {
    id: "pq-tohoku-agr-001",
    universityId: "tohoku-u",
    universityName: "東北大学",
    facultyName: "農学部",
    year: 2024,
    theme: "農学に関する小作文（面接前課題）",
    description:
      "AO III期。面接前に農学に関する小作文を回答。作文自体は採点されないが、面接の質問がこの内容から派生する。",
    type: "past",
    field: "科学",
  },
  {
    id: "pq-tohoku-freq-001",
    universityId: "tohoku-u",
    universityName: "東北大学",
    facultyName: "文学部",
    year: 2025,
    theme: "現代社会における人文学の役割",
    description:
      "東北大文学部AO入試の頻出テーマ。人文学の社会的意義、学際的研究、文化理解に関する深い考察が求められる。",
    type: "frequent",
    wordLimit: 1600,
    timeLimit: 180,
    field: "文化",
  ...
  // ===== 東洋大学 =====
  {
    ...
    theme: "「時間でのあそび」（鷲田清一）",
    description:
      "筆者は「効率の時間は現在を未来のための踏み台と位置づけ、遊びの時間を侵食している」と述べている。1. この主張を踏まえ、筆者が「遊びの時間」で表現しようとしていることを300字以内で要約しなさい。2. 筆者が問う「二つの時間の共存」をあなた自身の日常に即して、具体例を挙げながら500字以内で論じなさい。",
    type: "past",
    wordLimit: 800,
    field: "哲学",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "「正義の語り手」（神島裕子）",
    description:
      "筆者は「語り手の位置を問わずに抽象的に正義を論じることは、しばしば隠蔽の手段になる」と述べる一方、当事者のみが語れるとすれば「議論はたちまち閉じてしまう」とも指摘している。この両者の緊張関係を踏まえ、「当事者でない者が正義を語ること」の意義と限界についてあなたの考えを500字以内で論じなさい。",
    type: "past",
    wordLimit: 800,
    field: "哲学",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-toyo-eastern-001",
    universityId: "toyo-u",
    universityName: "東洋大学",
    facultyName: "文学部東洋思想文化学科",
    year: 2024,
    theme: "「歴史と文明のクリティーク」（栗田直躬）",
    description:
      "筆者は「東洋思想を称揚するあまり神秘化したり西洋との単純な対比に落とし込んだりすることは、別の意味で歴史を歪める」と述べている。この指摘を踏まえ、東洋思想を現代社会の課題に活かすうえで注意すべき点はどこにあるか、あなたの考えを500字以内で論じなさい。",
    type: "past",
    wordLimit: 800,
    field: "東洋思想",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "「山中の禅僧について」（水上勉）",
    description:
      "筆者は「同じ作業を繰り返しているように見えて、彼の感覚はその微細な差に開かれていた」と述べ、反復の中でしか培われない感覚を「深い知恵」と位置づけている。この主張を踏まえ、効率・変化・新しさを追い求める現代社会においてそのような知恵を学ぶ意義について、あなたの考えを500字以内で論じなさい。",
    type: "past",
    wordLimit: 800,
    field: "東洋思想",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    universityId: "toyo-u",
    universityName: "東洋大学",
    facultyName: "文学部日本文学文化学科",
    year: 2024,
    theme: "紫式部の女手論",
    description:
      "学校推薦入試小論文型。日本古典文学に関するテーマで論述。日本文化・文芸への深い理解が求められる。",
    type: "past",
    wordLimit: 800,
    field: "日本文学",
  },
  {
    id: "pq-toyo-social-001",
    universityId: "toyo-u",
    universityName: "東洋大学",
    facultyName: "社会学部社会学科",
    year: 2024,
    theme: "孤独・孤立対策",
    description:
      "総合型選抜。現代社会における孤独・孤立問題について社会学的視点から分析・論述。",
    type: "past",
    wordLimit: 800,
    field: "社会",
  },
  {
    id: "pq-toyo-social-002",
    universityId: "toyo-u",
    universityName: "東洋大学",
    facultyName: "社会学部社会学科",
    year: 2023,
    theme: "多様性を尊重する社会",
    description:
      "総合型選抜。ダイバーシティ＆インクルージョンについて社会学的観点から論じる。",
    type: "past",
    wordLimit: 800,
    field: "社会",
  },
  {
    id: "pq-toyo-social-003",
    universityId: "toyo-u",
    universityName: "東洋大学",
    facultyName: "社会学部社会学科",
    year: 2024,
    theme: "AI時代の社会的影響",
    description:
      "総合型選抜。AI技術の発展が社会に与える影響について多角的に考察。",
    type: "past",
    wordLimit: 800,
    field: "社会学・テクノロジー",
  },
  {
    id: "pq-toyo-social-004",
    universityId: "toyo-u",
    universityName: "東洋大学",
    facultyName: "社会学部社会学科",
    year: 2023,
    theme: "男女間の差別について",
    description: "総合型選抜。ジェンダー不平等について社会学的視点から論述。",
    type: "past",
    wordLimit: 800,
    field: "社会学・ジェンダー",
  },
  {
    id: "pq-toyo-social-005",
    universityId: "toyo-u",
    universityName: "東洋大学",
    facultyName: "社会学部社会学科",
    year: 2022,
    theme: "エコツーリズム",
    description:
      "総合型選抜。持続可能な観光としてのエコツーリズムについて論じる。",
    type: "past",
    wordLimit: 800,
    field: "社会学・環境",
  },
  {
    id: "pq-toyo-founding-001",
    universityId: "toyo-u",
    universityName: "東洋大学",
    facultyName: "全学部（基礎学力テスト型）",
    year: 2026,
    theme: "建学の精神に基づく学びの志望",
    description:
      "2026年度新設。東洋大学の建学の精神・教育理念から1つを選び、自らの経験を踏まえて東洋大学でどのような学びをしたいか400字以内で論述。事前課題型。",
    type: "past",
    wordLimit: 400,
    field: "総合",
  },
  ...
  // ===== 法政大学 =====
  {
    ...
    theme: "異文化理解の難しさ",
    description:
      "グローバル体験公募推薦。自身の海外経験を踏まえて、異文化理解の難しさについて論じる。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "文化",
  },
  {
    ...
    theme: "海外経験と将来の活用",
    description:
      "グローバル体験公募推薦。海外での特筆すべき体験を将来どう活かすか、法政大学での学びにどう結びつけるか論述。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "文化",
  },
  {
    ...
    theme: "経済政策と社会問題",
    description:
      "筆者は「経済学は最適解を一意に提供する道具ではなく、選択肢のコストと帰結を可視化し、社会の議論を支える知的基盤を提供する役割を担う」と述べている。この主張を踏まえ、現代日本が直面する経済政策上の課題を一つ取り上げ、経済学の役割を意識しながらあなたが望ましいと考える方向性とその根拠を800字程度で論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "経済",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    universityId: "hosei-u",
    universityName: "法政大学",
    facultyName: "グローバル教養学部",
    year: 2024,
    theme: "グローバル社会における教養の意義",
    description:
      "自己推薦入試。グローバル社会における教養の意義について英語・日本語で論述。国際的視点が求められる。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "国際",
  },
  {
    ...
    theme: "課題文型と異文化体験",
    description:
      "全学部で課題文型（与えられた文章をもとに意見を述べる形式）が主流。文学部では海外経験・異文化理解、経済学部では社会問題が頻出。",
    type: "frequent",
    field: "社会",
  },
  {
    id: "pq-hosei-freq-002",
    universityId: "hosei-u",
    universityName: "法政大学",
    facultyName: "全学部共通",
    year: 2024,
    theme: "社会問題・国際問題の分析",
    description:
      "学部の専門性に応じた社会問題・国際問題がテーマとして出題。特に国際的視点を含む内容が多い。",
    type: "frequent",
    field: "国際",
  },
  ...
  // ===== 甲南大学 =====
  {
    id: "pq-konan-econ-001",
    universityId: "konan-u",
    universityName: "甲南大学",
    facultyName: "経済学部",
    year: 2024,
    theme: "経済・社会テーマに関する論述（個性重視型）",
    description:
      "公募制推薦入学試験【個性重視型】。経済学部では書類審査と面接・グループワークで選考。経済・社会テーマへの理解と自己表現力が問われる。",
    type: "frequent",
    field: "経済学",
  },
  {
    id: "pq-konan-mgmt-001",
    universityId: "konan-u",
    universityName: "甲南大学",
    facultyName: "マネジメント創造学部",
    year: 2024,
    theme: "マネジメント・社会課題に関する論述（個性重視型）",
    description:
      "公募制推薦入学試験【個性重視型】。書類審査と面接で選考。マネジメントや社会課題に対する問題意識と解決策の提案力が評価される。",
    type: "frequent",
    field: "経済",
  },
  {
    id: "pq-konan-lit-history-001",
    universityId: "konan-u",
    universityName: "甲南大学",
    facultyName: "文学部歴史文化学科",
    year: 2025,
    theme: "歴史・文化に関する論述（個性重視型）",
    description:
      "公募制推薦入学試験【個性重視型】。2025年度より新規追加。歴史や文化に対する深い関心と独自の視点が求められる。",
    type: "past",
    field: "文化",
  },
  {
    id: "pq-konan-business-001",
    universityId: "konan-u",
    universityName: "甲南大学",
    facultyName: "経営学部",
    year: 2024,
    theme: "経営・ビジネスに関する課題（教科科目型）",
    description:
      "公募制推薦入学試験【教科科目型】。教科試験（英語・国語等）に加え、学部によって面接あり。教科科目型の過去問集は公式サイトで入手可能。",
    type: "frequent",
    field: "経済",
  },
  ...
  // ===== 立命館大学 =====
  {
    id: "pq-ritsumeikan-sansha-pr-001",
    universityId: "ritsumeikan-u",
    universityName: "立命館大学",
    facultyName: "産業社会学部",
    year: 2025,
    theme: "高校での活動と大学で学びたいテーマの論述",
    description:
      "産業社会小論文方式。高校入学以降の活動でアピールしたいものを挙げ、活動を通じて形成された問題意識と大学で学びたいテーマについて論述。1次：小論文（80分）+書類、2次：面接。",
    type: "past",
    timeLimit: 80,
    field: "社会",
  },
  {
    id: "pq-ritsumeikan-ir-001",
    universityId: "ritsumeikan-u",
    universityName: "立命館大学",
    facultyName: "国際関係学部",
    year: 2025,
    ...
    description:
      "筆者は現代の国際秩序を「複合的な多極化」と呼び、米中のデカップリング、軍事力による現状変更という国際規範への挑戦、グローバル・サウスの独自路線という三つの力学が絡み合っていると論じている。①この「複合的な多極化」の特徴を200字以内で整理した上で、②こうした秩序変容のもとで日本がとるべき外交・安全保障上の方針について、あなたの考えを600字程度で論じなさい。",
    type: "past",
    field: "国際",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    description:
      "筆者は「生成AIが文章を瞬時に作り出す時代に、なお人間が自ら本を読み、文章を書き、問い続けることの意味」を問うている。この問いに対するあなた自身の考えを、自身の関心領域や具体例を踏まえて600字程度で論じなさい。",
    type: "past",
    field: "文化",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-ritsumeikan-general-001",
    universityId: "ritsumeikan-u",
    universityName: "立命館大学",
    facultyName: "全学部共通",
    year: 2025,
    theme: "読解力・要約力・意見表明の総合評価",
    description:
      "AO選抜全般。「読む／聴く」力、「要約する」力、「書く／発言する」力、「意見を表明する力」を問う。独創性・論理性・思考力・表現力が大切。公式サイトで過去問・講評公開。",
    type: "frequent",
    field: "総合",
  },
  {
    id: "pq-ritsumeikan-pharm-001",
    universityId: "ritsumeikan-u",
    universityName: "立命館大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "神経変性疾患のメカニズムと治療薬開発",
    description:
      "総合型選抜。60分・全3問。第一問はアルツハイマー病とパーキンソン病によって体内で増加・減少する物質の名称と構造式を答える問題。第二問はアルツハイマー病・パーキンソン病以外の神経変性疾患のメカニズムを説明する問題。第三問は神経変性疾患の治療薬の開発について、現在よりも良い開発や研究を進めるための方法を答える問題。第二問と第三問は合わせて2000字。ほかに将来の展望を書いた文書（1200字程度）を提出。面接は個人面接10分・面接官2名で、口頭試問としてタンパク質の説明やパーキンソン病の発症メカニズムを問われた。",
    type: "past",
    questionType: "essay",
    wordLimit: 2000,
    timeLimit: 60,
  ...
  // ===== 立教大学 =====
  {
    ...
    universityId: "rikkyo-u",
    universityName: "立教大学",
    facultyName: "異文化コミュニケーション学部",
    year: 2019,
    theme: "自文化中心主義と歴史記述の関係",
    description:
      "筆者は「自文化中心主義を完全に脱した『中立な歴史記述』が可能だと考えるのも、別の幻想である」と述べ、解決策として「複数の声が衝突しながら併存する場」の制度化を提唱している。この主張を踏まえ、筆者の提唱する歴史記述のあり方の意義と限界について、異文化コミュニケーションを学ぶ立場からあなたの見解を1000字程度で論述しなさい。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "文化",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "標準語の政治性",
    description:
      "筆者は「標準語の普及は、同時に多様な言語的伝統の沈黙化をも意味した」と述べ、共通言語の利便性を認めつつも抑圧された言語的多様性の回復と差別を生まない制度設計の必要性を説く。この筆者の問題提起を踏まえ、現代社会における言語のあり方についてあなたの考えを1000字程度で論述しなさい。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "文化",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "コードとしての言語",
    description:
      "自由選抜入試方式A。言語をコードとして捉える視点から、コミュニケーションの本質について論述。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "文化",
  ...
  {
    id: "pq-rikkyo-soc-001",
    universityId: "rikkyo-u",
    universityName: "立教大学",
    facultyName: "社会学部",
    year: 2020,
    theme: "グローバル化と異文化共生社会",
    description:
      "自由選抜入試。グローバル化の中で異文化共生社会をどう構築すべきかについて論述。口頭発表と小論文の組合せ。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "国際",
  },
  {
    ...
    theme: "紙の重要性について",
    description:
      "自由選抜入試。デジタル化が進む中での紙メディアの社会的重要性について論述。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "社会",
  },
  {
    ...
    theme: "言語・社会・文化の相互関係",
    description:
      "異文化コミュニケーション学部を中心に、言語と社会・文化の関係を問うテーマが安定的に出題。社会学部では社会問題が中心。",
    type: "frequent",
    field: "文化",
  },
  ...
  // ===== 近畿大学 =====
  {
    id: "pq-kindai-med-2023-001",
    universityId: "kindai-u",
    universityName: "近畿大学",
    facultyName: "医学部",
    year: 2023,
    theme: "良医への学修における自らの課題と克服方法",
    description:
      "一般前期。良い医師になるための学修において、自分自身の課題とその克服方法について400字以内で論述。",
    type: "past",
    wordLimit: 400,
    field: "医療",
  },
  {
    id: "pq-kindai-med-2023-002",
    universityId: "kindai-u",
    universityName: "近畿大学",
    facultyName: "医学部",
    year: 2023,
    theme: "インフォームドコンセントの観点から余命告知への対応",
    description:
      "推薦入試。患者への余命告知についてインフォームドコンセントの観点から考察。医療倫理の理解が問われる。",
    type: "past",
    wordLimit: 400,
    field: "医療",
  },
  {
    id: "pq-kindai-med-2022-001",
    universityId: "kindai-u",
    universityName: "近畿大学",
    facultyName: "医学部",
    year: 2022,
    theme: "新型コロナワクチン副反応の科学的・社会的考察",
    description:
      "一般後期。新型コロナワクチンの副反応について科学的・社会的側面から考察。医学的知識と社会的視点が求められる。",
    type: "past",
    wordLimit: 400,
    field: "医療",
  },
  {
    id: "pq-kindai-lit-2023-001",
    universityId: "kindai-u",
    universityName: "近畿大学",
    facultyName: "文芸学部",
    year: 2023,
    theme: "「七転び八起き」と思った経験の具体的記述",
    description:
      "一般前期。ことわざ「七転び八起き」に関連する自身の経験を具体的に800〜1000字で記述。体験に基づく表現力が問われる。",
    type: "past",
    wordLimit: 1000,
    field: "文化",
  },
  {
    id: "pq-kindai-lit-2023-002",
    universityId: "kindai-u",
    universityName: "近畿大学",
    facultyName: "文芸学部",
    year: 2023,
    theme: "「琴線に触れる」経験についての具体的記述",
    description:
      "推薦入試。「琴線に触れる」経験について1000〜1200字で具体的に記述。感性と表現力が重視される。",
    type: "past",
    wordLimit: 1200,
    field: "文化",
  },
  {
    id: "pq-kindai-lit-2022-001",
    universityId: "kindai-u",
    universityName: "近畿大学",
    facultyName: "文芸学部",
    year: 2022,
    theme: "「逃がした魚は大きい」と思った経験",
    description:
      "一般前期。ことわざ「逃がした魚は大きい」に関連する自身の経験を800〜1000字で記述。毎年ことわざテーマで出題される傾向。",
    type: "past",
    wordLimit: 1000,
    field: "文化",
  },
  {
    id: "pq-kindai-lit-2022-002",
    universityId: "kindai-u",
    universityName: "近畿大学",
    facultyName: "文芸学部",
    year: 2022,
    theme: "「案ずるより産むが易い」の経験について",
    description:
      "推薦入試。ことわざをテーマに自身の経験を1000〜1200字で論述。近畿大学文芸学部の定番出題パターン。",
    type: "past",
    wordLimit: 1200,
    field: "文化",
  },
  {
    id: "pq-kindai-int-ao-001",
    universityId: "kindai-u",
    universityName: "近畿大学",
    facultyName: "国際学部",
    year: 2024,
    theme: "国際社会に関する小論文（AO入試）",
    description:
      "総合型選抜（AO入試）。国際学部独自の小論文過去問がPDFで公式サイトに公開。国際社会の課題について分析・論述。",
    type: "past",
    field: "国際",
  },
  {
    id: "pq-kindai-stage-001",
    universityId: "kindai-u",
    universityName: "近畿大学",
    facultyName: "文芸学部芸術学科舞台芸術専攻",
    year: 2024,
    theme: "人間の営みにおける劇的要素",
    description:
      "一般前期B日程。人間の営みにおける劇的（ドラマ的）要素を問うテーマについて800〜1000字で記述。",
    type: "past",
    wordLimit: 1000,
    field: "文化",
  },
  ...
  // ===== 関西大学 =====
  {
    ...
    description:
      "SF入試小論文I。以下の資料を読み取り、データから読み取れる傾向を分析した上で、結論を800字程度で論理的に導きなさい。※サンプル資料は練習用に生成された架空データです。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 60,
  ...
  },
  {
    ...
    description:
      "SF入試小論文II。以下の資料を読み取り、筆者の主張と防災上の課題を整理した上で、具体例を挙げて自分の考えを800字程度で論述しなさい。※サンプル資料は練習用に生成された架空データです。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 60,
  ...
  },
  {
    ...
    universityId: "kansai-u",
    universityName: "関西大学",
    facultyName: "全学部（AO入試）",
    year: 2024,
    theme: "志望分野に関する自由論述",
    description:
      "AO入試。過去問非公開。面接・書類中心だが一部学部で小論文あり。日頃のニュースへの関心と具体的な経験に基づく記述が重視される。抽象的でなく具体的に書くことがポイント。",
    type: "frequent",
    field: "総合",
  },
  ...
  // ===== 関西学院大学 =====
  {
    ...
    theme: "旧約聖書の世界観",
    description:
      "学部特色入学試験。旧約聖書の世界観に関する筆記審査。宗教的・哲学的考察を求められる。",
    type: "past",
    field: "文化",
  },
  {
    id: "pq-kwansei-global-001",
    universityId: "kwansei-u",
    universityName: "関西学院大学",
    facultyName: "国際学部",
    year: 2024,
    theme: "グローバル社会の課題に関する論述",
    description:
      "グローバル入学試験。国際社会の問題（貧困、環境、人権等）について英語または日本語で論述。筆記審査問題は公式サイトで公開。",
    type: "past",
    wordLimit: 800,
    field: "国際",
  },
  {
    id: "pq-kwansei-policy-001",
    universityId: "kwansei-u",
    universityName: "関西学院大学",
    facultyName: "総合政策学部",
    year: 2024,
    theme: "社会課題の分析と政策提言",
    description:
      "筆者は、コンパクトシティ政策について「過去の中心市街地再生事業の多くが補助金頼みのハコモノに終わった」と述べ、効率と公平・変化と継続のはざまでの難しい選択を指摘している。この指摘を踏まえ、あなたがA市の政策立案担当者だとすれば、どのような政策パッケージを設計するか。賛否双方の論点を踏まえ、800字程度で論じなさい。",
    type: "past",
    wordLimit: 800,
    field: "社会",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "経済・社会問題に関する論述",
    description:
      "学部特色入学試験。人文・社会系の時事問題や経済テーマについて論理的に記述。データの読み取りと分析力が重視される。",
    type: "frequent",
    wordLimit: 800,
    field: "経済学",
  },
  {
    id: "pq-kwansei-human-001",
    universityId: "kwansei-u",
    universityName: "関西学院大学",
    facultyName: "人間福祉学部",
    year: 2024,
    theme: "福祉・社会課題に関する倫理的考察",
    description:
      "学部特色入学試験。福祉や人間の幸福に関する倫理的テーマを論じる。社会的弱者への支援や共生社会について問われる傾向。",
    type: "frequent",
    wordLimit: 800,
    field: "社会",
  },
  ...
  // ===== 青山学院大学 =====
  {
    id: "pq-aoyama-sccs-001",
    universityId: "aoyama-u",
    universityName: "青山学院大学",
    facultyName: "総合文化政策学部",
    year: 2024,
    theme: "古典・偉人の原著からの論述",
    description:
      "筆者は「古典は古いから尊いのではない。古いにもかかわらず、今なお私たちの問いに応答する力を持つから尊い」と述べ、文化を「人間が自分自身と社会を理解し、変えていくための営み」と定義している。この主張を踏まえ、文化政策に関心を持つ立場として自身が取り組みたい問いを600字程度で論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "文化",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "文化政策と社会変革",
    description:
      "筆者は「文化政策の評価指標を『来館者数』『経済波及効果』だけに収斂させてよいのか」と問い、文化政策を社会の価値序列を編み直す政治的実践として捉えている。この筆者の認識を踏まえ、経済効果以外に文化政策を評価するためにどのような指標が必要か、具体例を挙げて600字程度で論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "文化",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-aoyama-art-001",
    universityId: "aoyama-u",
    universityName: "青山学院大学",
    facultyName: "文学部比較芸術学科",
    year: 2024,
    theme: "芸術評論に基づく論述",
    description:
      "筆者は「評論は作品を『説明』するためではなく、作品と鑑賞者の出会いそのものを豊かにするために存在する」と述べ、バッハやゴッホを例に、作品は受容の歴史を背負って時代ごとに異なる存在として立ち現れると論じている。この主張を踏まえ、美術・音楽・演劇・映像のいずれかから作品を一つ挙げ、その受容の変遷と芸術評論の役割についてあなたの考えを800字以内で論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "文化",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-aoyama-ipe-001",
    universityId: "aoyama-u",
    universityName: "青山学院大学",
    facultyName: "国際政治経済学部",
    year: 2024,
    theme: "国際関係とデータ分析",
    description:
      "総合型選抜。以下の英文を読み、国際関係における定量的データ分析の意義と限界について日本語800字程度で論述しなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 800,
    field: "国際",
  ...
  },
  {
    ...
    theme: "データ読解と社会分析",
    description:
      "D方式。以下の資料を読み解き、データから観察される社会現象を分析した上で、自分の考えを800字程度で論述しなさい。※サンプル資料は練習用に生成された架空データです。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 90,
  ...
  {
    id: "pq-aoyama-freq-001",
    universityId: "aoyama-u",
    universityName: "青山学院大学",
    facultyName: "全学部共通",
    year: 2024,
    theme: "読解力・論理的思考・表現力の総合評価",
    description:
      "全学部で文章読解→論理的思考→表現という流れの総合問題が主流。社会科学的テーマと文化・芸術テーマが2大柱。",
    type: "frequent",
    field: "社会",
  },
  ...
  // ===== 駒澤大学 =====
  {
    id: "pq-komazawa-buddhism-001",
    universityId: "komazawa-u",
    universityName: "駒澤大学",
    facultyName: "仏教学部",
    year: 2024,
    theme: "宗教（仏教）と社会・文化との関わり",
    description:
      "自己推薦選抜。仏教と現代社会・文化の関わりについて論述。宗教的素養と社会的視点が問われる。60分。",
    type: "past",
    timeLimit: 60,
    field: "仏教学・宗教学",
  },
  {
    id: "pq-komazawa-jpn-001",
    universityId: "komazawa-u",
    universityName: "駒澤大学",
    facultyName: "文学部国文学科",
    year: 2024,
    theme: "日本の文化・文芸に関する論述",
    description:
      "自己推薦選抜（総合評価型）。日本の文化・文芸に関する事柄についてのテーマや文章が与えられ、内容理解を前提に自身の意見を述べる。60分。",
    type: "past",
    timeLimit: 60,
    field: "日本文学",
  },
  {
    id: "pq-komazawa-sociology-001",
    universityId: "komazawa-u",
    universityName: "駒澤大学",
    facultyName: "文学部社会学専攻",
    year: 2024,
    theme: "身近な社会現象・国内外の社会問題",
    description:
      "自己推薦選抜。身近な社会現象や国内外の社会問題について社会学的視点から分析・論述。60分。",
    type: "past",
    timeLimit: 60,
    field: "社会",
  },
  {
    id: "pq-komazawa-geography-001",
    universityId: "komazawa-u",
    universityName: "駒澤大学",
    facultyName: "文学部地理学科",
    year: 2024,
    ...
    description:
      "自己推薦選抜。以下の地理・統計資料を読み取り、観察される地域的傾向を地理学的視点から800字程度で論述しなさい。60分。※サンプル資料は練習用に生成された架空データです。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 60,
  ...
  },
  {
    ...
    theme: "法律・社会問題に関する論述",
    description:
      "自己推薦選抜。フレックスA専攻とB専攻で同一の小論文を出題。法的・社会的課題について論理的に論述。60分。",
    type: "past",
    timeLimit: 60,
    field: "法律",
  },
  {
    id: "pq-komazawa-econ-001",
    universityId: "komazawa-u",
    universityName: "駒澤大学",
    facultyName: "経済学部",
    year: 2024,
    theme: "経済・社会問題に関する小論文",
    description:
      "自己推薦選抜。経済的・社会的課題について分析・論述。時事問題への関心と論理的思考力が問われる。60分。",
    type: "frequent",
    timeLimit: 60,
    field: "経済学",
  },
  {
    id: "pq-komazawa-gms-001",
    universityId: "komazawa-u",
    universityName: "駒澤大学",
    facultyName: "グローバル・メディア・スタディーズ学部",
    year: 2024,
    theme: "メディア・国際社会に関する時事問題",
    description:
      "自己推薦選抜。メディアやグローバル社会に関する時事的テーマについて論述。60分。",
    type: "frequent",
    timeLimit: 60,
    field: "メディア・国際",
  },
...

  {
    ...
    description:
      "以下の資料を分析し、日本の少子高齢化の特徴を国際比較の観点から明らかにした上で、出生率回復のために必要な政策を800字以内で論じなさい。",
    type: "frequent",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 90,
...

  {
    ...
    description:
      "以下の資料からAI導入の現状と生産性への影響を読み取り、日本企業がAI活用を進めるための課題と方策を800字以内で論じなさい。",
    type: "frequent",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 90,
...

  {
    ...
    description:
      "以下の資料からSDGs達成度の推移を読み取り、日本が特に課題を抱える目標について分析し、改善策を600字以内で論じなさい。",
    type: "frequent",
    questionType: "data-analysis",
    wordLimit: 600,
    timeLimit: 60,
...

  {
    ...
    description:
      "以下の資料からテレワークの普及状況と労働時間の変化を読み取り、働き方改革の成果と今後の課題を800字以内で論じなさい。",
    type: "frequent",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 90,
    ...
    chartData: [
      ...
      },
      {
        ...
        yKeys: [
          { key: "実労働時間", name: "年間総実労働時間", color: "#10B981" },
        ],
      },
    ],
  },

  {
    ...
    description:
      "以下の資料を分析し、主要国のCO2排出量の推移と削減目標の達成可能性について600字以内で論じなさい。",
    type: "frequent",
    questionType: "data-analysis",
    wordLimit: 600,
    timeLimit: 60,
...

  {
    ...
    description:
      "以下の資料を分析し、大学進学率の上昇と学費増加の関係を踏まえ、教育機会の平等をどう確保すべきか800字以内で論じなさい。",
    type: "frequent",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 90,
...

  {
    ...
    description:
      "以下の資料を分析し、日本の経済格差の現状を国際比較の観点から明らかにした上で、格差是正のための政策を800字以内で提案しなさい。",
    type: "frequent",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 90,
...

  {
    ...
    description:
      "以下の資料を分析し、医療費増大の要因を明らかにした上で、持続可能な医療制度を実現するための方策を800字以内で論じなさい。",
    type: "frequent",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 90,
  ...
  {
    id: "pq-data-digital-divide-age-1",
    universityId: "ritsumeikan-u",
    universityName: "立命館大学",
    facultyName: "情報理工学部",
    year: 2025,
    ...
    description:
      "以下の資料を分析し、年齢層間のデジタルデバイドの実態と、デジタル化の恩恵を全世代に広げるための方策を600字以内で論じなさい。",
    type: "frequent",
    questionType: "data-analysis",
    wordLimit: 600,
    timeLimit: 60,
...

  {
    ...
    description:
      "以下の資料を分析し、外国人労働者の受入れ状況の変化を踏まえ、多文化共生社会の実現に向けた課題と方策を800字以内で論じなさい。",
    type: "frequent",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 90,
    ...
    chartData: [
      {
        ...
        yKeys: [
          { key: "労働者数", name: "外国人労働者数（万人）", color: "#3B82F6" },
        ],
      },
      {
        type: "pie",
...

  {
    ...
    description:
      "以下の資料を分析し、日本の再生可能エネルギー普及の現状と課題を国際比較から明らかにし、エネルギー政策のあり方を600字以内で論じなさい。",
    type: "frequent",
    questionType: "data-analysis",
    wordLimit: 600,
    timeLimit: 60,
    ...
    chartData: [
      {
        ...
        yKeys: [
          { key: "再エネ比率", name: "再エネ比率（%）", color: "#10B981" },
        ],
      },
    ],
  },
...

  {
    ...
    theme: "【講義型】AIと創造性の関係",
    description:
      "「AIは人間の創造性を拡張するか、それとも代替するか」という講義を聴いた後、講義の要旨をまとめ（200字程度）、それに対するあなたの意見を600字以内で述べなさい。講義要旨：生成AIの登場により、絵画・音楽・文章の自動生成が可能になった。一部の研究者はAIが人間の創造的パートナーとなると主張するが、芸術家の中にはAIによる創作は本質的な創造性を欠くと批判する声もある。",
    type: "frequent",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
...

  {
    ...
    theme: "【講義型】言語と思考の関係",
    description:
      "「言語が思考を規定する」というサピア=ウォーフ仮説に関する講義を聴いた後、講義の要旨をまとめ（200字程度）、それを踏まえてバイリンガル教育の意義について800字以内で論じなさい。講義要旨：サピア=ウォーフ仮説によれば、使用する言語が世界の認知方法に影響を与える。近年の認知科学の研究は、言語が色彩知覚や時間概念に影響することを実験的に示している。",
    type: "frequent",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 90,
...

  {
    ...
    description:
      "「ビッグデータ時代の個人情報保護」に関する講義を聴いた後、講義で示された論点を整理し（200字程度）、個人情報保護と公共の利益の両立について、具体例を挙げながら600字以内で論じなさい。講義要旨：医療・防災・犯罪捜査などの分野では個人データの活用が公共の利益に資する。一方、監視社会化への懸念やプロファイリングによる差別のリスクも指摘されている。",
    type: "frequent",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 60,
...

  {
    ...
    description:
      "「グローバルサウスの台頭と国際開発の再定義」に関する講義を聴いた後、講義の要旨をまとめ（200字程度）、従来の南北問題の枠組みがどう変容しているかについて600字以内で論じなさい。講義要旨：BRICSの拡大や途上国間協力（南南協力）の進展により、先進国主導の国際開発体制が変化している。インドやブラジルなどは援助の受け手から担い手へと移行しつつある。",
    type: "frequent",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 60,
...

  {
    ...
    description:
      "「非認知能力と教育成果の関係」に関する講義を聴いた後、講義内容を要約し（200字程度）、非認知能力を育成するための教育方法について600字以内で提案しなさい。講義要旨：ヘックマンの研究は、幼児期の非認知能力（忍耐力、自制心、協調性など）への投資が長期的な教育・経済的成果に大きな影響を与えることを示した。しかし、非認知能力の評価方法や育成カリキュラムには課題が残る。",
    type: "frequent",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 60,
  ...
  // ===== 龍谷大学 =====
  {
    id: "pq-ryukoku-policy-001",
    universityId: "ryukoku-u",
    universityName: "龍谷大学",
    facultyName: "政策学部",
    year: 2024,
    theme: "社会政策に関する課題文読み取り型小論文",
    description:
      "1. 課題文に示されたA市とB市の取り組みについて、それぞれの長所と短所を含めて300字以内で整理しなさい。\n2. 筆者は「政策の正しさは、結果の数字だけでなく、決定に至る過程の納得性によっても評価されるべきである」と述べている。この主張を踏まえ、人口減少地域における公共サービス維持のあり方についてあなたの考えを700字以内で論じなさい。",
    type: "past",
    wordLimit: 1000,
    field: "社会",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-ryukoku-intl-001",
    universityId: "ryukoku-u",
    universityName: "龍谷大学",
    facultyName: "国際学部国際文化学科",
    year: 2024,
    theme: "国際文化に関する小論文",
    description:
      "公募推薦入試（専門高校対象）。国際文化・異文化理解に関するテーマで論述。2024年11月24日実施。",
    type: "past",
    field: "国際文化",
  },
  {
    id: "pq-ryukoku-intl-gs-001",
    universityId: "ryukoku-u",
    universityName: "龍谷大学",
    facultyName: "国際学部グローバルスタディーズ学科",
    year: 2024,
    theme: "グローバル社会の課題に関する論述",
    description:
      "公募推薦入試（専門高校対象）。グローバル社会の課題について分析・論述。2024年11月24日実施。",
    type: "past",
    field: "国際",
  },
  {
    id: "pq-ryukoku-social-001",
    universityId: "ryukoku-u",
    universityName: "龍谷大学",
    facultyName: "社会学部総合社会学科",
    year: 2024,
    theme: "社会問題に関する論述",
    description:
      "公募推薦入試（専門高校対象）。社会問題に関するテーマで1000字程度の記述。社会学部は比較的長い字数が求められる傾向。",
    type: "past",
    wordLimit: 1000,
    field: "社会",
  },
  {
    id: "pq-ryukoku-agri-001",
    universityId: "ryukoku-u",
    universityName: "龍谷大学",
    facultyName: "農学部",
    year: 2024,
    theme: "農業・食・環境に関する論述",
    description:
      "筆者は「食料の問題は、農業だけの問題ではなく、社会全体で何を優先するかという価値選択の問題でもある」と述べている。この主張を踏まえ、食料自給率の向上に向けて社会全体として優先すべき取り組みについて、あなたの考えを600字以内で論じなさい。",
    type: "past",
    field: "農学",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-ryukoku-sports-001",
    universityId: "ryukoku-u",
    universityName: "龍谷大学",
    facultyName: "全学部（スポーツ活動選抜）",
    year: 2023,
    theme: "スポーツと社会に関するテーマ型小論文",
    description:
      "総合型選抜スポーツ活動選抜。スポーツの社会的意義や自身の競技経験に関するテーマ型小論文。2023年11月11日実施。",
    type: "past",
    wordLimit: 1000,
    field: "スポーツ",
  },
  ...
  // ===== 九州大学（追加分） =====
  {
    id: "pq-kyushu-kyoso-1",
    universityId: "kyushu-u",
    universityName: "九州大学",
    facultyName: "共創学部",
    year: 2024,
    theme: "鳥獣被害を防止するための政策",
    description:
      "農林水産省「鳥獣被害の現状と対策」の図表資料を分析し、鳥獣被害防止のための政策について課題を抽出し、自分の意見を論述する。図表分析型。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 850,
    timeLimit: 180,
  ...
  {
    id: "pq-kyushu-kyoso-2",
    universityId: "kyushu-u",
    universityName: "九州大学",
    facultyName: "共創学部",
    year: 2024,
    theme: "日本におけるジェンダーギャップの改善策",
    description:
      "世界経済フォーラム「グローバル・ジェンダー・ギャップ報告書2023」等の複数資料を分析し、日本のジェンダーギャップの課題と改善策を論述する。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 850,
    timeLimit: 180,
    ...
    chartData: [
      {
        ...
        yKeys: [
          { key: "順位", name: "順位（低いほど良い）", color: "#EF4444" },
        ],
      },
      {
        type: "bar",
        title: "日本のGGI 分野別スコア（2023）",
        xKey: "area",
        data: [
          { area: "経済", score: 0.561 },
          { area: "教育", score: 0.997 },
        ...
        yKeys: [
          { key: "score", name: "スコア（1が完全平等）", color: "#6366F1" },
        ],
      },
    ],
  },
  {
    id: "pq-kyushu-kyoso-3",
    universityId: "kyushu-u",
    universityName: "九州大学",
    facultyName: "共創学部",
    year: 2023,
    theme: "宗教人口と統計および宗教教育",
    description:
      "『日本人の考え方 世界の人の考え方Ⅱ：第7回世界価値観調査から見えるもの』等の資料を分析し、宗教人口の統計データと宗教教育の在り方について論述する。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 850,
    timeLimit: 180,
    ...
    chartData: [
      {
        type: "pie",
        title: "世界の宗教人口比率（2020年・Pew Research）",
        xKey: "name",
        data: [
          { name: "キリスト教", value: 31.1 },
          { name: "イスラム教", value: 24.9 },
          { name: "無宗教", value: 15.6 },
          { name: "ヒンドゥー教", value: 15.2 },
          { name: "仏教", value: 6.6 },
          { name: "民族宗教", value: 5.6 },
          { name: "その他", value: 1.0 },
        ],
  ...
  {
    id: "pq-kyushu-kyoso-4",
    universityId: "kyushu-u",
    universityName: "九州大学",
    facultyName: "共創学部",
    year: 2023,
    theme: "九州にある原子力発電所が抱えるリスク",
    description:
      "経済産業省・資源エネルギー庁「放射性廃棄物について」、産業技術総合研究所「活断層データベース」等を分析し、九州の原発リスクについて論述する。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 850,
    timeLimit: 180,
    ...
    chartData: [
      {
        type: "bar",
        title:
          "九州の原発周辺50km圏内の主要活断層数（想定マグニチュード7以上）",
        xKey: "plant",
        data: [
          { plant: "玄海原発", 活断層: 4 },
          { plant: "川内原発", 活断層: 7 },
      ...
      {
        type: "line",
        title: "日本の高レベル放射性廃棄物 累積量（本・ガラス固化体換算）",
        xKey: "year",
        data: [
          { year: "2010", 累積: 1664 },
          { year: "2015", 累積: 2124 },
  ...
  {
    id: "pq-kyushu-kyoso-5",
    universityId: "kyushu-u",
    universityName: "九州大学",
    facultyName: "共創学部",
    year: 2022,
    theme: "情報通信技術を活用した社会問題の解決",
    description:
      "ICT・Society5.0関連の資料を読み解き、情報通信技術による社会問題解決の可能性と課題について論述する。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 850,
    timeLimit: 180,
    ...
    chartData: [
      ...
      {
        type: "bar",
        title: "ICT活用により社会課題解決を期待する分野（複数回答・%）",
        xKey: "area",
        data: [
          { area: "医療・介護", 期待: 68 },
          { area: "教育", 期待: 55 },
  ...
  },
  {
    ...
    theme: "オリンピックと国際社会",
    description:
      "オリンピックに関する複数の資料を分析し、国際社会における意義や課題について自分の意見を論述する。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 850,
    timeLimit: 180,
    ...
    chartData: [
      {
        type: "line",
        title: "夏季五輪の開催コスト推移（億USドル）",
        xKey: "year",
        data: [
          { year: "2000 シドニー", コスト: 32 },
          { year: "2004 アテネ", コスト: 90 },
          { year: "2008 北京", コスト: 68 },
          { year: "2012 ロンドン", コスト: 150 },
          { year: "2016 リオ", コスト: 132 },
          { year: "2020 東京", コスト: 155 },
        ],
  ...
  },
  {
    ...
    theme: "世界遺産の保全と活用",
    description:
      "世界遺産に関する複数のスライド資料を読み解き、世界遺産の保全と活用における課題を説明し、自分の意見を論述する。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 850,
    timeLimit: 180,
    ...
    chartData: [
      {
        type: "pie",
        title: "世界遺産の種類別登録件数（2024年・UNESCO）",
        xKey: "name",
        data: [
          { name: "文化遺産", value: 933 },
          { name: "自然遺産", value: 227 },
  ...
  },
  {
    ...
    theme: "食品ロスの削減",
    description:
      "食品ロスに関する統計データやスライド資料を読み解き、食品廃棄の現状と削減に向けた方策について論述する。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 850,
    timeLimit: 180,
  ...
  },
  {
    ...
    theme: "不安のない生活と社会",
    description:
      "社会における不安に関する8枚のスライド資料を読み解き、不安のない生活と社会の実現に向けた課題を説明し、自分の貢献策を論述する。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 850,
    timeLimit: 180,
    ...
    chartData: [
      {
        ...
        yKeys: [
          { key: "不安", name: "不安を感じる割合（%）", color: "#EF4444" },
        ],
      },
      {
        type: "line",
        title: "「悩みや不安がある」と答えた割合（内閣府・%）",
        xKey: "year",
        data: [
          { year: "2000", 全体: 55.8 },
          { year: "2010", 全体: 69.4 },
  ...
  },
  {
    ...
    theme: "AIと人間社会の共存",
    description:
      "AI（人工知能）に関する資料を分析し、AIと人間社会の共存における課題と可能性について論述する。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 850,
    timeLimit: 180,
    ...
    chartData: [
      ...
      {
        type: "bar",
        title: "AIにより自動化リスクが高い職業カテゴリ（OECD・%）",
        xKey: "job",
        data: [
          { job: "単純事務", リスク: 71 },
          { job: "運輸", リスク: 58 },
  ...
  },
  {
    ...
    theme: "叡智を表現する言語としての国語の意義",
    description:
      "後期日程（150分）。以下の課題文（水村美苗『日本語が滅びるとき 英語の世紀の中で』を素材にしたサンプル文）を読み、英語の世紀における日本語の意義について800字程度で読解・論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 150,
  ...
  },
  {
    ...
    description:
      "後期日程（150分）。以下の課題文（岡田暁生『音楽と出会う』を素材にしたサンプル文）を読み、AI時代における人間の想像力の役割について800字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 150,
  ...
  },
  {
    ...
    facultyName: "経済学部（経済・経営学科）",
    year: 2023,
    theme: "スタートアップ企業を左右するCVC",
    description:
      "Alfred A. Marcus 'Innovations in Sustainability' を英文課題として、スタートアップ企業とCVCについて論述する。英文問題。180分。",
    type: "past",
    questionType: "english-reading",
    timeLimit: 180,
    field: "経済",
  ...
  // ===== 大阪大学（追加分） =====
  {
    ...
    year: 2024,
    theme: "色彩がもたらす健康への影響",
    description: "色彩が健康に与える影響について理科論述型で出題。90分。",
    type: "past",
    timeLimit: 90,
    field: "医療",
  },
  {
    ...
    description:
      "以下の課題文（早石修『研究ターゲッティング』を素材にしたサンプル文）を読み、医薬品研究開発におけるAI活用の意義と限界について800字程度で読解・論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    description:
      "以下の課題文（光岡知足『腸内細菌の話』を素材にしたサンプル文）を読み、腸内細菌とがんの関連性を踏まえた今後の医療・薬学研究の方向性について800字程度で読解・論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    description:
      "以下の日本語課題文を読み、人文学が現代社会で果たす役割について、800字程度で読解力・論理的思考力・表現力を発揮して論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    facultyName: "人間科学部",
    year: 2024,
    theme: "人間科学に関する課題文読解と論述",
    description:
      "日本語課題文を読み、心理学・社会学・教育学・行動学等のテーマについて読解力・論理的思考力・表現力を問う。",
    type: "frequent",
    timeLimit: 90,
    field: "社会",
  },
  {
    id: "pq-osaka-foreign-1",
    universityId: "osaka-u",
    universityName: "大阪大学",
    facultyName: "外国語学部",
    year: 2024,
    theme: "言語・文化・国際関係に関する論述",
    description:
      "日本語課題文を読み、言語・文化・国際関係等のテーマについて論述する。外国語学部の総合型選抜で実施。",
    type: "frequent",
    timeLimit: 90,
    field: "国際",
  },
  ...
  // ===== 名古屋大学（追加分） =====
  {
    ...
    theme: "民主主義と陪審制",
    description:
      "以下の課題文（三谷太一郎『政治制度としての陪審制』を素材にしたサンプル文）を読み、民主主義と陪審制（裁判員制度）の関係について800字程度で読解・論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    description:
      "以下の課題文（前田健太郎『女性のいない民主主義』を素材にしたサンプル文）を読み、民主主義の定義を見直し女性の政治参加を促進するための方策について800字程度で読解・論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    description:
      "以下の課題文（猪木正徳『自由と秩序』を素材にしたサンプル文）を読み、現代民主制と市場競争における公平性の調整について800字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    description:
      "以下の課題文（入江昭『歴史家が見る現代世界』を素材にしたサンプル文）を読み、グローバル化が不可逆であることを前提に、今後の世界秩序の像について800字程度で考察しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    universityId: "nagoya-u",
    universityName: "名古屋大学",
    facultyName: "理学部（生命理学科）",
    year: 2025,
    theme: "生命科学分野の講義に基づく小論文",
    description:
      "第2次選考で生命科学分野の講義を受講し、その内容に基づく小論文を作成する。2025年度から総合型選抜を新設。",
    type: "past",
    field: "科学技術",
  },
  ...
  // ===== 東京大学（追加分） =====
  {
    ...
    facultyName: "文学部",
    year: 2024,
    theme: "文学部の学問領域の意義とジレンマ",
    description:
      "文学部で扱っている領域の意義や難しさ、ジレンマを説明する論説文を課題文として読み、筆者の述べている問題の大意を把握した上で議論を組み立てる。大問一：課題文要約400字＋小論文600字、大問二：文章読解型小論文800-1200字。",
    type: "past",
    wordLimit: 1200,
    field: "文化",
  },
  {
    ...
    theme: "翻訳の本質と意義",
    description:
      "翻訳についての課題文を読み、「翻訳はどのようなものと考えられているか」を800字以内でまとめ、さらに自分の見解を述べる。大問一は日本語課題文の要約＋小論文、大問二は文章読解型小論文の二題構成。",
    type: "past",
    wordLimit: 1200,
    field: "文化",
  },
  {
    id: "pq-todai-kyoyo-001",
    universityId: "tokyo-u",
    universityName: "東京大学",
    facultyName: "教養学部学際科学科",
    year: 2024,
    theme: "民主主義の危機と課題",
    description:
      "宇野重規『民主主義とは何か』を課題文として、民主主義の危機をどのように捉えるかについて論じる。課題文を要約した上で自身の意見を述べる形式。",
    type: "past",
    field: "社会",
  },
  {
    ...
    facultyName: "法学部",
    year: 2024,
    theme: "現代社会の重要問題と取り組み",
    description:
      "志願理由書として3つのお題に合計3000字で回答：①現代社会の中で重要だと思う問題は何か、②その問題について将来どのように取り組もうと思っているか、③その他入学後にやりたいことは何か。",
    type: "past",
    wordLimit: 3000,
    field: "法律",
  },
  {
    id: "pq-todai-bun1-001",
    universityId: "tokyo-u",
    universityName: "東京大学",
    facultyName: "文科一類（外国学校出身者入試）",
    year: 2022,
    theme: "技術と法・倫理の問題",
    description:
      "問題A：技術的に可能だが法的・倫理的に問題のある行為について論じる。問題B：平等原理の正当な例外適用について論じる。",
    type: "past",
    field: "法律",
  },
  {
    id: "pq-todai-bun2-001",
    universityId: "tokyo-u",
    universityName: "東京大学",
    facultyName: "文科二類（外国学校出身者入試）",
    year: 2022,
    theme: "感染症対策と社会経済活動の両立",
    description:
      "問題A：オミクロン株への感染症対策と社会経済活動の両立について論じる。問題B：データ活用における予期しない問題点と必要な配慮について論じる。",
    type: "past",
    field: "経済",
  },
  {
    id: "pq-todai-bun3-001",
    universityId: "tokyo-u",
    universityName: "東京大学",
    facultyName: "文科三類（外国学校出身者入試）",
    year: 2022,
    theme: "歴史を学ぶ意味と格差",
    description:
      "問題A：歴史を学ぶことの意味について論じる。問題B：「親ガチャ」と格差の固定化問題について論じる。",
    type: "past",
    field: "社会",
  },
  {
    ...
    universityId: "tokyo-u",
    universityName: "東京大学",
    facultyName: "理科一類（外国学校出身者入試）",
    year: 2022,
    theme: "感染症対策における科学者の役割",
    description:
      "問題A：感染症対策における科学者の貢献方法について論じる。問題B：科学技術の両義性（幸福と不幸の可能性）について論じる。",
    type: "past",
    field: "科学技術",
  },
  {
    id: "pq-todai-bun1-002",
    universityId: "tokyo-u",
    universityName: "東京大学",
    facultyName: "文科一類（外国学校出身者入試）",
    year: 2020,
    theme: "幸福度と民主主義",
    description:
      "問題A：幸福度統計資料に基づく政治・法制度設計について論じる。問題B：ソーシャルメディア発展の民主主義への影響について論じる。",
    type: "past",
    field: "法律",
  },
  {
    id: "pq-todai-bun2-002",
    universityId: "tokyo-u",
    universityName: "東京大学",
    facultyName: "文科二類（外国学校出身者入試）",
    year: 2020,
    theme: "経済格差と気候変動",
    description:
      "問題A：経済的格差拡大の原因と政府対策について論じる。問題B：気候変動対応における国家間公平性と経済成長について論じる。",
    type: "past",
    field: "経済",
  },
  ...
  // ===== 京都大学 特色入試（追加分） =====
  {
    ...
    theme: "災害間の日常と社会の備え",
    description:
      "特色入試。以下の課題文を読み、(1)「災間の思考」に基づく日常生活の備えについて800字程度、(2)社会における「溜め」「隙間」「無駄」がリスク対応に機能する事例について1,200字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1200,
    field: "社会",
  ...
  },
  {
    ...
    theme: "言語のディレンマと口述歴史",
    description:
      "特色入試。以下の課題文を読み、(1)「言語のディレンマ」を学びの観点から800字以内、(2)口述歴史と世界史における個人と全体の関係について800字以内で論じなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    field: "文化",
  ...
  },
  {
    ...
    theme: "日本の公教育と社会認識",
    description:
      "特色入試。以下の二つの課題文（著者A・著者B）を読み、(1)日本の公教育の課題について300字以内で要約、(2)両者の主張の共通点と相違点を分析した上で、共通点に対するあなたの考えを1,200字以内で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1200,
    field: "教育",
  ...
  },
  {
    ...
    theme: "家族法における国家介入",
    description:
      "英文を題材に日本語で解答する小論文（120分）。家族法における国家介入の必要性（400字程度）、家族に関する法制定の意義と問題点（1000字程度）。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 1000,
    timeLimit: 120,
  ...
  },
  {
    ...
    theme: "医療ケアと多職種チーム構築",
    description:
      "人体解剖における「さわる」と「ふれる」の区別、医療ケアのあり方、「山アラシのジレンマ」の具体例、多職種医療チームの構築など多数の小問から構成。",
    type: "past",
    wordLimit: 500,
    field: "医療",
  },
  {
    id: "pq-kyodai-yaku-001",
    universityId: "kyoto-u",
    universityName: "京都大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "AlphaFold2と医薬品開発",
    description:
      "Aminative Suzuki-Miyaura couplingの説明、AlphaFold2の開発方針、生物種による信頼度スコア差の理由、AlphaFoldの医薬品開発への応用について論述。英文課題あり。",
    type: "past",
    questionType: "english-reading",
    field: "医療",
  ...
  {
    id: "pq-kyodai-nou-001",
    universityId: "kyoto-u",
    universityName: "京都大学",
    facultyName: "農学部応用生命科学科",
    year: 2025,
    theme: "科学技術の二面性と生物間相互作用",
    description:
      "科学技術の二面性に関する論述、生物間相互作用の具体例説明、環境要素の影響調査実験の設計、生物間相互作用の応用例について論述。",
    type: "past",
    field: "科学技術",
  },
  {
    id: "pq-kyodai-nou-002",
    universityId: "kyoto-u",
    universityName: "京都大学",
    facultyName: "農学部地域環境工学科",
    year: 2025,
    theme: "Vertical Farmingと農業集約化",
    description:
      "英文を読んでvertical farmingの目的と具体例、aquaponicsの説明、農業集約化の方向性、環境問題解決への貢献について論述。",
    type: "past",
    questionType: "english-reading",
    field: "環境",
  ...
  {
    id: "pq-kyodai-nou-003",
    universityId: "kyoto-u",
    universityName: "京都大学",
    facultyName: "農学部食料・環境経済学科",
    year: 2025,
    theme: "CO2削減費用と割引率の経済学的議論",
    description:
      "英文を読んでSternとNordhausの割引率根拠の違い、SC-CO2分布の統計特性について論述。数学的関数分析も含む。",
    type: "past",
    questionType: "english-reading",
    field: "経済",
  ...
  },
  {
    ...
    description:
      "特色入試。以下の課題文を読み、(1)「わたしのもの」と「私有物」の関係をめぐる現代社会の課題、(2)断片化する情報空間における「わたし」の組織化、それぞれ日本語1,200字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1200,
    field: "社会",
  ...
  },
  {
    ...
    description:
      "特色入試。以下の課題文を読み、(1)現代における「ソクラテス的態度」の意義について800字以内、(2)音声と文字の関係について800字以内で論じなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    field: "文化",
  ...
  },
  {
    ...
    description:
      "特色入試。以下の課題文を読み、秘密と心理的発達の関係、およびデジタル空間における匿名コミュニケーションへの教育的対応について、それぞれ日本語400字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 400,
    field: "教育",
  ...
  {
    id: "pq-kyodai-hou-002",
    universityId: "kyoto-u",
    universityName: "京都大学",
    facultyName: "法学部",
    year: 2024,
    theme: "動物の権利と共生社会の法制度",
    description:
      "英文を題材に日本語で解答（120分）。'dedicated animal representatives'制度の説明（300字程度）、動物と共生する社会の法・政治制度について論じる（1200字程度）。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 1200,
    timeLimit: 120,
  ...
  {
    id: "pq-kyodai-yaku-002",
    universityId: "kyoto-u",
    universityName: "京都大学",
    facultyName: "薬学部",
    year: 2024,
    theme: "放射性薬剤療法とPiezoタンパク質",
    description:
      "放射性薬剤療法と放射線療法の違い、Click chemistryの特徴、Piezo遺伝子と骨における役割、未知機械刺激センサータンパク質の推定と実験設計。英文課題あり。",
    type: "past",
    questionType: "english-reading",
    field: "医療",
  ...
  {
    id: "pq-kyodai-nou-004",
    universityId: "kyoto-u",
    universityName: "京都大学",
    facultyName: "農学部食料・環境経済学科",
    year: 2024,
    theme: "アイルランド大飢饉と貧困の罠",
    description:
      "英文和訳と文脈分析、飢饉防止の方策、栄養問題における経済学視点の重要性、貧困の罠の発生メカニズムについて論述。数学的関数分析も含む。",
    type: "past",
    questionType: "english-reading",
    field: "経済",
  ...
  // ===== 東北大学 AO入試（追加分） =====
  {
    ...
    theme: "文章読解と自己見解の表現",
    description:
      "AO II期（180分）。以下の文章を読み、2つの小論文に回答しなさい。問1：著者の考えを説明する（600-800字）。問2：自分の見解を述べる（1400-1600字）。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1600,
    timeLimit: 180,
  ...
  },
  {
    ...
    description:
      "AO II期。以下の英文を読み、エビデンスに基づく教育政策のあり方について日本語400字程度で論述しなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 400,
    timeLimit: 120,
  ...
  },
  {
    ...
    theme: "英語読解と法的論理的思考",
    description:
      "AO II期。以下の英文を読み、多元的社会における法的推論のあり方について日本語800字程度で論述しなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 800,
    field: "法律",
  ...
  },
  {
    ...
    theme: "英文読解と技術課題への意見",
    description:
      "AO II期。以下の英文を読み、21世紀の持続可能な工学のあり方について日本語400字程度で論述しなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 400,
    field: "科学技術",
  ...
  },
  {
    ...
    theme: "理科系英文読解と科学的論述",
    description:
      "AO II期。以下の英文を読み、量子生物学の意義と今後の発展について日本語600字程度で論述しなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 600,
    field: "科学技術",
  ...
  },
  {
    ...
    theme: "医学と科学に関する論述",
    description:
      "AO III期。共通テスト950点＋提出書類・面接試験400点で選考。「医学」と「科学」に関連するテーマで出題される傾向。",
    type: "frequent",
    field: "医療",
  },
  {
    id: "pq-tohoku-nou-001",
    universityId: "tohoku-u",
    universityName: "東北大学",
    facultyName: "農学部",
    year: 2024,
    theme: "英文読解と農学的課題の考察",
    description:
      "AO II期。以下の英文を読み、土壌の健全性と持続可能な農業の関係について日本語500字程度で論述しなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 500,
    field: "科学技術",
  ...
  // ===== 北海道大学 フロンティア入試（追加分） =====
  {
    id: "pq-hokudai-igaku-001",
    universityId: "hokkaido-u",
    universityName: "北海道大学",
    facultyName: "医学部医学科",
    year: 2024,
    theme: "論理性・読解力・思考力の総合評価",
    description:
      "TypeI。課題論文と面接（MMI形式含む）による選考。課題論文は論理性、読解力、思考力、判断力等を問う。共通テスト720点以上が最終合格基準。",
    type: "past",
    field: "医療",
  },
  {
    id: "pq-hokudai-ri-001",
    universityId: "hokkaido-u",
    universityName: "北海道大学",
    facultyName: "理学部（数学科）",
    year: 2024,
    theme: "数学の適性試験",
    description:
      "TypeII。共通問題：数学計算（60分・150点）＋選択問題：数学論述（120分・150点）。多様な解答を想定した論述形式。",
    type: "past",
    timeLimit: 180,
    field: "科学技術",
  },
  {
    id: "pq-hokudai-ri-002",
    universityId: "hokkaido-u",
    universityName: "北海道大学",
    facultyName: "理学部（物理学科）",
    year: 2024,
    theme: "物理の適性試験",
    description:
      "TypeII。共通問題：数学計算＋選択問題：物理論述。重力加速度の測定、地下構造の探査、電流回路の性質、電磁誘導の応用などが出題。",
    type: "past",
    timeLimit: 180,
    field: "科学技術",
  },
  {
    id: "pq-hokudai-ri-003",
    universityId: "hokkaido-u",
    universityName: "北海道大学",
    facultyName: "理学部（化学科）",
    year: 2024,
    theme: "化学の適性試験",
    description:
      "TypeII。共通問題：数学計算＋選択問題：化学論述。化学の基礎知識と応用力、論理的思考力を問う論述形式。",
    type: "past",
    timeLimit: 180,
    field: "科学技術",
  },
  {
    id: "pq-hokudai-kou-001",
    universityId: "hokkaido-u",
    universityName: "北海道大学",
    facultyName: "工学部",
    year: 2024,
    theme: "工学適性試験と課題論文",
    description:
      "TypeI/II。TypeIは課題論文＋面接、TypeIIは適性試験（数学共通＋物理or化学選択）＋面接。工学的問題解決能力と論理的思考力を評価。",
    type: "past",
    field: "科学技術",
  },
  {
    id: "pq-hokudai-sui-001",
    universityId: "hokkaido-u",
    universityName: "北海道大学",
    facultyName: "水産学部",
    year: 2024,
    theme: "水産科学に関する課題論文",
    description:
      "TypeI。課題論文＋面接による選考。水産科学・海洋環境に関連するテーマで論理性、読解力、思考力を評価。",
    type: "past",
    field: "科学技術",
  },
  ...
  // ===== 明治大学（追加分） =====
  {
    ...
    facultyName: "政治経済学部",
    year: 2025,
    theme: "ジェンダーギャップ指数と日本社会",
    description:
      "グローバル型特別入学試験。世界経済フォーラムの「ジェンダー・ギャップ指数（GGI）2023」のデータを読み取り、日本のジェンダー格差の現状と課題について分析・論述しなさい。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 90,
    ...
    chartData: [
      ...
      {
        type: "bar",
        title: "管理職に占める女性比率の国際比較（2023・%）",
        xKey: "country",
        data: [
          { country: "スウェーデン", 比率: 43 },
          { country: "米", 比率: 41 },
          { country: "英", 比率: 37 },
          { country: "仏", 比率: 34 },
          { country: "韓国", 比率: 14 },
  ...
  },
  {
    ...
    theme: "コロナ禍と経済格差",
    description:
      "グローバル型特別入学試験。新型コロナウイルス感染症が各国の経済格差に与えた影響について、統計データをもとに分析し、今後の政策的対応について論述しなさい。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 90,
    ...
    chartData: [
      {
        type: "line",
        title: "主要国のジニ係数推移（OECD）",
        xKey: "year",
        data: [
          { year: "2015", 日本: 0.339, 米国: 0.39, 独: 0.289, 仏: 0.292 },
          { year: "2018", 日本: 0.334, 米国: 0.395, 独: 0.289, 仏: 0.291 },
          { year: "2020", 日本: 0.339, 米国: 0.375, 独: 0.296, 仏: 0.298 },
          { year: "2022", 日本: 0.34, 米国: 0.396, 独: 0.294, 仏: 0.296 },
        ],
        yKeys: [
          { key: "日本", name: "日本", color: "#EF4444" },
          { key: "米国", name: "米国", color: "#3B82F6" },
      ...
      {
        type: "bar",
        title: "コロナ禍での所得階層別就業率変化（2020年・%ポイント）",
        xKey: "income",
        data: [
          { income: "低所得層", 変化: -8.3 },
          { income: "中所得層", 変化: -3.2 },
        ...
        yKeys: [
          { key: "変化", name: "就業率変化（%ポイント）", color: "#EF4444" },
        ],
      },
    ],
  },
  {
    ...
    facultyName: "農学部",
    year: 2024,
    theme: "食料安全保障と持続可能な農業",
    description:
      "自己推薦特別入試。世界の食料安全保障の現状と課題について、持続可能な農業の観点から具体例を挙げて論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "環境",
  },
  {
    ...
    theme: "生物多様性の保全と農業",
    description:
      "自己推薦特別入試。農業活動が生物多様性に与える影響と、両立させるための方策について論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "環境",
  },
  {
    ...
    theme: "日本文化の国際発信",
    description:
      "総合型選抜。日本文化の海外への発信において、何が求められているか。具体的な文化事象を取り上げて論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "文化",
  },
  {
    ...
    theme: "グローバル化と日本語教育",
    description:
      "総合型選抜。グローバル化が進む中で日本語教育が果たすべき役割と課題について、具体例を挙げて論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "文化",
  },
  {
    ...
    theme: "デジタル社会と個人情報保護",
    description:
      "筆者は「長大な利用規約をスクロールして同意ボタンを押す行為が、真に自律的な意思決定と呼べるかは疑わしい」と述べている。この指摘を踏まえ、本人同意・国家による監視・AIプロファイリングのいずれかの論点を取り上げ、法学を学ぶ立場として望ましい制度設計についてあなたの考えを800字程度で論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "法律",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "企業の社会的責任（CSR）",
    description:
      "総合型選抜。企業の社会的責任（CSR）について、近年の具体的事例を挙げながら、その意義と課題を論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "経済",
  },
  {
    ...
    theme: "資料・データ分析型の出題",
    description:
      "政治経済学部グローバル型を中心に、図表・統計データを読み解き、社会問題を分析する出題形式が定着。農学部では専門分野に関する課題文型、文学部・国際日本学部では文化・社会に関する課題文型が主流。",
    type: "frequent",
    field: "社会",
  },
  ...
  // ===== 青山学院大学（追加分） =====
  {
    id: "pq-aoyama-gsc-001",
    universityId: "aoyama-u",
    universityName: "青山学院大学",
    facultyName: "地球社会共生学部",
    year: 2024,
    theme: "人口変動と経済成長",
    description:
      "自己推薦入試。人口変動が経済成長に与える影響について、先進国・途上国の事例を比較しながら60分で論述しなさい。国際社会問題がテーマ。",
    type: "past",
    wordLimit: 600,
    timeLimit: 60,
    field: "経済",
  },
  {
    ...
    theme: "労働生産性と産業構造の変化",
    description:
      "自己推薦入試。労働生産性の国際比較データを踏まえ、産業構造の変化が社会に与える影響について論じなさい。",
    type: "past",
    wordLimit: 600,
    timeLimit: 60,
    field: "経済",
  },
  {
    ...
    theme: "気候変動と国際協力",
    description:
      "自己推薦入試。気候変動に対する国際協力の現状と課題について論じなさい。環境問題に関する国際的視点が求められる。",
    type: "past",
    wordLimit: 600,
    timeLimit: 60,
    field: "環境",
  },
  {
    ...
    theme: "感染症と文明の共存",
    description:
      "課題文Bの筆者は「文明は感染症を完全に克服することはできない。共存の方法を、繰り返し作り直していくほかない」と述べ、課題文Aは黒死病がユダヤ人迫害など弱者への犠牲転嫁を生んだと指摘する。この両者の主張を踏まえ、感染症と文明の共存について現代社会が新たに直面している課題とあなたの考えを600字程度で論述しなさい。",
    type: "past",
    wordLimit: 600,
    timeLimit: 60,
    field: "社会",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "少子化と移民政策",
    description:
      "自己推薦入試。少子化に伴う労働力不足と移民政策の是非について、日本と他国の事例を比較して論じなさい。",
    type: "past",
    wordLimit: 600,
    timeLimit: 60,
    field: "社会",
  },
  {
    ...
    theme: "地域活動の歴史と社会的意義",
    description:
      "自己推薦入試1次課題。あなたの住んでいる、あるいは知っている地域での活動について具体的な事例を挙げ、その歴史的なバックグラウンドや今日の社会における意義を述べ、これからの活動の展望を2000字で述べなさい。",
    type: "past",
    wordLimit: 2000,
    timeLimit: 0,
    field: "地域",
  },
  {
    ...
    theme: "コミュニティとは何か",
    description:
      "自己推薦入試2次小論文。「コミュニティ」の概念について、あなた自身の経験を踏まえて900字で論じなさい。60分。",
    type: "past",
    wordLimit: 900,
    timeLimit: 60,
    field: "地域",
  },
  {
    ...
    theme: "ベルクソンの道徳論",
    description:
      "筆者は「社会は閉じた道徳なしには日常の安定を維持できず、開いた道徳なしには停滞と排他に陥る」と述べ、両者の緊張を保ち続けることを今日の課題とする。この主張を踏まえ、現代社会における道徳の役割についてあなたの考えを700字以内で論述しなさい。",
    type: "past",
    wordLimit: 700,
    timeLimit: 80,
    field: "文化",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "グラフ分析と文化政策論述",
    description:
      "筆者は「文化への支出を『贅沢』と呼ぶことは、共同体の言語能力そのものを『贅沢』と呼ぶに等しい」と述べる一方、「限られた財源の配分という現実的問いには十分には答えていない」と自ら認めている。この留保を踏まえ、資料1・2も根拠として用いながら、限られた公的財源のもとで文化支援をどう設計すべきか、あなたの立場を明示して500字程度で論述しなさい。",
    type: "past",
    wordLimit: 700,
    timeLimit: 80,
    field: "文化",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "一流品の「フレッシュネス」",
    description:
      "自己推薦入試。芸術における「一流品のフレッシュネス」について、具体的な作品を挙げて600字以内で述べなさい。",
    type: "past",
    wordLimit: 600,
    timeLimit: 60,
    field: "文化",
  ...
  {
    id: "pq-aoyama-art-003",
    universityId: "aoyama-u",
    universityName: "青山学院大学",
    facultyName: "文学部比較芸術学科",
    year: 2024,
    theme: "美術史・音楽史・演劇映像学の論旨置換",
    description:
      "自己推薦入試。文章を読んでその論旨を美術史・音楽史・演劇映像学のいずれかに置き換えて800字以内で論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "文化",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-aoyama-freq-002",
    universityId: "aoyama-u",
    universityName: "青山学院大学",
    facultyName: "全学部共通",
    year: 2025,
    theme: "地球社会共生学部は国際社会問題、コミュニティ人間科学部は地域課題",
    description:
      "地球社会共生学部は国際社会問題（人口・環境・格差）、コミュニティ人間科学部は地域課題・ボランティア、総合文化政策学部は古典・偉人の著作読解、比較芸術学科は芸術評論が定番テーマ。",
    type: "frequent",
    field: "社会",
  },
  ...
  // ===== 立教大学（追加分） =====
  {
    ...
    facultyName: "異文化コミュニケーション学部",
    year: 2022,
    theme: "言語や文化の違いと社会的問題",
    description:
      "自由選抜入試方式A。言語や文化の違いによって起きる社会的問題の具体例を挙げ、その問題に対するあなたの考えを2000字程度で論じなさい。",
    type: "past",
    wordLimit: 2000,
    timeLimit: 90,
    field: "文化",
  },
  {
    ...
    theme: "多言語社会における言語政策",
    description:
      "筆者は「言語政策は、技術的な配分問題であると同時に、社会の自己理解そのものを問う実践である」と述べている。この主張を踏まえ、筆者が提示する三つの立場のうちあなたが望ましいと考える方向性を、その根拠とともに1000字程度で論述しなさい。（90分・自由選抜入試方式A）",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "文化",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "翻訳と文化的コンテクスト",
    description:
      "筆者は「翻訳は受容する側の文化そのものを作り変える行為」であり、文化的コンテクストの判断は「技術はまだ代替できていない」と述べている。この主張を踏まえ、同化的翻訳と異化的翻訳の対比に触れながら、グローバル化と機械翻訳の進展のなかで翻訳と異文化理解はどうあるべきか、あなたの考えを1000字程度で論じなさい。（自由選抜入試方式A）",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "文化",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-rikkyo-biz-001",
    universityId: "rikkyo-u",
    universityName: "立教大学",
    facultyName: "経営学部",
    year: 2024,
    theme: "リーダーシップとチームマネジメント",
    description:
      "筆者は、現代のリーダーに求められるのは「触媒」としての役割でありながら、同時に「決断を下す責任、批判を受け止める覚悟、長期的なビジョンを示す力」も不可欠だと述べている。この「二つの役割の両立」という主張を踏まえ、あなた自身が部活動・生徒会・ボランティア等で経験したリーダーシップやチーム活動の事例と結びつけて800字程度で論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "経済",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-rikkyo-biz-002",
    universityId: "rikkyo-u",
    universityName: "立教大学",
    facultyName: "経営学部",
    year: 2023,
    theme: "イノベーションと企業の社会的価値",
    description:
      "自由選抜入試。企業のイノベーションが社会的価値の創出にどのように貢献するかについて論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "経済",
  ...
  {
    id: "pq-rikkyo-tour-001",
    universityId: "rikkyo-u",
    universityName: "立教大学",
    facultyName: "観光学部",
    year: 2024,
    theme: "持続可能な観光（サステナブルツーリズム）",
    description:
      "自由選抜入試。オーバーツーリズムの問題を踏まえ、持続可能な観光のあり方について論理的に構成し論述しなさい。60分。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "社会",
  },
  {
    ...
    theme: "地域観光資源の活用と課題",
    description:
      "自由選抜入試。地域の観光資源を活用した地域振興について、具体例を挙げて論じなさい。独創的発想が評価される。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "社会",
  },
  {
    ...
    universityId: "rikkyo-u",
    universityName: "立教大学",
    facultyName: "コミュニティ福祉学部",
    year: 2024,
    theme: "社会的包摂と福祉政策",
    description:
      "自由選抜入試。社会的排除の問題に対して、社会的包摂を実現するための福祉政策のあり方について論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "社会",
  },
  {
    ...
    theme: "高齢社会と地域共生",
    description:
      "自由選抜入試。超高齢社会における地域共生社会の実現に向けた課題と方策について論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "社会",
  },
  {
    ...
    theme: "法の支配と民主主義",
    description:
      "筆者は「法の支配は、民主主義を制約することによってかえって民主主義を健全に保つ装置でもある」と述べている。この主張を踏まえ、現代日本において法の支配と民主主義のバランスが問われる論点を一つ取り上げ、あなたの見解を800字程度で論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "法律",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-rikkyo-freq-002",
    universityId: "rikkyo-u",
    universityName: "立教大学",
    facultyName: "全学部共通",
    year: 2025,
    theme: "課題文読解型が主流、学部の専門性に応じたテーマ",
    description:
      "異文化コミュニケーション学部は言語・文化論、経営学部はビジネス・リーダーシップ、観光学部はサステナブルツーリズム、社会学部は現代社会問題、コミュニティ福祉学部は福祉・社会的包摂がそれぞれ頻出テーマ。",
    type: "frequent",
    field: "社会",
  },
  ...
  // ===== 中央大学（追加分） =====
  {
    ...
    description:
      "チャレンジ入学試験。以下の課題文を読み、憲法における人権保障の現代的課題について自身の見解を800字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    facultyName: "法学部",
    year: 2023,
    theme: "チャレンジ入試：国際法と主権",
    description:
      "チャレンジ入学試験。グローバル化時代における国際法と国家主権の関係について、具体的事例を踏まえて論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "法律",
  },
  {
    ...
    description:
      "英語運用能力特別入試（90分）。以下の英文を読み、法と正義の関係について、筆者の主張を踏まえつつ日本語800字程度で論じなさい。小論文と面接により総合評価。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    description:
      "英語運用能力特別入試（90分）。以下の英文を読み、現代の経済政策が所得格差に与える影響について日本語800字程度で論じなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    description:
      "英語運用能力特別入試（90分）。以下の英文を読み、デジタル経済の進展が雇用構造に与える影響について日本語800字程度で論じなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    description:
      "英語運用能力特別入試（90分）。以下の英文を読み、グローバル化が日本企業の経営戦略に与える影響について日本語800字程度で論じなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    theme: "異文化マネジメントの課題",
    description:
      "総合型選抜（自己推薦入試）。以下の課題文と資料を読み、異文化環境における企業マネジメントの課題についてデータを踏まえつつ800字程度で分析・論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    year: 2025,
    theme:
      "法学部はチャレンジ入試＋英語運用能力、経済・商は英語運用能力特別入試",
    description:
      "法学部チャレンジ入試は法・政治の課題文型、英語運用能力特別入試は法・経済・商3学部で実施。国際経営学部はデータ分析型。いずれも課題文を読み論述する形式が基本。",
    type: "frequent",
    field: "法律",
  },
  ...
  // ===== 法政大学（追加分） =====
  {
    ...
    universityId: "hosei-u",
    universityName: "法政大学",
    facultyName: "キャリアデザイン学部",
    year: 2024,
    theme: "「学ぶこと」と「働くこと」の関係",
    description:
      "キャリア体験自己推薦入試。課題文を読み、「学ぶこと」と「働くこと」の関係について、筆者の主張を要約した上で自身の意見を2000字程度で論述しなさい。60分。",
    type: "past",
    wordLimit: 2000,
    timeLimit: 60,
    field: "社会",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    facultyName: "キャリアデザイン学部",
    year: 2023,
    theme: "「生きること」をめぐるキャリア形成",
    description:
      "キャリア体験自己推薦入試。「生きること」をめぐる課題文を読み、キャリア形成の視点から筆者の主張を要約し、自身の考えを論述しなさい。",
    type: "past",
    wordLimit: 2000,
    timeLimit: 60,
    field: "社会",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    facultyName: "国際文化学部",
    year: 2024,
    theme: "SA先の言語・文化と学習計画",
    description:
      "SA自己推薦入試。SA（スタディ・アブロード）希望先の言語圏の文化について、入学後に何をどのように学びたいか、具体的な学習計画を600字で述べなさい。面接で深掘りされる。",
    type: "past",
    wordLimit: 600,
    timeLimit: 0,
    field: "国際",
  },
  {
    ...
    theme: "異文化交流と相互理解の促進",
    description:
      "SA自己推薦入試。異文化交流が相互理解の促進にどのように貢献するか、自身の経験や関心を踏まえて論じなさい。",
    type: "past",
    wordLimit: 600,
    timeLimit: 60,
    field: "国際",
  },
  {
    ...
    facultyName: "グローバル教養学部",
    year: 2024,
    theme: "Global Challenges and Liberal Arts",
    description:
      "GIS自己推薦入試（A基準）。英語によるEssay Writing。グローバルな課題に対してリベラルアーツの視点からどのようにアプローチすべきか論述しなさい。TOEFL Independent Writing形式に近い。",
    type: "past",
    wordLimit: 500,
    timeLimit: 60,
    field: "国際",
  },
  {
    ...
    facultyName: "グローバル教養学部",
    year: 2023,
    theme: "Cultural Diversity in Modern Society",
    description:
      "GIS自己推薦入試（A基準）。英語によるEssay Writing。現代社会における文化的多様性の意義と課題について、具体例を挙げて英語で論述しなさい。",
    type: "past",
    wordLimit: 500,
    timeLimit: 60,
    field: "国際",
  },
  {
    ...
    theme: "持続可能な社会と人間の共存",
    description:
      "自己推薦入試（60分：英語と小論文合計）。以下の英文を読み、人間と環境の共存に基づく持続可能な社会の実現方策について日本語600字程度で論じなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 600,
    timeLimit: 60,
  ...
  },
  {
    ...
    theme: "人間と人間の共生",
    description:
      "筆者は「共生」を『互いの存在を承認し、対立を非暴力的に処理する作法を共有すること』と定義し、その実現には学校教育・メディア・行政制度といった社会的基盤の整備が不可欠だと述べている。この主張を踏まえ、選択課題AまたはBのいずれか一つを選び、多様な価値観が共存する社会の実現に向けた具体的な方策について、あなたの考えを600字程度で論述しなさい。",
    type: "past",
    wordLimit: 600,
    timeLimit: 60,
    field: "社会",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "SNSと社会関係の変容",
    description:
      "筆者は「SNSは単に『便利な道具』ではなく、社会関係の構造そのものを再編する装置である」と述べ、関係の広く浅く化・自己呈示の戦略化・議論の対立化を指摘している。この主張を踏まえ、個人・教育・社会制度の各レベルでどのような取り組みが必要か、具体例を挙げて800字程度で論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "社会",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "地域福祉と住民参加",
    description:
      "総合型選抜。地域福祉の推進における住民参加の意義と課題について、具体的な事例を踏まえて論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "社会",
  ...
  {
    id: "pq-hosei-freq-003",
    universityId: "hosei-u",
    universityName: "法政大学",
    facultyName: "全学部共通",
    year: 2025,
    theme: "課題文型が全学部で主流、学部の特色に応じた出題",
    description:
      "キャリアデザイン学部は「学ぶ・働く・生きる」、国際文化学部は異文化・言語、GISは英語論述、人間環境学部は持続可能性、社会学部は現代社会問題がテーマ。課題文の要約＋自身の意見論述の形式が定着。",
    type: "frequent",
    field: "社会",
  },
  ...
  // ===== 慶應義塾大学（追加分） =====
  {
    ...
    description:
      "総合政策学部・小論文試験を想定した課題。以下の5つの資料を読み、米国・中国との関係を展望しつつ10年後の日本について日本語800字以内で論じ、合わせて日本経済を活性化するイノベーション施策を3つ提案しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 120,
  ...
  },
  {
    ...
    description:
      "総合政策学部・小論文試験を想定した課題。以下の文章1〜4のうち少なくとも3つに言及しつつ、大学での学びにおいて重要だと考えるものを日本語600字以内で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 600,
    timeLimit: 120,
  ...
  },
  {
    ...
    theme: "トレードオフと政策判断",
    description:
      "総合政策学部・小論文試験を想定した課題。以下の資料を読み解き、トレードオフをキー概念として、ある具体的な政策領域における判断のあり方について日本語1000字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 120,
  ...
  },
  {
    ...
    description:
      "環境情報学部・小論文試験を想定した課題。以下の6つの文献を熟読し、生物・環境・情報の相互作用を踏まえて『生きる』とは何かを、自身の見解として日本語1000字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 120,
  ...
  {
    id: "pq-keio-kankyo-n2",
    universityId: "keio-u",
    universityName: "慶應義塾大学",
    facultyName: "環境情報学部",
    year: 2022,
    theme: "フェルミ推定と未来改変シナリオ",
    description:
      "日本国内で購入されたシャープペンシルの本数を推定する問題、および2020年にタイムスリップして未来を変えるシナリオ。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 120,
    field: "社会",
  },
  {
    ...
    universityId: "keio-u",
    universityName: "慶應義塾大学",
    facultyName: "法学部（FIT入試B方式）",
    year: 2024,
    theme: "県立大学への進学者増加策",
    description:
      "【総合考査II】県知事の立場で県立大学への進学者を増やす政策を論じる。400字・45分。",
    type: "past",
    wordLimit: 400,
    timeLimit: 45,
    field: "社会",
  },
  {
    ...
    facultyName: "法学部（FIT入試B方式）",
    year: 2023,
    theme: "野党党首への批判に対する反論",
    description:
      "【総合考査II】批判ばかりしているとコメントされた野党党首の立場で反論を書く。400字・45分。",
    type: "past",
    wordLimit: 400,
    timeLimit: 45,
    field: "政治",
  },
  {
    ...
    facultyName: "法学部（FIT入試B方式）",
    year: 2022,
    theme: "高齢者の選挙権喪失制度の評価",
    description:
      "【総合考査II】老齢年金受給の高齢者は選挙権を失うという制度をどう評価するか。400字・45分。",
    type: "past",
    wordLimit: 400,
    timeLimit: 45,
    field: "法律",
  },
  {
    ...
    theme: "功利主義と動物の権利",
    description:
      "【総合考査II】功利主義に基づき、動物を食料・実験に用いることについて論じる。400字・45分。",
    type: "past",
    wordLimit: 400,
    timeLimit: 45,
    field: "倫理",
  },
  {
    ...
    universityId: "keio-u",
    universityName: "慶應義塾大学",
    facultyName: "文学部（自主応募推薦）",
    year: 2022,
    theme: "「文系学部廃止」の衝撃",
    description:
      "文学部・自主応募推薦を想定した課題。以下の課題文を読み、設問1で課題文の要約を、設問2で人文社会系の知の意義についての意見を、それぞれ日本語300字程度（合計600字以内）で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 600,
    timeLimit: 120,
  ...
  },
  {
    ...
    theme: "「ひとり」の哲学",
    description:
      "文学部・自主応募推薦を想定した課題。以下の課題文を読み、設問1で要約を、設問2で「ひとり」であることの意義についての意見を、それぞれ日本語300字程度（合計600字以内）で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 600,
    timeLimit: 120,
  ...
  },
  {
    ...
    description:
      "文学部・自主応募推薦を想定した課題。以下の課題文を読み、設問1で要約を、設問2で現代における友情の意義についての意見を、それぞれ日本語300字程度（合計600字以内）で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 600,
    timeLimit: 120,
  ...
  },
  {
    ...
    universityId: "keio-u",
    universityName: "慶應義塾大学",
    facultyName: "看護医療学部（AO入試）",
    year: 2022,
    theme: "介護と道具",
    description: "介護における道具の役割について約700字で論述。",
    type: "past",
    wordLimit: 700,
    timeLimit: 120,
    field: "医療",
  ...
  // ===== 関西大学（追加分） =====
  {
    id: "pq-kansai-law-ao2-001",
    universityId: "kansai-u",
    universityName: "関西大学",
    facultyName: "法学部（AO入試Ⅱ型）",
    year: 2024,
    theme: "『女性のいない民主主義』を読んで最も重要なテーマを論じる",
    description:
      "筆者は「女性議員が少ない政治の場では女性の生活経験に根ざした論点が可視化されにくく、さらに女性の政治参加が後退する循環が生じている」と述べ、これを民主主義の質の問題として捉えている。この主張を踏まえ、あなたが最も重要と考えるテーマを一つ取り上げ、それが社会全体にとってなぜ重要かを1,000字程度（上限1,500字）で論じなさい。",
    type: "past",
    wordLimit: 1500,
    timeLimit: 90,
    field: "法律",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-kansai-law-ao3-001",
    universityId: "kansai-u",
    universityName: "関西大学",
    facultyName: "法学部（AO入試Ⅲ型）",
    year: 2024,
    theme: "法曹志望者向け法的思考力小論文",
    description:
      "筆者は「法律家を志す者は、条文を覚え判例を分析する技術を身につけるだけでなく、『なぜその法が正当性を持つのか』『不正な法に対して何ができるのか』という根本的な問いを引き受け続けることが求められる」と述べている。この主張を踏まえ、「不正と感じる法律」に対して市民および法律家はどのように向き合うべきか、憲法・裁判制度・市民的不服従などの観点を含め、あなたの考えを1,000字以上1,500字以内で論じなさい。",
    type: "past",
    wordLimit: 1500,
    timeLimit: 90,
    field: "法律",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-kansai-econ-ao-001",
    universityId: "kansai-u",
    universityName: "関西大学",
    facultyName: "経済学部（AO入試）",
    year: 2024,
    theme: "ガソリン価格抑制政策の日本経済への影響",
    description:
      "AO入試（自己推薦型）課題エッセイ。原油価格高騰と円安によるガソリン価格高騰を受け、日本政府が実施したガソリン価格抑制政策が日本経済に与えた影響について、メリット・デメリットを整理した上で自らの見解を800字で論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "経済",
  ...
  {
    id: "pq-kansai-econ-ao-002",
    universityId: "kansai-u",
    universityName: "関西大学",
    facultyName: "経済学部（AO入試）",
    year: 2023,
    theme: "円安が日本の貿易・経済に与える影響",
    description:
      "AO入試（自己推薦型）課題エッセイ。急激な円安が日本の貿易収支や物価、企業活動に与える影響について、具体的なデータや事例を挙げて分析し、自らの見解を800字で述べなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "経済",
  ...
  {
    id: "pq-kansai-info-sf-002",
    universityId: "kansai-u",
    universityName: "関西大学",
    facultyName: "総合情報学部（SF入試）",
    year: 2023,
    theme: "情報技術の社会的影響に関するデータ分析",
    description:
      "SF入試小論文I。以下の統計資料を読み取り、情報技術の普及が社会に与える影響を分析し、論理的に結論を800字程度で導きなさい。※サンプル資料は練習用に生成された架空データです。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 60,
  ...
  },
  {
    ...
    description:
      "SF入試小論文I。以下の資料を読み取り、デジタル化がもたらす社会変革について、データに基づいて800字程度で論理的に分析し結論を述べなさい。※サンプル資料は練習用に生成された架空データです。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 60,
  ...
  {
    id: "pq-kansai-safety-sf-002",
    universityId: "kansai-u",
    universityName: "関西大学",
    facultyName: "社会安全学部（SF入試）",
    year: 2023,
    theme: "自然災害リスクと地域防災の課題",
    description:
      "SF入試小論文II。以下の資料を読み取り、筆者の主張と防災上の課題を整理した上で、具体例を挙げて自分の考えを800字程度で述べなさい。※サンプル資料は練習用に生成された架空データです。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 60,
  ...
  },
  {
    ...
    description:
      "SF入試小論文II。以下の資料を読み、感染症流行時における公衆衛生と社会活動の両立について、具体例を挙げて800字程度で論じなさい。※サンプル資料は練習用に生成された架空データです。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 60,
  ...
  {
    id: "pq-kansai-foreign-ao-001",
    universityId: "kansai-u",
    universityName: "関西大学",
    facultyName: "外国語学部（AO入試）",
    year: 2024,
    theme: "多言語社会における言語政策",
    description:
      "AO入試。外国語学部志望者として、多言語社会における言語政策の課題について、具体的な国・地域の事例を踏まえて論じなさい。推薦書必須。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 60,
    field: "国際",
  ...
  {
    id: "pq-kansai-policy-ao-001",
    universityId: "kansai-u",
    universityName: "関西大学",
    facultyName: "政策創造学部（AO入試）",
    year: 2024,
    theme: "地域活性化に関する政策提言",
    description:
      "AO入試。過疎化・少子高齢化が進む地域の活性化策について、具体的な政策を提案し、その実現可能性と期待される効果を論じなさい。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 60,
    field: "社会",
  ...
  {
    id: "pq-kansai-human-ao-001",
    universityId: "kansai-u",
    universityName: "関西大学",
    facultyName: "人間健康学部（AO入試）",
    year: 2024,
    theme: "健康寿命延伸と地域社会の役割",
    description:
      "AO入試。健康寿命の延伸に向けて地域社会が果たすべき役割について、スポーツ・福祉・コミュニティの観点から具体例を挙げて論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "社会",
  ...
  {
    id: "pq-kansai-freq-n1",
    universityId: "kansai-u",
    universityName: "関西大学",
    facultyName: "全学部共通",
    year: 2025,
    theme: "AO入試は指定図書型・課題エッセイ型、SF入試はデータ分析型が中心",
    description:
      "法学部Ⅱ型は指定図書の読解と論述（約1,000字・90分）、経済学部は課題エッセイ（800字）、総合情報学部SF入試はグラフ・データ分析型、社会安全学部SF入試は資料読解型。日頃のニュースへの関心と具体的経験に基づく記述が重視される。過去問は非公開だがAO入試ガイドブックに講評掲載。",
    type: "frequent",
    field: "総合",
  },
  ...
  // ===== 関西学院大学（追加分） =====
  {
    id: "pq-kwansei-theology-002",
    universityId: "kwansei-u",
    universityName: "関西学院大学",
    facultyName: "神学部（学部特色入試）",
    year: 2023,
    theme: "新約聖書における隣人愛の思想",
    description:
      "学部特色入学試験。講義を受講した上で、新約聖書における隣人愛の思想についてリポートを作成しなさい。キリスト教理解を中心とした知識・技能が評価される。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "文化",
  ...
  {
    id: "pq-kwansei-theology-003",
    universityId: "kwansei-u",
    universityName: "関西学院大学",
    facultyName: "神学部（学部特色入試）",
    year: 2022,
    theme: "キリスト教と現代社会の倫理的課題",
    description:
      "学部特色入学試験。講義・リポート形式。キリスト教の倫理観が現代社会の課題（生命倫理、環境問題等）にどのように示唆を与えるか論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "文化",
  ...
  {
    id: "pq-kwansei-law-001",
    universityId: "kwansei-u",
    universityName: "関西学院大学",
    facultyName: "法学部（学部特色入試）",
    year: 2024,
    theme: "現代の法的課題に関する論述",
    description:
      "筆者は「萎縮効果を最小化しつつ被害者の人格的利益を守るための繊細な制度設計が求められている」と述べ、規制の強弱という単純な二項対立を退けている。この主張を踏まえ、誹謗中傷規制と表現の自由のバランスをいかに設計すべきか、あなたの考えを800字程度で論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "法律",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-kwansei-law-002",
    universityId: "kwansei-u",
    universityName: "関西学院大学",
    facultyName: "法学部（学部特色入試）",
    year: 2023,
    theme: "デジタル社会とプライバシー権",
    description:
      "学部特色入学試験。デジタル技術の進展に伴うプライバシー権の保護と情報利活用のバランスについて、法的観点から論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "法律",
  ...
  {
    id: "pq-kwansei-commerce-001",
    universityId: "kwansei-u",
    universityName: "関西学院大学",
    facultyName: "商学部（学部特色入試）",
    year: 2024,
    theme: "企業の社会的責任（CSR）と持続可能な経営",
    description:
      "学部特色入学試験。企業の社会的責任（CSR）が持続可能な経営に与える影響について、具体的な企業事例を挙げて論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "経済",
  ...
  {
    id: "pq-kwansei-literature-001",
    universityId: "kwansei-u",
    universityName: "関西学院大学",
    facultyName: "文学部（学部特色入試）",
    year: 2024,
    theme: "言語と文化の関係性",
    description:
      "学部特色入学試験。言語が文化の形成にどのような役割を果たしているか、具体例を挙げて論じなさい。人文学的な視点と論理的思考力が問われる。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "文化",
  ...
  {
    id: "pq-kwansei-sociology-001",
    universityId: "kwansei-u",
    universityName: "関西学院大学",
    facultyName: "社会学部（探究評価型入試）",
    year: 2024,
    theme: "社会問題の探究と解決策の提案",
    description:
      "探究評価型入学試験。高校時代に取り組んだ探究活動の成果を踏まえ、社会学的視点から現代社会の課題を分析し、解決策を提案しなさい。プレゼンテーションと口頭試問。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "社会",
  ...
  {
    id: "pq-kwansei-sociology-002",
    universityId: "kwansei-u",
    universityName: "関西学院大学",
    facultyName: "社会学部（探究評価型入試）",
    year: 2023,
    theme: "地域コミュニティの変容と社会的課題",
    description:
      "探究評価型入学試験。地域コミュニティの変容がもたらす社会的課題について、探究活動の成果を踏まえて論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "社会",
  ...
  {
    id: "pq-kwansei-education-001",
    universityId: "kwansei-u",
    universityName: "関西学院大学",
    facultyName: "教育学部（学部特色入試）",
    year: 2024,
    theme: "教育現場におけるICT活用の可能性と課題",
    description:
      "学部特色入学試験。教育現場でのICT活用がもたらす学習効果と課題について、具体的な事例を挙げて論じなさい。教育への熱意と分析力が評価される。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "教育",
  ...
  {
    id: "pq-kwansei-education-002",
    universityId: "kwansei-u",
    universityName: "関西学院大学",
    facultyName: "教育学部（学部特色入試）",
    year: 2023,
    theme: "インクルーシブ教育の理念と実践",
    description:
      "学部特色入学試験。インクルーシブ教育の理念を踏まえ、多様な子どもが共に学ぶ教育環境の実現に向けた課題と方策を論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "教育",
  ...
  {
    id: "pq-kwansei-global-002",
    universityId: "kwansei-u",
    universityName: "関西学院大学",
    facultyName: "国際学部（グローバル入試）",
    year: 2023,
    theme: "気候変動と国際協力",
    description:
      "グローバル入学試験。気候変動問題に対する国際的な取り組みの現状と課題について、具体的な事例を挙げて英語または日本語で論述しなさい。筆記審査問題は公式サイトで公開。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "国際",
  ...
  {
    id: "pq-kwansei-global-003",
    universityId: "kwansei-u",
    universityName: "関西学院大学",
    facultyName: "国際学部（グローバル入試）",
    year: 2022,
    theme: "グローバル・ガバナンスの課題",
    description:
      "グローバル入学試験。国際機関の役割とグローバル・ガバナンスの課題について、具体的な事例を踏まえて論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "国際",
  ...
  {
    id: "pq-kwansei-freq-n1",
    universityId: "kwansei-u",
    universityName: "関西学院大学",
    facultyName: "全学部共通",
    year: 2025,
    theme:
      "学部特色入試は講義・リポート型、探究評価型はプレゼン＋口頭試問が主流",
    description:
      "神学部は講義受講後のリポート作成、法学部・商学部・文学部は課題文型小論文、社会学部・教育学部は探究活動の成果発表、国際学部のグローバル入試は筆記審査（公式サイトで過去問公開）。全14学部で総合型選抜を実施。2023年度に制度再編（探究評価型・学部特色・グローバル・スポーツ選抜の4類型）。",
    type: "frequent",
    field: "総合",
  },
  ...
  // ===== 同志社大学（追加分） =====
  {
    id: "pq-doshisha-commerce-ao-002",
    universityId: "doshisha-u",
    universityName: "同志社大学",
    facultyName: "商学部（AO入試）",
    year: 2024,
    theme: "ビジネスイノベーションに関する自由テーマエッセイ",
    description:
      "AO入試。ビジネスに関連した自由テーマで2,000字以内の日本語エッセイを提出。ビジネスイノベーションや起業、マーケティング等の独自の視点が求められる。",
    type: "past",
    wordLimit: 2000,
    field: "経済",
  },
  {
    id: "pq-doshisha-commerce-ao-003",
    universityId: "doshisha-u",
    universityName: "同志社大学",
    facultyName: "商学部（AO入試）",
    year: 2023,
    theme: "サステナブルビジネスに関する自由テーマエッセイ",
    description:
      "AO入試。ビジネスに関連した自由テーマで2,000字以内の日本語エッセイ。ESG経営やサステナビリティに関する考察が評価される。",
    type: "past",
    wordLimit: 2000,
    field: "経済",
  },
  {
    id: "pq-doshisha-sports-ao-002",
    universityId: "doshisha-u",
    universityName: "同志社大学",
    facultyName: "スポーツ健康科学部（AO入試）",
    year: 2024,
    theme: "スポーツと健康に関する自由テーマエッセイ",
    description:
      "AO入試。スポーツに関連した自由テーマで2,000字以内の日本語エッセイを提出。2次選考では30分間の面接（自己紹介・プレゼン・質疑応答）＋60分の小論文試験。",
    type: "past",
    wordLimit: 2000,
    timeLimit: 60,
    field: "スポーツ",
  ...
  {
    id: "pq-doshisha-sports-ao-003",
    universityId: "doshisha-u",
    universityName: "同志社大学",
    facultyName: "スポーツ健康科学部（AO入試）",
    year: 2023,
    theme: "スポーツ報道におけるジェンダー問題",
    description:
      "AO入試小論文試験。スポーツ報道において女性選手の実力より容姿が注目される傾向について、どのような社会的原因によって生じるのか考察しなさい。60分。",
    type: "past",
    wordLimit: 2000,
    timeLimit: 60,
    field: "スポーツ",
  ...
  {
    id: "pq-doshisha-theology-self-001",
    universityId: "doshisha-u",
    universityName: "同志社大学",
    facultyName: "神学部（自己推薦入試）",
    year: 2024,
    theme: "宗教と現代社会に関する自由テーマ小論文",
    description:
      "自己推薦入試。宗教や神学に関する自由テーマの小論文を提出。面接（口頭試問含む）で小論文の内容について深掘りされる。",
    type: "past",
    field: "文化",
  },
  {
    id: "pq-doshisha-gc-self-002",
    universityId: "doshisha-u",
    universityName: "同志社大学",
    facultyName: "グローバル・コミュニケーション学部（自己推薦入試）",
    year: 2024,
    theme: "英語長文読解に基づく小論文",
    description:
      "自己推薦入試（90分）。以下の英文を読み、現代社会における言語・アイデンティティ・帰属の関係について日本語800字以内で論述しなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    description:
      "自己推薦入試（90分）。以下の英文を読み、分極化が進む社会における異文化コミュニケーションの課題と可能性について日本語800字以内で論述しなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 800,
    timeLimit: 90,
  ...
  {
    id: "pq-doshisha-psychology-002",
    universityId: "doshisha-u",
    universityName: "同志社大学",
    facultyName: "心理学部（自己推薦入試）",
    year: 2023,
    theme: "認知バイアスと意思決定",
    description:
      "筆者は「完全にバイアスから自由になることはできない。しかし、その存在を知り、自らの判断を『外側から』点検する習慣を持つことは、よりよい意思決定への第一歩となる」と述べている。この主張を踏まえ、あなた自身や周囲の意思決定における認知バイアスの影響を具体例とともに挙げ、その対処法を心理学的視点から800字程度で論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "社会",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    description:
      "筆者は「差別はいけないと道徳的に説くだけでは不十分であり、認知の仕組みに根ざした働きかけが重要となる」と述べている。この主張を踏まえ、筆者が示す軽減策の内容を整理した上で、あなた自身が最も有効と考える取り組みを具体例を挙げて800字程度で論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "社会",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-doshisha-cis-self-001",
    universityId: "doshisha-u",
    universityName: "同志社大学",
    facultyName: "文化情報学部（自己推薦入試）",
    year: 2024,
    theme: "データサイエンスと文化研究の融合",
    description:
      "自己推薦入試。文化現象をデータサイエンスの手法で分析することの意義と可能性について、具体例を挙げて論じなさい。プレゼンテーション必須。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "科学技術",
  ...
  {
    id: "pq-doshisha-cis-self-002",
    universityId: "doshisha-u",
    universityName: "同志社大学",
    facultyName: "文化情報学部（自己推薦入試）",
    year: 2023,
    theme: "デジタルアーカイブと文化の保存",
    description:
      "自己推薦入試。デジタル技術を用いた文化資産の保存・活用について、具体的な事例を踏まえて論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "文化",
  ...
  {
    id: "pq-doshisha-policy-self-001",
    universityId: "doshisha-u",
    universityName: "同志社大学",
    facultyName: "政策学部（自己推薦入試）",
    year: 2024,
    theme: "地域政策と住民参加",
    description:
      "自己推薦入試。地域の政策課題に対する住民参加型のアプローチについて、具体的な事例を挙げて論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "社会",
  ...
  {
    id: "pq-doshisha-engineering-ao-001",
    universityId: "doshisha-u",
    universityName: "同志社大学",
    facultyName: "理工学部機械系（AO入試）",
    year: 2023,
    theme: "機械工学が低炭素社会の実現に果たす役割",
    description:
      "AO入試。機械工学が低炭素社会の実現に果たす役割についてあなたの考えを述べなさい。科学的知識と社会課題への関心が問われる。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "科学技術",
  ...
  {
    id: "pq-doshisha-freq-n1",
    universityId: "doshisha-u",
    universityName: "同志社大学",
    facultyName: "全学部共通",
    year: 2025,
    theme:
      "AO入試は自由テーマエッセイ（2,000字）、自己推薦は課題文型小論文が中心",
    description:
      "商学部・スポーツ健康科学部のAO入試は自由テーマ（学部関連）の日本語エッセイ2,000字以内＋面接。自己推薦入試は法学部・心理学部・GC学部等で課題文型小論文＋口頭試問。心理学部は公式サイトで過去問を公開。GC学部は英語長文読解型。神学部は自由テーマ。面接では小論文内容が深掘りされる。",
    type: "frequent",
    field: "総合",
  },
  ...
  // ===== 立命館大学（追加分） =====
  {
    id: "pq-ritsumeikan-sansha-001",
    universityId: "ritsumeikan-u",
    universityName: "立命館大学",
    facultyName: "産業社会学部（産業社会小論文方式）",
    year: 2024,
    theme: "現代社会の諸問題に関する課題文型小論文",
    description:
      "筆者は「『つながりを増やす』ことが必ずしも本人の幸福を意味するとは限らず、行政が介入することがかえって本人の尊厳を損なうこともある」としながらも、社会的な支援の必要性を論じている。この筆者の立場を踏まえ、孤独・孤立を社会全体で支える仕組みとして有効と考える取り組みを、あなた自身の経験や関心を交えながら800字程度で論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 80,
    field: "社会",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    description:
      "筆者は「メディアリテラシー」を〈単に『フェイクを見抜く技術』にとどまらず、自分自身の情報摂取のクセを自覚し、意見の異なる相手の言葉に耳を傾ける態度、感情的に反応する前に一呼吸置く節度をも含む、総合的な構え〉と定義している。この定義を踏まえ、SNS時代の世論形成における問題と、メディアリテラシーをどう育てるべきかについて、あなたの考えを800字程度で論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 80,
    field: "社会",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "都市計画と共生の思想",
    description:
      "筆者は「職住分離は長距離通勤と地域コミュニティの希薄化を生んだ」と述べ、近代の分離主義の限界を指摘したうえで、江戸の雑居性・複合性・多義性を現代の制度と技術の文脈で再解釈する「共生」の都市を提唱している。この主張を踏まえ、これからの日本の都市計画はどうあるべきか、具体例を交えて800字程度で論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 80,
    field: "社会",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    description:
      "筆者は「重要なのは、彼らを『支援される対象』として一方的に見るのではなく、それぞれの言語・文化を尊重し、社会の側が変わっていく姿勢である」と述べている。この主張を踏まえ、学校・地域社会が外国にルーツを持つ子どもたちとどのように関わるべきか、あなたの考えを800字程度で論じなさい。（AO選抜・80分）",
    type: "past",
    wordLimit: 800,
    timeLimit: 80,
    field: "教育",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-ritsumeikan-policy-001",
    universityId: "ritsumeikan-u",
    universityName: "立命館大学",
    facultyName: "政策科学部（AO選抜）",
    year: 2024,
    theme: "政策科学的視点からの社会課題分析",
    description:
      "AO選抜。以下の資料を読み、政策科学の視点から社会課題を分析した上で、具体的な政策提言を含めて800字程度で論述しなさい。※サンプル資料は練習用に生成された架空データです。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 80,
  ...
  },
  {
    ...
    description:
      "AO選抜。以下の資料を読み、少子高齢化が進む中での地方創生に関する政策的課題を分析した上で、解決策を800字程度で提案しなさい。※サンプル資料は練習用に生成された架空データです。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 80,
  ...
  {
    id: "pq-ritsumeikan-lit-002",
    universityId: "ritsumeikan-u",
    universityName: "立命館大学",
    facultyName: "文学部（AO選抜）",
    year: 2024,
    theme: "人文学的テーマに関する資料・講義ベース小論文",
    description:
      "AO選抜。2025年度より小論文のみに変更（GD廃止）。資料・講義の内容を元に人文学的テーマについて論述しなさい。独創性・論理性・思考力・表現力が評価される。",
    type: "past",
    wordLimit: 800,
    timeLimit: 80,
    field: "文化",
  ...
  {
    id: "pq-ritsumeikan-eizo-001",
    universityId: "ritsumeikan-u",
    universityName: "立命館大学",
    facultyName: "映像学部（AO選抜）",
    year: 2024,
    theme: "映像メディアと社会の関係性",
    description:
      "AO選抜。映像メディアが社会に与える影響について、具体的な映像作品や事例を挙げて論じなさい。映像に対する深い関心と独自の視点が求められる。",
    type: "past",
    wordLimit: 800,
    timeLimit: 80,
    field: "芸術",
  },
  {
    ...
    theme: "AIと映像制作の未来",
    description:
      "AO選抜。AI技術の発展が映像制作にもたらす可能性と課題について、具体例を挙げて論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 80,
    field: "芸術",
  ...
  {
    id: "pq-ritsumeikan-food-001",
    universityId: "ritsumeikan-u",
    universityName: "立命館大学",
    facultyName: "食マネジメント学部（AO選抜）",
    year: 2024,
    theme: "食の安全と持続可能性に関する課題論文",
    description:
      "筆者は「『食』をめぐる選択は、極めて個人的な行為であると同時に、地球と未来世代に対する集合的な責任を伴う行為でもある」と述べている。この主張を踏まえ、食の安全と持続可能性を両立するフードシステムを構築するために、消費者・生産者・行政・企業のそれぞれが果たすべき役割について、具体例を挙げて2,000字以内で論じなさい。",
    type: "past",
    wordLimit: 2000,
    field: "社会",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    description:
      "筆者は「フードロス削減は単なる社会貢献ではなく、原価率の改善やESG投資への対応など、複数の利益と直結する課題である」と述べる一方、「一企業の取り組みだけでは解決しきれない課題も多い」と指摘している。この主張を踏まえ、企業と社会それぞれの役割をどう設計すべきか、事業系・家庭系それぞれの課題に言及しながら2,000字以内で論じなさい。",
    type: "past",
    wordLimit: 2000,
    field: "経済",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-ritsumeikan-sports-001",
    universityId: "ritsumeikan-u",
    universityName: "立命館大学",
    facultyName: "スポーツ健康科学部（AO選抜）",
    year: 2024,
    theme: "スポーツ科学と健康増進",
    description:
      "AO選抜。スポーツ科学の知見を活用した健康増進策について、具体的なエビデンスを挙げて論じなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 80,
    field: "スポーツ",
  ...
  {
    id: "pq-ritsumeikan-freq-n1",
    universityId: "ritsumeikan-u",
    universityName: "立命館大学",
    facultyName: "全学部共通",
    year: 2025,
    theme:
      "AO選抜は課題文型小論文（80分）が中心、学部により講義型・課題図書型も",
    description:
      "産業社会学部は「現代社会の諸問題」課題文型80分、政策科学部は資料分析＋政策提言型、文学部は資料・講義ベース（2025年度よりGD廃止→小論文のみ）、映像学部は映像メディア関連、食マネジメント学部は課題図書＋プレゼン型、国際関係学部は講義選抜方式。法学部以外の全15学部で実施。過去2年分の過去問・講評を公式サイトで公開。",
    type: "frequent",
    field: "総合",
  },
  ...
  // ===== 早稲田大学（追加分） =====
  {
    ...
    universityId: "waseda-u",
    universityName: "早稲田大学",
    facultyName: "社会科学部（全国自己推薦）",
    year: 2023,
    theme: "SNSの発達がもたらした影響",
    description:
      "SNSのメリット・デメリット（エコーチェンバー現象等）について800字以内で論じる。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "社会",
  },
  {
    ...
    theme: "観光立国を目指すための改善",
    description:
      "日本が「観光立国」「観光大国」を目指すにはどのような改善が必要か。800字以内。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "社会",
  },
  {
    ...
    facultyName: "社会科学部（全国自己推薦）",
    year: 2021,
    theme: "コロナがもたらしたものと今後の社会",
    description: "コロナがもたらしたものを今後の社会にどう繋げるべきか論じる。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "社会",
  },
  {
    ...
    facultyName: "社会科学部（全国自己推薦）",
    year: 2020,
    theme: "歩きスマホがなくならない理由",
    description:
      "歩きスマホが社会問題化する中、なぜなくならないのか800字以内で論じる。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "社会",
  ...
  {
    id: "pq-waseda-arch-n1",
    universityId: "waseda-u",
    universityName: "早稲田大学",
    facultyName: "創造理工学部建築学科（創成入試）",
    year: 2023,
    theme: "空間の創造的配置とデッサン",
    description:
      "4つの立体を創造的に配置した空間をイメージし、デッサンと文章で表現する。120分。",
    type: "past",
    wordLimit: 800,
    timeLimit: 120,
    field: "芸術",
  ...
  {
    id: "pq-waseda-sport-n1",
    universityId: "waseda-u",
    universityName: "早稲田大学",
    facultyName: "スポーツ科学部（総合型選抜III群）",
    year: 2025,
    theme: "大学生は「子ども」か「大人」か",
    description: "601字以上1,000字以内で論じる。90分。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "社会",
  },
  {
    ...
    theme: "スポーツがなくなった世界",
    description:
      "「この世からスポーツがなくなったらどうなるか」601字以上1,000字以内。90分。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "スポーツ",
  ...
  {
    id: "pq-waseda-sport-n3",
    universityId: "waseda-u",
    universityName: "早稲田大学",
    facultyName: "スポーツ科学部（総合型選抜III群）",
    year: 2023,
    theme: "退屈の意味",
    description: "「退屈の意味」について601字以上1,000字以内で論じる。90分。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "社会",
  ...
  {
    id: "pq-waseda-human-n1",
    universityId: "waseda-u",
    universityName: "早稲田大学",
    facultyName: "人間科学部（FACT選抜）",
    year: 2023,
    theme: "事前課題に基づく総合的論述試験",
    description:
      "FACT選抜（120分）。以下の英文を読み、人間行動の理解における学際的アプローチの意義について日本語800字程度で論じなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 800,
    timeLimit: 120,
  ...
  // ===== 上智大学（追加分） =====
  {
    ...
    universityId: "sophia-u",
    universityName: "上智大学",
    facultyName: "法学部法律学科（公募推薦）",
    year: 2022,
    theme: "社会における法の役割",
    description:
      "法が果たす役割・機能について具体例を挙げて論じ、大学で法律学を学ぶ意義を述べる。800字・60分。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "法律",
  },
  {
    ...
    facultyName: "法学部法律学科（公募推薦）",
    year: 2023,
    theme: "生活保護制度に関する法的考察",
    description:
      "生活保護制度の法的問題点と自分の立場を論じる。反論想定と再反論も記述。800字・60分。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "法律",
  ...
  {
    id: "pq-sophia-global-n1",
    universityId: "sophia-u",
    universityName: "上智大学",
    facultyName: "総合グローバル学部（公募推薦）",
    year: 2023,
    theme: "グローバリゼーションと軍事同盟",
    description:
      "公募推薦（90分）。以下の課題文を読み、グローバル化が深化する中で軍事同盟が果たす役割について、日本語800字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    theme: "難民2世の問題",
    description:
      "公募推薦（90分）。以下の課題文を読み、難民第二世代が直面する課題と、受入社会が果たすべき役割について日本語800字程度で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    universityId: "sophia-u",
    universityName: "上智大学",
    facultyName: "文学部哲学科（公募推薦）",
    year: 2022,
    theme: "「覚える」と「分かる」の違い",
    description: "哲学的に考察し論述する。800字・60分。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "文化",
  ...
  {
    id: "pq-sophia-econ-n1",
    universityId: "sophia-u",
    universityName: "上智大学",
    facultyName: "経済学部（公募推薦）",
    year: 2022,
    theme: "貧困の定義の変化",
    description: "貧困の定義の変化を経済学的観点から論述。800字・60分。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "経済",
  ...
  {
    id: "pq-sophia-human-n1",
    universityId: "sophia-u",
    universityName: "上智大学",
    facultyName: "総合人間科学部社会福祉学科（公募推薦）",
    year: 2022,
    theme: "平和と社会福祉",
    description: "「平和」をテーマに社会福祉の観点から論述。800字・60分。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "社会",
  ...
  // ===== 京都産業大学（追加分） =====
  {
    id: "pq-kyoto-sangyo-mgmt-n1",
    universityId: "kyoto-sangyo-u",
    universityName: "京都産業大学",
    facultyName: "経営学部（総合型選抜）",
    year: 2024,
    theme: "女性の年齢階級別労働力率の変化",
    description:
      "総合型選抜1次選考。以下の資料を読み取り、女性の年齢階級別労働力率の変化の背景と今後の課題について、自身の考えを60分で800字程度に論述しなさい。※サンプル資料は練習用に生成された架空データです。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 60,
  ...
  {
    id: "pq-kyoto-sangyo-mgmt-n2",
    universityId: "kyoto-sangyo-u",
    universityName: "京都産業大学",
    facultyName: "経営学部（総合型選抜）",
    year: 2023,
    theme: "人工知能（AI）の普及と生活の変化",
    description:
      "総合型選抜1次選考。AI技術の普及が人々の生活や働き方にどのような変化をもたらすか、参考資料に基づき自身の考えを60分で論述。",
    type: "past",
    timeLimit: 60,
    field: "テクノロジー",
  },
  {
    id: "pq-kyoto-sangyo-mgmt-n3",
    universityId: "kyoto-sangyo-u",
    universityName: "京都産業大学",
    facultyName: "経営学部（総合型選抜）",
    year: 2022,
    ...
    description:
      "総合型選抜1次選考。以下の図表資料を読み取り、コロナ禍における男女の雇用状況の違いを生んだ要因と対策について、60分で800字程度に論述しなさい。※サンプル資料は練習用に生成された架空データです。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 60,
  ...
  {
    id: "pq-kyoto-sangyo-modern-n1",
    universityId: "kyoto-sangyo-u",
    universityName: "京都産業大学",
    facultyName: "現代社会学部（総合型選抜）",
    year: 2024,
    theme: "地域社会の持続可能性と若者の役割",
    description:
      "総合型選抜。地方の人口減少と地域社会の持続可能性について、若者がどのような役割を果たせるか論述。",
    type: "past",
    timeLimit: 60,
    field: "社会",
  },
  {
    id: "pq-kyoto-sangyo-modern-n2",
    universityId: "kyoto-sangyo-u",
    universityName: "京都産業大学",
    facultyName: "現代社会学部（総合型選抜）",
    year: 2023,
    theme: "SNS社会における情報リテラシー",
    description:
      "総合型選抜。SNSの普及がもたらす情報環境の変化と、情報リテラシー教育の在り方について論述。",
    type: "past",
    timeLimit: 60,
    field: "社会",
  },
  {
    id: "pq-kyoto-sangyo-foreign-n1",
    universityId: "kyoto-sangyo-u",
    universityName: "京都産業大学",
    facultyName: "外国語学部（総合型選抜）",
    year: 2024,
    theme: "多言語社会における言語政策",
    description:
      "総合型選抜。グローバル化が進む中での多言語社会の課題と言語政策について、具体例を挙げて論述。",
    type: "past",
    timeLimit: 60,
    field: "国際",
  },
  {
    id: "pq-kyoto-sangyo-culture-n1",
    universityId: "kyoto-sangyo-u",
    universityName: "京都産業大学",
    facultyName: "文化学部（総合型選抜）",
    year: 2024,
    theme: "伝統文化の継承と現代社会",
    description:
      "総合型選抜。1次は成果報告書（関心分野の論文）提出、2次はグループ・ディスカッション。伝統文化の保存と活用について論じる。",
    type: "past",
    field: "文化",
  },
  {
    id: "pq-kyoto-sangyo-info-n1",
    universityId: "kyoto-sangyo-u",
    universityName: "京都産業大学",
    facultyName: "情報理工学部（総合型選抜）",
    year: 2024,
    theme: "デジタル社会における情報セキュリティ",
    description:
      "総合型選抜。デジタル化が進む社会におけるサイバーセキュリティの課題と対策について論述。",
    type: "past",
    timeLimit: 60,
    field: "科学技術",
  },
  ...
  // ===== 近畿大学（追加分） =====
  {
    id: "pq-kindai-int-ao-n1",
    universityId: "kindai-u",
    universityName: "近畿大学",
    facultyName: "国際学部（総合型選抜AO入試）",
    year: 2023,
    theme: "グローバル化と文化的多様性の保護",
    description:
      "総合型選抜（AO入試）。国際社会におけるグローバル化と文化的多様性の保護の両立について分析・論述。公式サイトにPDF公開。",
    type: "past",
    field: "国際",
  },
  {
    id: "pq-kindai-int-ao-n2",
    universityId: "kindai-u",
    universityName: "近畿大学",
    facultyName: "国際学部（総合型選抜AO入試）",
    year: 2022,
    theme: "移民・難民問題と国際協力",
    description:
      "総合型選抜（AO入試）。移民・難民問題をめぐる国際社会の対応と今後の国際協力の在り方について論述。",
    type: "past",
    field: "国際",
  },
  {
    ...
    universityId: "kindai-u",
    universityName: "近畿大学",
    facultyName: "法学部（推薦入試）",
    year: 2023,
    theme: "立憲主義と家庭への政治の介入",
    description:
      "推薦入試。立憲主義の観点から、家庭生活への国家の介入の是非について法的・倫理的に論述。",
    type: "past",
    field: "法律",
  },
  {
    ...
    facultyName: "法学部（推薦入試）",
    year: 2022,
    theme: "自由と民主主義と人権の普遍性",
    description:
      "推薦入試。自由・民主主義・人権の普遍的価値について、国際的な視野から論じる。",
    type: "past",
    field: "法律",
  },
  {
    ...
    facultyName: "法学部（推薦入試）",
    year: 2024,
    theme: "ディストピア小説における管理国家と人権",
    description:
      "推薦入試。ディストピア小説に描かれるウルトラ管理国家（脳にデバイス・遺伝子操作）への賛成論と反対論を論述。",
    type: "past",
    field: "法律",
  },
  {
    ...
    universityId: "kindai-u",
    universityName: "近畿大学",
    facultyName: "文芸学部（一般前期）",
    year: 2024,
    theme: "「灯台下暗し」と思った経験",
    description:
      "一般前期。ことわざ「灯台下暗し」に関連する自身の経験を800〜1000字で具体的に記述。文芸学部の定番パターン。",
    type: "past",
    wordLimit: 1000,
    field: "文化",
  },
  {
    ...
    universityId: "kindai-u",
    universityName: "近畿大学",
    facultyName: "医学部（一般前期）",
    year: 2024,
    theme: "医師の働き方改革と医療の質",
    description:
      "一般前期。2024年4月施行の医師の働き方改革が医療の質に与える影響について400字以内で論述。",
    type: "past",
    wordLimit: 400,
    field: "医療",
  },
  {
    id: "pq-kindai-econ-n1",
    universityId: "kindai-u",
    universityName: "近畿大学",
    facultyName: "経済学部（推薦入試）",
    year: 2024,
    theme: "少子高齢化と経済成長",
    description:
      "推薦入試。少子高齢化が日本経済に与える影響と成長戦略について論述。社会問題と経済のリンクが問われる。",
    type: "past",
    field: "経済",
  },
  ...
  // ===== 甲南大学（追加分） =====
  {
    ...
    universityId: "konan-u",
    universityName: "甲南大学",
    facultyName: "法学部（公募推薦・教科科目型）",
    year: 2024,
    theme: "法と社会正義に関する論述",
    description:
      "公募制推薦入学試験【教科科目型】。教科試験（英語・国語等）に加え面接。法的思考力と社会問題への関心が問われる。",
    type: "past",
    field: "法律",
  },
  {
    ...
    universityId: "konan-u",
    universityName: "甲南大学",
    facultyName: "理工学部（公募推薦・教科科目型）",
    year: 2024,
    theme: "科学技術と持続可能な社会",
    description:
      "公募制推薦入学試験【教科科目型】。教科試験に加え面接。科学技術が持続可能な社会構築にどう貢献できるか論述。",
    type: "past",
    field: "科学技術",
  },
  {
    id: "pq-konan-intel-n1",
    universityId: "konan-u",
    universityName: "甲南大学",
    facultyName: "知能情報学部（公募推薦・教科科目型）",
    year: 2024,
    theme: "情報技術と社会変革",
    description:
      "公募制推薦入学試験【教科科目型】。AI・情報技術が社会にもたらす変革と課題について論述。",
    type: "past",
    field: "科学技術",
  },
  {
    id: "pq-konan-global-n1",
    universityId: "konan-u",
    universityName: "甲南大学",
    facultyName: "グローバル教養学環（個性重視型）",
    year: 2025,
    theme: "グローバル社会における異文化理解",
    description:
      "公募制推薦入学試験【個性重視型】。書類審査と面接で選考。国際的な視野と異文化理解力が評価される。",
    type: "past",
    field: "国際",
  },
  {
    id: "pq-konan-lit-jpn-n1",
    universityId: "konan-u",
    universityName: "甲南大学",
    facultyName: "文学部日本語日本文学科（教科科目型）",
    year: 2024,
    theme: "日本語・日本文学に関する論述",
    description:
      "公募制推薦入学試験【教科科目型】。教科試験と面接。日本語・日本文学への理解と表現力が問われる。",
    type: "past",
    field: "文化",
  },
  {
    ...
    universityId: "konan-u",
    universityName: "甲南大学",
    facultyName: "経済学部（個性重視型）",
    year: 2023,
    theme: "格差社会と経済政策",
    description:
      "公募制推薦入学試験【個性重視型】。経済格差の現状と是正策について、グループワーク形式で議論・発表。",
    type: "past",
    field: "経済",
  },
  {
    id: "pq-konan-mgmt-cube-n1",
    universityId: "konan-u",
    universityName: "甲南大学",
    facultyName: "マネジメント創造学部（個性重視型）",
    year: 2023,
    theme: "起業と社会課題解決",
    description:
      "公募制推薦入学試験【個性重視型】。起業やビジネスによる社会課題解決について面接で論述。問題意識と提案力が評価される。",
    type: "past",
    field: "経済",
  },
  {
    id: "pq-konan-lit-sociology-n1",
    universityId: "konan-u",
    universityName: "甲南大学",
    facultyName: "文学部社会学科（教科科目型）",
    year: 2024,
    theme: "現代社会の諸問題に関する論述",
    description:
      "公募制推薦入学試験【教科科目型】。教科試験と面接で選考。社会学的視点から現代社会の課題を分析する力が求められる。",
    type: "past",
    field: "社会",
  },
  ...
  // ===== 龍谷大学（追加分） =====
  {
    id: "pq-ryukoku-lit-n1",
    universityId: "ryukoku-u",
    universityName: "龍谷大学",
    facultyName: "文学部（総合型選抜・学部独自方式）",
    year: 2024,
    theme: "課題文読み取り型・人文学的論述",
    description:
      "筆者は「ある時代に当然とされた家族のあり方が、別の時代には全く違っていたことを学ぶとき、私たちは『今ある形が唯一の正解ではない』と気づく」と述べている。この気づきが筆者の言う「人文学の役立つ」という主張とどのように結びつくかを400字程度で説明した上で、あなた自身が人文学を学ぶ意義についての考えを400字程度で論じなさい。",
    type: "past",
    wordLimit: 800,
    field: "文化",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "宗教と現代社会の関わり",
    description:
      "筆者は「宗教を公共の場から完全に排除するのでもなく、特定の宗教を社会に押しつけるのでもなく、宗教が培ってきた知恵や営みを信仰の有無を超えた共有財として捉え直すこと」を提唱している。この主張を踏まえ、宗教と現代社会の望ましい関係について、龍谷大学の建学の精神と関連づけながらあなたの考えを400字程度で論じなさい。",
    type: "past",
    wordLimit: 800,
    field: "文化",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-ryukoku-econ-n1",
    universityId: "ryukoku-u",
    universityName: "龍谷大学",
    facultyName: "経済学部（総合型選抜・学部独自方式）",
    year: 2024,
    theme: "経済格差と社会的包摂",
    description:
      "【設問1】筆者は「経済格差の問題は所得や資産だけでは捉えきれない」と述べ、より広い意味での「包摂からの排除」が経済格差と相互に強化し合いながら進行していると論じている。筆者がいう「包摂からの排除」の内容と、それが経済格差とどのように関係しているかを400字程度でまとめなさい。\n【設問2】筆者は格差是正の手段として「短期的な再分配と長期的な機会形成のどちらをどう組み合わせるかは、社会の合意形成にかかっている」と述べている。この筆者の指摘を踏まえ、あなたが優先すべきと考える施策とその理由を600字程度で論じなさい。",
    type: "past",
    wordLimit: 1000,
    field: "経済",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "地域経済の活性化策",
    description:
      "総合型選抜学部独自方式。地域経済の衰退とその活性化に向けた方策について論述。",
    type: "past",
    wordLimit: 1000,
    field: "経済",
  },
  {
    id: "pq-ryukoku-mgmt-n1",
    universityId: "ryukoku-u",
    universityName: "龍谷大学",
    facultyName: "経営学部（総合型選抜・学部独自方式）",
    year: 2024,
    theme: "ESG経営と企業の社会的責任",
    description:
      "総合型選抜学部独自方式。ESG経営の意義と企業の社会的責任について論述。",
    type: "past",
    wordLimit: 1000,
    field: "経済",
  },
  {
    id: "pq-ryukoku-law-n1",
    universityId: "ryukoku-u",
    universityName: "龍谷大学",
    facultyName: "法学部（総合型選抜・学部独自方式）",
    year: 2024,
    theme: "デジタル社会における個人情報保護",
    description:
      "総合型選抜学部独自方式。デジタル社会での個人情報保護と利活用のバランスについて法的観点から論述。",
    type: "past",
    wordLimit: 1000,
    field: "法律",
  },
  {
    id: "pq-ryukoku-law-n2",
    universityId: "ryukoku-u",
    universityName: "龍谷大学",
    facultyName: "法学部（総合型選抜・学部独自方式）",
    year: 2023,
    theme: "少年犯罪と更生支援",
    description:
      "総合型選抜学部独自方式。少年犯罪の背景と更生支援のあり方について法学的観点から論述。",
    type: "past",
    wordLimit: 1000,
    field: "法律",
  },
  {
    id: "pq-ryukoku-sports-n2",
    universityId: "ryukoku-u",
    universityName: "龍谷大学",
    facultyName: "全学部（文化・芸術・社会活動選抜）",
    year: 2024,
    theme: "文化・芸術活動が社会に与える影響",
    description:
      "総合型選抜文化・芸術・社会活動選抜。自身の活動経験を踏まえ、文化・芸術が社会にもたらす価値について1000字程度で論述。",
    type: "past",
    wordLimit: 1000,
    field: "文化",
  },
  ...
  // ===== 日本大学（追加分） =====
  {
    ...
    universityId: "nihon-u",
    universityName: "日本大学",
    facultyName: "法学部（総合型選抜）",
    year: 2024,
    theme: "SDGsと法制度の役割",
    description:
      "総合型選抜。SDGsの達成に向けた法制度の役割について論述。社会問題への法的アプローチが問われる。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "法律",
  },
  {
    ...
    theme: "環境問題と法的責任",
    description:
      "総合型選抜。環境破壊に対する法的責任の所在と規制の在り方について論述。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "法律",
  ...
  {
    id: "pq-nihon-bunri-n1",
    universityId: "nihon-u",
    universityName: "日本大学",
    facultyName: "文理学部（総合型選抜）",
    year: 2024,
    theme: "志望学科の専門分野に関する課題論述",
    description:
      "総合型選抜。志望学科の専門分野について強い意欲と適性を示す論述。学科ごとにテーマが異なる。",
    type: "past",
    wordLimit: 800,
    field: "総合",
  },
  {
    id: "pq-nihon-art-lit-n1",
    universityId: "nihon-u",
    universityName: "日本大学",
    facultyName: "芸術学部文芸学科（総合型選抜）",
    year: 2024,
    theme: "「公平」と「平等」についての小論文",
    description:
      "総合型選抜。「公平」と「平等」の概念の違いについて自分の考えを論述。",
    type: "past",
    wordLimit: 800,
    field: "文化",
  },
  {
    id: "pq-nihon-art-drama-n1",
    universityId: "nihon-u",
    universityName: "日本大学",
    facultyName: "芸術学部演劇学科（総合型選抜）",
    year: 2023,
    theme: "「意地悪する人」をタイトルとした作文",
    description:
      "総合型選抜。「意地悪する人」をタイトルとして、思うことや物語を自由に作文する。表現力が問われる。",
    type: "past",
    field: "文化",
  },
  {
    id: "pq-nihon-art-lit-n2",
    universityId: "nihon-u",
    universityName: "日本大学",
    facultyName: "芸術学部文芸学科（総合型選抜）",
    year: 2023,
    theme: "「不自由な生活」についての小論文",
    description:
      "総合型選抜。「不自由な生活」をテーマに自分の考えや経験を論述。",
    type: "past",
    wordLimit: 800,
    field: "文化",
  },
  {
    id: "pq-nihon-art-photo-n1",
    universityId: "nihon-u",
    universityName: "日本大学",
    facultyName: "芸術学部（総合型選抜）",
    year: 2024,
    theme: "「SDGsとその課題」についての論述",
    description:
      "総合型選抜。SDGsの意義と実現に向けた課題について自分の意見を論述。",
    type: "past",
    wordLimit: 800,
    field: "社会",
  },
  {
    ...
    universityId: "nihon-u",
    universityName: "日本大学",
    facultyName: "経済学部（総合型選抜プレゼン型）",
    year: 2024,
    theme: "地域社会における環境問題の解決策",
    description:
      "総合型選抜プレゼン型。身近な地域の環境問題を取り上げ、解決に向けた取り組みを検討する2,700〜3,000字のレポート。",
    type: "past",
    wordLimit: 3000,
    field: "経済",
  },
  ...
  // ===== 東洋大学（追加分） =====
  {
    ...
    universityId: "toyo-u",
    universityName: "東洋大学",
    facultyName: "経済学部（自己推薦入試）",
    year: 2024,
    theme: "日本経済の構造的課題",
    description:
      "自己推薦入試小論文型。日本経済が直面する構造的課題（少子高齢化・格差拡大等）について800字で論述。",
    type: "past",
    wordLimit: 800,
    field: "経済",
  },
  {
    ...
    theme: "デジタル経済と雇用の変化",
    description:
      "自己推薦入試小論文型。デジタル技術の進展が労働市場に与える影響について論述。",
    type: "past",
    wordLimit: 800,
    field: "経済",
  },
  {
    ...
    universityId: "toyo-u",
    universityName: "東洋大学",
    facultyName: "法学部（自己推薦入試）",
    year: 2024,
    theme: "現代社会における人権保障の課題",
    description:
      "自己推薦入試小論文型。現代社会の人権課題について法的視点から800字で論述。志望理由書は3,000〜4,000字の長文。",
    type: "past",
    wordLimit: 800,
    field: "法律",
  },
  {
    ...
    facultyName: "法学部（自己推薦入試）",
    year: 2023,
    theme: "SNS時代の表現の自由と名誉毀損",
    description:
      "自己推薦入試小論文型。SNS上の表現の自由と名誉毀損の境界について法的観点から論述。",
    type: "past",
    wordLimit: 800,
    field: "法律",
  },
  {
    id: "pq-toyo-intl-tourism-n1",
    universityId: "toyo-u",
    universityName: "東洋大学",
    facultyName: "国際観光学部（総合型選抜）",
    year: 2023,
    theme: "日本の観光の課題と解決策",
    description:
      "総合型選抜。キーワード群から1つ選択し、日本の観光の課題を指摘するとともに解決策を800字以内で記述。オーバーツーリズム等が出題。",
    type: "past",
    wordLimit: 800,
    field: "社会",
  },
  {
    id: "pq-toyo-intl-tourism-n2",
    universityId: "toyo-u",
    universityName: "東洋大学",
    facultyName: "国際観光学部（総合型選抜）",
    year: 2024,
    theme: "持続可能な観光（サステナブルツーリズム）",
    description:
      "総合型選抜。持続可能な観光の実現に向けた課題と方策を論述。地域活性化との関連も問われる。",
    type: "past",
    wordLimit: 800,
    field: "社会",
  },
  {
    ...
    universityId: "toyo-u",
    universityName: "東洋大学",
    facultyName: "国際学部（自己推薦入試）",
    year: 2024,
    theme: "グローバル社会における多文化共生",
    description:
      "自己推薦入試。多文化共生社会の実現に向けた課題と自分自身の貢献について論述。",
    type: "past",
    wordLimit: 800,
    field: "国際",
  },
  {
    id: "pq-toyo-sociology-n1",
    universityId: "toyo-u",
    universityName: "東洋大学",
    facultyName: "社会学部メディアコミュニケーション学科",
    year: 2024,
    theme: "メディアリテラシーと民主主義",
    description:
      "自己推薦入試小論文型。デジタルメディア時代のメディアリテラシーと民主主義の関係について論述。",
    type: "past",
    wordLimit: 800,
    field: "メディア",
  },
  ...
  // ===== 駒澤大学（追加分） =====
  {
    id: "pq-komazawa-buddhism-n2",
    universityId: "komazawa-u",
    universityName: "駒澤大学",
    facultyName: "仏教学部（自己推薦選抜）",
    year: 2023,
    theme: "仏教思想と現代の社会課題",
    description:
      "自己推薦選抜。仏教の教えが現代社会の課題（環境問題・共生等）にどう貢献できるか論述。60分。",
    type: "past",
    timeLimit: 60,
    field: "仏教学",
  },
  {
    id: "pq-komazawa-buddhism-n3",
    universityId: "komazawa-u",
    universityName: "駒澤大学",
    facultyName: "仏教学部（自己推薦選抜）",
    year: 2022,
    theme: "宗教的寛容と多様性の尊重",
    description:
      "自己推薦選抜。宗教的寛容の意義と多文化社会における多様性の尊重について論述。60分。",
    type: "past",
    timeLimit: 60,
    field: "仏教学",
  },
  {
    id: "pq-komazawa-jpn-n2",
    universityId: "komazawa-u",
    universityName: "駒澤大学",
    facultyName: "文学部国文学科（自己推薦選抜）",
    year: 2023,
    theme: "古典文学の現代的意義",
    description:
      "自己推薦選抜（総合評価型）。古典文学が現代を生きる私たちに示唆するものについて論述。60分。",
    type: "past",
    timeLimit: 60,
    field: "日本文学",
  },
  {
    id: "pq-komazawa-english-n1",
    universityId: "komazawa-u",
    universityName: "駒澤大学",
    facultyName: "文学部英米文学科（自己推薦選抜）",
    year: 2024,
    theme: "英語圏の文化・文学に関する論述",
    description:
      "自己推薦選抜（総合評価型）。英語圏の文化または文学に関するテーマについて論述。英語力と文学的素養が問われる。60分。",
    type: "past",
    timeLimit: 60,
    field: "文化",
  },
  {
    id: "pq-komazawa-history-n1",
    universityId: "komazawa-u",
    universityName: "駒澤大学",
    facultyName: "文学部歴史学科（自己推薦選抜）",
    year: 2024,
    theme: "歴史的事象の分析と現代への教訓",
    description:
      "筆者は、この藩が「村の現実を見ない判断は長期的に藩の存立を危うくする」という下級武士の意見書を受け入れたことで、近隣藩より順調な復興を果たしたと述べている。この史料から読み取れる藩の意思決定の特徴を200字程度でまとめなさい。また、その特徴を踏まえ、現代の組織運営が学ぶべき教訓について600字程度で論じなさい。",
    type: "past",
    timeLimit: 60,
    field: "歴史",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-komazawa-mgmt-n1",
    universityId: "komazawa-u",
    universityName: "駒澤大学",
    facultyName: "経営学部（自己推薦選抜）",
    year: 2024,
    theme: "企業経営と社会的責任",
    description:
      "自己推薦選抜。企業の社会的責任（CSR）やESG経営について論述。経営学的思考力が問われる。60分。",
    type: "past",
    timeLimit: 60,
    field: "経済",
  },
  {
    id: "pq-komazawa-mgmt-n2",
    universityId: "komazawa-u",
    universityName: "駒澤大学",
    facultyName: "経営学部（自己推薦選抜）",
    year: 2023,
    theme: "DXと企業変革",
    description:
      "自己推薦選抜。デジタルトランスフォーメーション（DX）が企業経営にもたらす変革について論述。60分。",
    type: "past",
    timeLimit: 60,
    field: "経済",
  },
  {
    id: "pq-komazawa-psychology-n1",
    universityId: "komazawa-u",
    universityName: "駒澤大学",
    facultyName: "文学部心理学科（自己推薦選抜）",
    year: 2024,
    theme: "現代社会における心の健康",
    description:
      "自己推薦選抜。ストレス社会における心の健康と心理学の役割について論述。60分。",
    type: "past",
    timeLimit: 60,
    field: "心理学",
  },
  ...
  // ===== 専修大学（追加分） =====
  {
    id: "pq-senshu-econ-intl-n1",
    universityId: "senshu-u",
    universityName: "専修大学",
    facultyName: "経済学部国際経済学科（総合型選抜）",
    year: 2024,
    theme: "グローバル経済と為替変動の影響",
    description:
      "総合型選抜。グローバル経済における為替変動が貿易・産業に与える影響について論述。志望理由書と論文の2本立て。",
    type: "past",
    field: "経済",
  },
  {
    id: "pq-senshu-econ-intl-n2",
    universityId: "senshu-u",
    universityName: "専修大学",
    facultyName: "経済学部国際経済学科（総合型選抜）",
    year: 2023,
    theme: "新興国の経済発展と国際秩序",
    description:
      "総合型選抜。新興国の台頭が国際経済秩序に与える影響について論述。",
    type: "past",
    field: "経済",
  },
  {
    id: "pq-senshu-business-n2",
    universityId: "senshu-u",
    universityName: "専修大学",
    facultyName: "経営学部（総合型選抜）",
    year: 2023,
    theme: "サブスクリプションモデルとビジネス変革",
    description:
      "総合型選抜。サブスクリプション型ビジネスモデルの台頭とその影響について論述。",
    type: "past",
    field: "経済",
  },
  {
    id: "pq-senshu-business-n3",
    universityId: "senshu-u",
    universityName: "専修大学",
    facultyName: "経営学部（総合型選抜）",
    year: 2024,
    theme: "ESG投資と企業価値",
    description:
      "総合型選抜。ESG投資の拡大が企業経営と企業価値に与える影響について論述。",
    type: "past",
    field: "経済",
  },
  {
    id: "pq-senshu-intl-comm-n1",
    universityId: "senshu-u",
    universityName: "専修大学",
    facultyName:
      "国際コミュニケーション学部異文化コミュニケーション学科（総合型選抜）",
    year: 2024,
    theme: "異文化理解とコミュニケーション",
    description:
      "総合型選抜。異文化間のコミュニケーションにおける課題と解決策について論述。英語力と国際的視野が問われる。",
    type: "past",
    field: "国際",
  },
  {
    id: "pq-senshu-intl-comm-n2",
    universityId: "senshu-u",
    universityName: "専修大学",
    facultyName:
      "国際コミュニケーション学部異文化コミュニケーション学科（総合型選抜）",
    year: 2023,
    theme: "言語と文化のアイデンティティ",
    description:
      "総合型選抜。言語が文化的アイデンティティの形成に果たす役割について論述。",
    type: "past",
    field: "国際",
  },
  {
    id: "pq-senshu-network-n1",
    universityId: "senshu-u",
    universityName: "専修大学",
    facultyName: "ネットワーク情報学部（総合型選抜）",
    year: 2024,
    theme: "情報社会における課題発見と解決",
    description:
      "総合型選抜。情報社会における課題を発見し、ITを活用した解決策を提案する論述。プレゼン能力も評価。",
    type: "past",
    field: "科学技術",
  },
  {
    id: "pq-senshu-network-n2",
    universityId: "senshu-u",
    universityName: "専修大学",
    facultyName: "ネットワーク情報学部（総合型選抜）",
    year: 2023,
    theme: "データ活用と社会的インパクト",
    description:
      "総合型選抜。ビッグデータやAIの活用が社会に与えるインパクトについて論述。",
    type: "past",
    field: "科学技術",
  },
  ...
  {
    id: "pq-tsukuba-soc-1",
    universityId: "tsukuba-u",
    universityName: "筑波大学",
    facultyName: "社会・国際学群 社会学類（推薦入試）",
    year: 2021,
    theme: "予言の自己成就",
    description:
      "課題文読み取り型。社会学における「予言の自己成就」概念に関する以下の課題文を読み、内容を踏まえて自身の考えを1200字で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1200,
    timeLimit: 90,
  ...
  },
  {
    ...
    facultyName: "社会・国際学群 社会学類（推薦入試）",
    year: 2020,
    theme: "福島第一原発事故後の風評被害",
    description:
      "資料読み取り型。福島第一原発事故後の風評被害に関する統計資料・データを読み取り、社会的影響と対策について1200字で論述しなさい。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 1200,
    timeLimit: 90,
  ...
  {
    id: "pq-tsukuba-intl-1",
    universityId: "tsukuba-u",
    universityName: "筑波大学",
    facultyName: "社会・国際学群 国際総合学類（推薦入試）",
    year: 2022,
    theme: "グローバル化と国家主権の変容",
    description:
      "課題文読み取り型（英文含む）。グローバル化が国家主権に与える影響について日本語・英語の課題文を読み、2000字以上で論述しなさい。国際総合学類は英文読解も出題される。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 2000,
    timeLimit: 120,
  ...
  },
  {
    ...
    universityId: "tsukuba-u",
    universityName: "筑波大学",
    facultyName: "人間学群 教育学類（推薦入試）",
    year: 2022,
    theme: "子どもの読解力を伸ばす指導",
    description:
      "課題文読み取り型。子どもの読解力向上に関する以下の文章を読み、教育実践への示唆を1000字で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 90,
  ...
  },
  {
    ...
    universityId: "tsukuba-u",
    universityName: "筑波大学",
    facultyName: "人間学群 心理学類（推薦入試）",
    year: 2021,
    theme: "主体性と協同性の関係",
    description:
      "課題文読み取り型。主体性と協同性が人間の発達においてどのように関係するかについて、以下の課題文を読み、踏まえた上で1000字で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 90,
  ...
  },
  {
    ...
    description:
      "課題文読み取り型。以下の文章を読み、SNS等のデジタル技術によるコミュニケーションの変化が人間の心理に与える影響について論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 90,
  ...
  },
  {
    ...
    universityId: "tsukuba-u",
    universityName: "筑波大学",
    facultyName: "生命環境学群 生物学類（推薦入試）",
    year: 2023,
    theme: "細菌の分類方法",
    description:
      "英語長文読み取り型。細菌の分類方法に関する英文を読み、内容をまとめた上で生物学的視点から考察を述べなさい。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 800,
    timeLimit: 90,
  ...
  {
    id: "pq-tsukuba-soceng-1",
    universityId: "tsukuba-u",
    universityName: "筑波大学",
    facultyName: "理工学群 社会工学類（推薦入試）",
    year: 2023,
    theme: "都市計画と住民参加",
    description:
      "総合問題形式。都市計画における住民参加の意義と課題について、データや資料を踏まえて多角的に論述しなさい。",
    type: "past",
    questionType: "mixed",
    wordLimit: 1000,
    timeLimit: 90,
    ...
    chartData: [
      {
        type: "bar",
        title: "都市計画策定における住民参加手段の実施率（全国自治体調査・%）",
        xKey: "method",
        data: [
          { method: "パブリックコメント", 実施率: 88 },
          { method: "住民説明会", 実施率: 76 },
          { method: "ワークショップ", 実施率: 42 },
          { method: "住民アンケート", 実施率: 65 },
  ...
  // ===== 神戸大学 =====
  {
    ...
    universityId: "kobe-u",
    universityName: "神戸大学",
    facultyName: "法学部（志特別選抜）",
    year: 2023,
    theme: "憲法と個人の自由の限界",
    description:
      "志特別選抜。以下の課題文を読み、憲法が保障する個人の自由とその限界について、具体的事例を挙げながら800字で意見論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    universityId: "kobe-u",
    universityName: "神戸大学",
    facultyName: "文学部（志特別選抜）",
    year: 2023,
    theme: "言語と思考の関係",
    description:
      "志特別選抜。言語が思考に与える影響についての以下の課題文を読み、内容を的確に把握した上で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    universityId: "kobe-u",
    universityName: "神戸大学",
    facultyName: "国際人間科学部 環境共生学科（志特別選抜）",
    year: 2023,
    theme: "持続可能な地域社会の構築",
    description:
      "志特別選抜。環境問題と地域社会の持続可能性に関する以下の課題文を読み、科学的知見を踏まえて論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    universityId: "kobe-u",
    universityName: "神戸大学",
    facultyName: "工学部（志特別選抜）",
    year: 2023,
    theme: "技術革新と社会実装の課題",
    description:
      "志特別選抜。新技術の社会実装における課題について、工学的視点と社会的視点の両方から考察しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "科学技術",
  },
  {
    ...
    universityId: "kobe-u",
    universityName: "神戸大学",
    facultyName: "農学部（志特別選抜）",
    year: 2023,
    theme: "食料安全保障と農業の未来",
    description:
      "志特別選抜。グローバルな食料安全保障の課題と日本の農業が果たすべき役割について論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "環境",
  },
  {
    ...
    universityId: "kobe-u",
    universityName: "神戸大学",
    facultyName: "海洋政策科学部（志特別選抜）",
    year: 2024,
    theme: "海洋資源の持続的利用と国際協力",
    description:
      "志特別選抜。海洋資源の持続的利用に関する以下の課題文を読み、国際的な協力体制のあり方について論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  // ===== 一橋大学 =====
  {
    id: "pq-hitotsubashi-com-1",
    universityId: "hitotsubashi-u",
    universityName: "一橋大学",
    facultyName: "商学部（学校推薦型選抜）",
    year: 2024,
    theme: "分業の効率性と自由・不自由",
    description:
      "課題文読み取り型。以下の経済史に関する課題文を読み、(1)分業の効率性が自由と不自由の両方の根拠となりうる点を300字以内、(2)労働を単純に分割するだけでは効率性は達成できない点を300字以内、(3)効率性による自由が実現し不自由も発現する状況の事例を500字以内で記述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1100,
    timeLimit: 90,
  ...
  {
    id: "pq-hitotsubashi-law-1",
    universityId: "hitotsubashi-u",
    universityName: "一橋大学",
    facultyName: "法学部（学校推薦型選抜）",
    year: 2024,
    theme: "法の支配と民主主義の緊張関係",
    description:
      "課題文読み取り型。法の支配と民主主義の間に生じる緊張関係について、以下の課題文の論旨を要約した上で自身の見解を述べなさい。設問は要約＋意見論述の2〜4問構成、合計1000字以上。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 90,
  ...
  },
  {
    ...
    theme: "社会的不平等と制度的再生産",
    description:
      "テーマ型（課題文・資料なし）。「現代社会の不平等は個人の努力の差ではなく、制度や慣習を通じて世代を越えて再生産される」という主張に対し、賛否のいずれの立場でもよいので、具体的な制度（教育制度、労働市場、社会保障など）を取り上げて1000字以内で自身の論を展開しなさい。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "社会",
  ...
  {
    id: "pq-hitotsubashi-eco-1",
    universityId: "hitotsubashi-u",
    universityName: "一橋大学",
    facultyName: "経済学部（学校推薦型選抜）",
    year: 2024,
    theme: "経済成長とイノベーション",
    description:
      "課題文読み取り型。経済成長の源泉としてのイノベーションに関する以下の課題文を読み、要約と自身の意見を合計1000字以上で述べなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 90,
  ...
  {
    id: "pq-hitotsubashi-sds-1",
    universityId: "hitotsubashi-u",
    universityName: "一橋大学",
    facultyName: "ソーシャル・データサイエンス学部（学校推薦型選抜）",
    year: 2024,
    theme: "データ駆動型意思決定の倫理的課題",
    description:
      "課題文読み取り型。データを用いた意思決定の倫理的課題について、以下の課題文を読み、要約と自身の見解を述べなさい。年度により傾向が変わる新設学部。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 1000,
    timeLimit: 90,
  ...
  {
    id: "pq-chiba-intl-1",
    universityId: "chiba-u",
    universityName: "千葉大学",
    facultyName: "国際教養学部（総合型選抜）",
    year: 2024,
    theme: "異文化間の対話と相互理解",
    description:
      "総合型選抜。グローバル社会における異文化間の対話と相互理解の意義について、具体的事例を挙げながら論述しなさい。共通テストを課すタイプ。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "国際",
  },
  {
    ...
    universityId: "chiba-u",
    universityName: "千葉大学",
    facultyName: "法政経学部（総合型選抜）",
    year: 2024,
    theme: "デジタル社会と個人情報保護",
    description:
      "総合型選抜。デジタル社会における個人情報保護のあり方について、法的・経済的観点から論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "法律",
  },
  {
    ...
    universityId: "chiba-u",
    universityName: "千葉大学",
    facultyName: "文学部 人文学科 行動科学コース（後期・小論文）",
    year: 2023,
    theme: "社会調査と人間行動の理解",
    description:
      "後期日程。社会調査の方法論と人間行動の科学的理解に関する以下の課題文を読み、論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    universityId: "chiba-u",
    universityName: "千葉大学",
    facultyName: "文学部 人文学科 歴史学コース（後期・小論文）",
    year: 2023,
    theme: "歴史叙述と史料批判",
    description:
      "後期日程。歴史叙述における史料批判の重要性について、以下の課題文を読み、踏まえた上で論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    universityId: "chiba-u",
    universityName: "千葉大学",
    facultyName: "教育学部（総合型選抜 方式Ⅱ）",
    year: 2024,
    theme: "教育のICT活用と学びの変容",
    description:
      "総合型選抜方式Ⅱ（共通テスト不要）。教育現場におけるICT活用が児童・生徒の学びにどのような変容をもたらすか論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "教育",
  },
  {
    ...
    universityId: "chiba-u",
    universityName: "千葉大学",
    facultyName: "先進科学プログラム（飛び入学）",
    year: 2024,
    theme: "科学的探究と論理的思考",
    description:
      "先進科学プログラム課題論述。物理学・工学・情報科学に関連した課題について、論理的思考力と科学的探究能力を問う総合問題。",
    type: "past",
    questionType: "mixed",
    wordLimit: 800,
    timeLimit: 90,
    ...
    chartData: [
      {
        type: "bar",
        title: "主要国の被引用数TOP10%論文シェア（自然科学・%）",
        xKey: "country",
        data: [
          { country: "米国", シェア: 21.9 },
          { country: "中国", シェア: 27.2 },
        ...
        yKeys: [
          { key: "シェア", name: "TOP10%論文シェア（%）", color: "#3B82F6" },
        ],
      },
      {
        type: "line",
        title: "日本の博士課程入学者数の推移",
        xKey: "year",
        data: [
          { year: "2003", 入学者: 18232 },
          { year: "2010", 入学者: 16471 },
  ...
  // ===== 広島大学 =====
  {
    id: "pq-hiroshima-sogo-1",
    universityId: "hiroshima-u",
    universityName: "広島大学",
    facultyName: "総合科学部（光り輝き入試・総合型選抜Ⅰ型）",
    year: 2024,
    theme: "講義型小論文：現代社会の課題",
    description:
      "光り輝き入試。第二次選考で講義を受講した後、講義内容について小論文を作成する形式。現代社会の課題に関する講義を踏まえた論述。",
    type: "past",
  ...
  {
    id: "pq-hiroshima-edu-1",
    universityId: "hiroshima-u",
    universityName: "広島大学",
    facultyName: "教育学部（光り輝き入試・総合型選抜Ⅰ型）",
    year: 2024,
    theme: "教育の多様性と包摂的学習環境",
    description:
      "光り輝き入試。教育の多様性を尊重した包摂的な学習環境の構築について、自身の経験を踏まえて論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "教育",
  ...
  {
    id: "pq-hiroshima-lit-1",
    universityId: "hiroshima-u",
    universityName: "広島大学",
    facultyName: "文学部（光り輝き入試・総合型選抜Ⅰ型）",
    year: 2023,
    theme: "文化の伝承とデジタル技術",
    description:
      "光り輝き入試。文化遺産の伝承におけるデジタル技術の活用について、以下の課題文を読み論述しなさい。※サンプル課題文は練習用に生成されたものです。",
    type: "past",
    questionType: "essay",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    description:
      "光り輝き入試。テロ対策・治安維持を目的とする国家の権力強化と、表現の自由・プライバシー・移動の自由といった人権保障のバランスについて、国内外の具体例を一つ取り上げて論じ、自身の見解を800字以内で述べなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "法律",
  ...
  {
    id: "pq-hiroshima-eco-1",
    universityId: "hiroshima-u",
    universityName: "広島大学",
    facultyName: "経済学部（光り輝き入試・総合型選抜Ⅱ型）",
    year: 2024,
    theme: "地域経済の活性化と産学連携",
    description:
      "光り輝き入試Ⅱ型（共通テスト課す）。地域経済の活性化における産学連携の役割について論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "経済",
  ...
  {
    id: "pq-hiroshima-igs-1",
    universityId: "hiroshima-u",
    universityName: "広島大学",
    facultyName: "総合科学部 国際共創学科（IGS国内選抜型）",
    year: 2024,
    theme: "Globalization and Local Identity",
    description:
      "IGS国内選抜型。英語によるエッセイ。グローバル化が地域のアイデンティティに与える影響について英語で論述しなさい。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 600,
    timeLimit: 90,
  ...
  {
    id: "pq-ynu-usc-1",
    universityId: "yokohama-national-u",
    universityName: "横浜国立大学",
    facultyName: "都市科学部 都市社会共生学科（前期・小論文）",
    year: 2024,
    theme: "人工知能（AI）と社会的・倫理的課題",
    description:
      "課題文読み取り型。AI技術の社会的・倫理的問題に関するNTTデータ掲載記事を課題文として読み、AGIの存在やディープラーニング等の論点を踏まえて論述しなさい。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "AI・テクノロジー",
  },
  {
    ...
    facultyName: "都市科学部 都市社会共生学科（前期・小論文）",
    year: 2023,
    theme: "戦争社会学とナラティブの継承",
    description:
      "課題文読み取り型。朝日新聞『Journalism』寄稿文を読み、戦争にまつわるナラティブと報道、経験の継承について2つの文章から立論しなさい。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "社会",
  },
  {
    ...
    universityId: "yokohama-national-u",
    universityName: "横浜国立大学",
    facultyName: "都市科学部 環境リスク共生学科（後期・小論文）",
    year: 2024,
    theme: "AI技術と環境リスク評価",
    description:
      "後期日程。AI技術を環境リスク評価に応用する可能性と課題について、科学的知見を踏まえて論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "環境",
  },
  {
    ...
    universityId: "yokohama-national-u",
    universityName: "横浜国立大学",
    facultyName: "教育学部（総合型選抜）",
    year: 2024,
    theme: "多文化共生と学校教育の役割",
    description:
      "総合型選抜。多文化共生社会における学校教育の役割について、自身の経験や考えを踏まえて論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "教育",
  },
  {
    ...
    universityId: "yokohama-national-u",
    universityName: "横浜国立大学",
    facultyName: "経済学部（総合型選抜）",
    year: 2024,
    theme: "グローバル経済と地域産業の共存",
    description:
      "総合型選抜。グローバル経済の進展が地域産業に与える影響と共存の方策について論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "経済",
  ...
  // ===== 東京都立大学 =====
  {
    id: "pq-tmu-hum-1",
    universityId: "tmu",
    universityName: "東京都立大学",
    facultyName: "人文社会学部（ゼミナール入試・総合型選抜）",
    year: 2024,
    theme: "ゼミナール受講後レポート：社会と個人の関係",
    description:
      "ゼミナール入試。大学教員による講義・演習を受講後、社会と個人の関係性についてレポートを作成。グループワーク・プレゼンテーションも評価対象。",
    type: "past",
    questionType: "lecture",
    wordLimit: 800,
    timeLimit: 90,
  ...
  },
  {
    ...
    universityId: "tmu",
    universityName: "東京都立大学",
    facultyName: "都市環境学部 都市政策科学科（総合型選抜）",
    year: 2024,
    theme: "都市の持続可能性と市民参加",
    description:
      "総合型選抜。都市計画における持続可能性と市民参加のあり方について、具体的な都市問題を例に挙げて論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 90,
    field: "社会",
  },
  {
    ...
    universityId: "tmu",
    universityName: "東京都立大学",
    facultyName: "理学部（科学オリンピック入試・総合型選抜）",
    year: 2024,
    theme: "科学的発見の社会的インパクト",
    description:
      "科学オリンピック入試。科学的発見が社会に与えるインパクトについて、自身の研究経験を踏まえて論述しなさい。指定オリンピック優秀者が出願資格。",
    type: "past",
    wordLimit: 600,
    timeLimit: 60,
    field: "科学技術",
  },
  {
    ...
    universityId: "tmu",
    universityName: "東京都立大学",
    facultyName: "システムデザイン学部（総合型選抜）",
    year: 2024,
    theme: "技術と社会の共進化",
    description:
      "総合型選抜。技術革新と社会変革がどのように相互に影響し合うかについて、具体例を挙げて論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "科学技術",
  },
  {
    ...
    universityId: "tmu",
    universityName: "東京都立大学",
    facultyName: "健康福祉学部（総合型選抜）",
    year: 2024,
    theme: "高齢社会における地域包括ケアの課題",
    description:
      "総合型選抜。超高齢社会における地域包括ケアシステムの課題と展望について論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "医療・福祉",
  },
  {
    ...
    universityId: "tmu",
    universityName: "東京都立大学",
    facultyName: "人文社会学部（グローバル人材育成入試）",
    year: 2023,
    theme: "Global Citizenship and Local Responsibility",
    description:
      "グローバル人材育成入試（英検準1級程度必要）。グローバル市民としての責任と地域社会への貢献について英語と日本語で論述しなさい。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 800,
    timeLimit: 90,
  ...
  // ===== 大阪公立大学 =====
  {
    ...
    theme: "こども基本法と子どもの権利",
    description:
      "学校推薦型選抜。2023年4月施行の「こども基本法」を題材に、現代社会における子どもをめぐる問題（児童虐待・ヤングケアラー・子どもの貧困など）の背景を整理したうえで、「子どもの権利を守るために大学で学びたいこと」を1000字以内で論じなさい。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "社会",
  ...
  },
  {
    ...
    universityId: "omu",
    universityName: "大阪公立大学",
    facultyName: "現代システム科学域 環境社会システム学類（学校推薦型選抜）",
    year: 2024,
    theme: "持続可能な社会と人の暮らし",
    description:
      "学校推薦型選抜。「持続可能な社会と人の暮らし」をテーマとした出典から出題。地震をハザードとした場合のエンドポイントの例を挙げる問題等。",
    type: "past",
    questionType: "data-analysis",
    wordLimit: 800,
    timeLimit: 90,
    ...
    chartData: [
      {
        type: "bar",
        title: "日本のSDGs各目標の達成度スコア（SDG Index 2024）",
        xKey: "goal",
        data: [
          { goal: "G1 貧困", score: 99 },
          { goal: "G3 健康", score: 95 },
          { goal: "G5 ジェンダー", score: 63 },
          { goal: "G7 エネルギー", score: 68 },
          { goal: "G12 生産消費", score: 58 },
          { goal: "G13 気候", score: 69 },
          { goal: "G14 海洋", score: 52 },
          { goal: "G15 陸上", score: 71 },
        ],
        yKeys: [{ key: "score", name: "達成度スコア", color: "#10B981" }],
      },
      {
        type: "line",
        title: "日本の自然災害による経済損失額（億円）",
        xKey: "year",
        data: [
          { year: "2018", 損失: 14500 },
          { year: "2019", 損失: 21500 },
  ...
  },
  {
    ...
    theme: "食と健康のリテラシー",
    description:
      "学校推薦型選抜。「食と健康に関する科学的リテラシー」が現代社会で重要とされる背景を整理したうえで、生活者がそれを身につけるための具体的な方策（家庭・学校・地域・行政のいずれかで）を一つ提案し、800字以内で論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "医療・福祉",
  ...
  },
  {
    ...
    theme: "地域医療と多職種連携",
    description:
      "学校推薦型選抜。超高齢社会における地域医療の課題を整理したうえで、医師・看護師・薬剤師・介護職・ソーシャルワーカーなど多職種の連携（IPW: Interprofessional Work）が果たす意義と、そこでの看護師の役割について自身の考えを800字以内で論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "医療・福祉",
  ...
  },
  {
    ...
    description:
      "学校推薦型選抜。言語が単なる伝達手段ではなく「世界の切り取り方」 そのものであるという視点から、言語の多様性が個人や集団の文化的アイデンティティ形成に果たす役割について、具体例（方言、少数言語、多言語社会、母語教育など）を一つ取り上げて800字以内で論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "文化",
  ...
  },
  {
    ...
    universityId: "omu",
    universityName: "大阪公立大学",
    facultyName: "工学部（総合型選抜）",
    year: 2024,
    theme: "カーボンニュートラル実現に向けた技術課題",
    description:
      "総合型選抜。2050年カーボンニュートラル実現に向けた工学的課題と解決策について論述しなさい。",
    type: "past",
    wordLimit: 800,
    timeLimit: 60,
    field: "科学技術",
  ...
  // ===== 成蹊大学 =====
  {
    id: "pq-seikei-econ-n1",
    universityId: "seikei-u",
    universityName: "成蹊大学",
    facultyName: "経済学部（AOマルデス入試）",
    year: 2025,
    theme: "職業人としての資質と学業計画",
    description:
      "AOマルデス入試・課題レポート。あなたが成し遂げたいことの実現に必要な職業人としての資質やスキルを挙げ、目標実現に向けた学業計画を説明しなさい。1200字程度。",
    type: "past",
    wordLimit: 1200,
    field: "経済",
  },
  {
    id: "pq-seikei-mgmt-n1",
    universityId: "seikei-u",
    universityName: "成蹊大学",
    facultyName: "経営学部（AOマルデス入試）",
    year: 2025,
    theme: "未成年者のSNS利用に制限を課すべきか",
    description:
      "AOマルデス入試・課題レポート。未成年者のSNS利用に制限を課すべきかについて、賛否の立場を明確にしたうえで論述しなさい。1200字程度。討論力審査のテーマにもなる。",
    type: "past",
    wordLimit: 1200,
    field: "社会",
  },
  {
    ...
    universityId: "seikei-u",
    universityName: "成蹊大学",
    facultyName: "法学部（AOマルデス入試）",
    year: 2025,
    theme: "法学・政治学の専門テーマに関する学修計画レポート",
    description:
      "AOマルデス入試。志望学科の専門領域に関連した具体的テーマを設定し、自分で調べた内容や大学でより深く考察したい重要問題をまとめたレポートを作成しなさい。A4用紙2ページ以内。",
    type: "past",
    field: "法律",
  },
  {
    ...
    universityId: "seikei-u",
    universityName: "成蹊大学",
    facultyName: "文学部（AOマルデス入試）",
    year: 2025,
    theme: "志望学科の研究テーマに関する調査レポート",
    description:
      "AOマルデス入試。志望学科が扱う研究領域のうちどのようなテーマに興味を持ったか（400字程度）、そのテーマについて自分で調べたこと（600字程度）を記述。二次では約10分のプレゼンテーションと質疑応答。",
    type: "past",
    wordLimit: 1000,
    field: "文化",
  },
  {
    ...
    universityId: "seikei-u",
    universityName: "成蹊大学",
    facultyName: "理工学部（AOマルデス入試）",
    year: 2025,
    theme: "科学技術テーマの小論文と文章・資料読解",
    description:
      "設問1. 筆者は、エネルギー分野や材料分野の具体例を挙げながら「科学技術の評価軸」の変化を論じている。筆者が示す変化の内容と、その変化が生じた背景を300字程度でまとめなさい。\n設問2. 筆者は「自らが開発する技術がどのような社会的影響を持ち、どのような価値の選択に関わるのかを考え続ける姿勢」が科学技術人材に求められると述べている。この主張を踏まえ、あなたが関心を持つ分野を例に挙げながら、これからの科学技術人材のあり方について600字程度で論じなさい。",
    type: "past",
    field: "科学技術",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "経済政策と社会課題の解決",
    description:
      "AOマルデス入試・課題レポート。現代社会が直面する経済課題について、その解決に向けた政策提言を含めて論述しなさい。1200字程度。",
    type: "past",
    wordLimit: 1200,
    field: "経済",
  },
  {
    id: "pq-seikei-mgmt-n2",
    universityId: "seikei-u",
    universityName: "成蹊大学",
    facultyName: "経営学部（AOマルデス入試）",
    year: 2024,
    theme: "企業の社会的責任と経営戦略",
    description:
      "AOマルデス入試・課題レポート。企業の社会的責任（CSR）が経営戦略に与える影響について、具体例を挙げながら論述しなさい。1200字程度。討論力審査のテーマにもなる。",
    type: "past",
    wordLimit: 1200,
    field: "経済",
  },
  ...
  {
    id: "pq-seijo-econ-n1",
    universityId: "seijo-u",
    universityName: "成城大学",
    facultyName: "経済学部（総合型選抜）",
    year: 2025,
    theme: "経済社会に関する課題の論述",
    description:
      "筆者は「経済の指標から幸福の指標への移行は、単なる尺度の置き換えではなく、社会が何を大切にするかの合意形成のプロセスでもある」と述べている。①筆者が挙げる乖離の原因を400字程度で整理した上で、②この主張を踏まえ、これからの経済政策が目指すべき方向についてあなたの考えを800字程度で論じなさい。（計1200字程度・90分）",
    type: "past",
    wordLimit: 1200,
    timeLimit: 90,
    field: "経済",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "長文課題文の読解と論述",
    description:
      "【設問1】筆者は「形式的な合法性を超えた、内容の正当性こそが法の本質である」と述べている。この主張を導いた歴史的経緯を含め、「法と道徳の関係」をめぐる二つの立場の主張と根拠を400字程度でまとめなさい。\n【設問2】筆者は「何を法によって守るべきか」という問いを法学の根本とし、法は「社会の道徳的合意の制度化」であると述べている。この主張を踏まえ、現代の新領域における立法で最も重視されるべき視点についてあなたの考えを600字程度で論じなさい。",
    type: "past",
    field: "法律",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    universityId: "seijo-u",
    universityName: "成城大学",
    facultyName: "社会イノベーション学部（総合型選抜）",
    year: 2025,
    theme: "『イノベーションの科学』に基づく論述",
    description:
      "総合型選抜。課題図書：清水洋『イノベーションの科学 創造する人・破壊される人』（2024年、中公新書）。課題図書の内容を踏まえた論述審査。試験中は課題図書を参照できない。",
    type: "past",
    field: "経済",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容や課題図書の内容を保証するものではありません。`,
  ...
  },
  {
    ...
    facultyName: "社会イノベーション学部（総合型選抜）",
    year: 2024,
    theme: "『入門開発経済学』に基づく論述",
    description:
      "総合型選抜。課題図書：山形辰史『入門開発経済学 グローバルな貧困削減と途上国が起こすイノベーション』（2023年、中公新書）。課題図書の内容を踏まえた論述審査。",
    type: "past",
    field: "経済",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容や課題図書の内容を保証するものではありません。`,
  ...
  },
  {
    ...
    facultyName: "社会イノベーション学部（総合型選抜）",
    year: 2022,
    theme: "『現代社会はどこに向かうか』に基づく論述",
    description:
      "総合型選抜。課題図書：見田宗介『現代社会はどこに向かうか─高原の見晴らしを切り開くこと』（2018年、岩波新書）。課題図書の内容を踏まえた論述審査。",
    type: "past",
    field: "社会",
...
※本サンプル課題文は練習用にAI生成されたものです。実際の出題内容や課題図書の内容を保証するものではありません。`,
  ...
  },
  {
    ...
    universityId: "seijo-u",
    universityName: "成城大学",
    facultyName: "文芸学部英文学科（総合型選抜）",
    year: 2025,
    theme: "英語資料の要約と意見提示",
    description:
      "総合型選抜。面接時に以下の英語資料を読み、要約と自分の意見を日本語600字程度で提示しなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 600,
    field: "国際",
  ...
  },
  {
    ...
    universityId: "seijo-u",
    universityName: "成城大学",
    facultyName: "文芸学部マスコミュニケーション学科（総合型選抜）",
    year: 2025,
    theme: "メディアに関するプレゼンテーション",
    description:
      "総合型選抜。5分間のプレゼンテーション後、10分間の質疑応答。メディアや情報に関するテーマについて論理的に発表する力を評価。",
    type: "past",
    field: "社会",
  },
  ...
  // ===== 明治学院大学 =====
  {
    id: "pq-meigaku-soc-n1",
    universityId: "meigaku-u",
    universityName: "明治学院大学",
    facultyName: "社会学部社会学科（自己推薦AO入試）",
    year: 2024,
    theme: "現代の人間関係",
    description:
      "筆者は「『人それぞれ』と言い合うことで距離を取りつつ、それでもなお誰かと深く関わるための新しい作法を、私たちはまだ十分に持っていない」と述べている。この指摘を踏まえ、現代における人間関係の新たな作法のあり方についてあなたの考えを論じなさい。",
    type: "past",
    field: "社会",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "科学と社会",
    description:
      "筆者は「最終的な判断は市民の側で下すという姿勢」が必要だと述べ、そのために「市民が科学的思考の基本を身につける努力」を求めている。この主張を踏まえ、科学と社会の望ましい関係を築くために市民に求められる態度について論じなさい。（600字以内）",
    type: "past",
    field: "社会",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "人種・民族という概念",
    description:
      "筆者は、人種・民族とは「フィクションだから捨てよと単純に主張できない」カテゴリーであり、「なぜこのような区分が生まれ、何を可能にし、何を傷つけてきたのかを学ぶ」歴史的眼差しが必要だと述べている。この主張を踏まえ、学校教育において人種・民族をどのように教えるべきか、あなたの考えを論じなさい。",
    type: "past",
    field: "社会",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-meigaku-welfare-n1",
    universityId: "meigaku-u",
    universityName: "明治学院大学",
    facultyName: "社会学部社会福祉学科（自己推薦AO入試）",
    year: 2024,
    theme: "障害を通して考える支え合い",
    description:
      "筆者は「互いに迷惑をかけ合いながら生きることを当然の前提とする発想の転換が必要である」と述べている。この主張に対して、あなた自身の経験や考えを踏まえ、障害のある人とない人がともに生きる社会において私たち一人ひとりに求められる姿勢を論じなさい。",
    type: "past",
    field: "社会",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "戦後の貧困",
    description:
      "筆者は「貧困は経済成長によって自動的に解消されるものではなく、社会保障制度や労働政策、家族のあり方と複雑に絡み合いながら形を変えてきた」と述べている。この主張を踏まえ、戦後日本における貧困の変容を整理した上で、現代の「見えない貧困」に対して社会としていかなる取り組みが必要かを論じなさい。",
    type: "past",
    field: "社会",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "摂食障害の文化人類学的分析",
    description:
      "筆者は「摂食障害を抱える人々は、社会が発する規範を誰よりも忠実に内面化した結果として、食べる行為を統御しようとしている」と述べている。この主張を踏まえ、摂食障害を抱える人を支えるために社会の側に求められる変化について論じなさい。",
    type: "past",
    field: "社会",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-meigaku-law-n1",
    universityId: "meigaku-u",
    universityName: "明治学院大学",
    facultyName: "法学部消費情報環境法学科（自己推薦AO入試）",
    year: 2024,
    theme: "デジタル政策と人権",
    description:
      "筆者は「『デジタル化』と『人権保障』は対立するものではなく、どちらも諦めない制度設計が問われている」と述べている。この主張を踏まえ、日本の行政デジタル化において人権を守るために必要な制度的工夫をあなたの考えとともに論じなさい。",
    type: "past",
    field: "法律",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "憲法とデータ保護",
    description:
      "筆者は「同意の取り方の透明化、利用目的の限定、独立した監督機関の設置、不利益処分を受けた市民の救済手続き――これらを欠いたまま利活用だけを進めることは、個人の尊厳を空洞化させる恐れがある」と述べている。この主張を踏まえ、データ保護と公共目的の利活用を両立させるための制度設計について、あなたの考えを論じなさい。",
    type: "past",
    field: "法律",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "AI兵器と国際法",
    description:
      "自己推薦AO入試。自律型致死兵器システム（LAWS）の国際法上の規制について、法的・倫理的観点から論述しなさい。",
    type: "past",
    field: "法律",
  },
  {
    id: "pq-meigaku-global-n1",
    universityId: "meigaku-u",
    universityName: "明治学院大学",
    facultyName: "法学部グローバル法学科（自己推薦AO入試）",
    year: 2024,
    theme: "リベラリズムの再考",
    description:
      "筆者は「『リベラル』を嫌悪することと、リベラリズムを捨てることは、まったく別のことである」と述べ、リベラリズムを「合意できない者同士が共に生きるための作法」と定義している。この主張を踏まえ、多様な価値観が並存する現代社会においてリベラリズムが果たすべき役割について、あなたの考えを論じなさい。",
    type: "past",
    field: "法律",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "地方鉄道と人口減少",
    description:
      "自己推薦AO入試。地方鉄道の存続問題と人口減少社会の関係について、法的・政策的観点から論述しなさい。",
    type: "past",
    field: "社会",
  },
  {
    id: "pq-meigaku-intl-n1",
    universityId: "meigaku-u",
    universityName: "明治学院大学",
    facultyName: "国際学部国際学科（自己推薦AO入試）",
    year: 2024,
    theme: "ジェンダーと社会",
    description:
      "筆者は「ジェンダー平等とは、女性が男性と同じ『正義の声』を獲得することだけではない。社会が『ケアの声』をも正当な公共的言語として迎え入れることでもあるはずだ」と述べている。この主張を踏まえ、社会のあり方についてあなたの考えを論じなさい。",
    type: "past",
    field: "国際",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "SDGsと教育",
    description:
      "自己推薦AO入試。持続可能な開発目標（SDGs）と教育の関係について、国際的な視点から論述しなさい。",
    type: "past",
    field: "国際",
  },
  {
    id: "pq-meigaku-intl-n3",
    universityId: "meigaku-u",
    universityName: "明治学院大学",
    facultyName: "国際学部国際学科（自己推薦AO入試）",
    year: 2022,
    theme: "海外留学と国際理解",
    description:
      "自己推薦AO入試。海外留学の経験が国際理解の深化にどのように寄与するか、具体的に論述しなさい。",
    type: "past",
    field: "国際",
  },
  {
    id: "pq-meigaku-psy-n1",
    universityId: "meigaku-u",
    universityName: "明治学院大学",
    facultyName: "心理学部心理学科（自己推薦AO入試）",
    year: 2024,
    theme: "Z世代の特徴",
    description:
      "自己推薦AO入試。Z世代の価値観やコミュニケーションの特徴について、心理学的観点から論述しなさい。",
    type: "past",
    field: "社会",
  },
  {
    id: "pq-meigaku-psy-n2",
    universityId: "meigaku-u",
    universityName: "明治学院大学",
    facultyName: "心理学部心理学科（自己推薦AO入試）",
    year: 2023,
    theme: "社会問題と心理学",
    description:
      "自己推薦AO入試。現代の社会問題を一つ取り上げ、心理学の視点からその要因と解決策を論述しなさい。",
    type: "past",
    field: "社会",
  },
  {
    id: "pq-meigaku-edu-n1",
    universityId: "meigaku-u",
    universityName: "明治学院大学",
    facultyName: "心理学部教育発達学科（自己推薦AO入試）",
    year: 2024,
    theme: "外国にルーツを持つ子どもの発達課題",
    description:
      "筆者は「評価の枠組みが日本語母語の子どもを暗黙の標準としているならば、その物差しは、最も支援を必要とする子どもたちを取りこぼし、誤った位置づけを与えかねない」と述べている。①この主張をAさんの事例に即して具体的に説明しなさい。②この主張を踏まえ、学校教育現場が外国にルーツを持つ子どもを適切に支援するために必要な取り組みを論じなさい。",
    type: "past",
    field: "教育",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "子どもの心理発達",
    description:
      "筆者は「タイパ・コスパの論理が子育てにまで及ぶなかで、子どもの宇宙の深さに耳を澄ますことを忘れていないか」と問いかけている。この主張を踏まえ、子どもの心理発達を支えるために大人や社会が果たすべき役割を論じなさい。（設問1は変更なし）",
    type: "past",
    field: "教育",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "臨床とことば",
    description:
      "筆者は「臨床家の言葉が果たす役割は、解釈を押し付けることでも、安直に共感を表明することでもない」と述べ、沈黙を共に保ち言葉をわずかに言い換えて返すことの意義を説く。この主張を踏まえ、教育・福祉・医療の現場で他者の言葉に向き合う際に求められる態度について、あなたの考えを論じなさい。（600字以内）",
    type: "past",
    field: "教育",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-meigaku-eng-n1",
    universityId: "meigaku-u",
    universityName: "明治学院大学",
    facultyName: "文学部英文学科（自己推薦AO入試）",
    year: 2024,
    theme: "人文科学と理系専攻の比較",
    description:
      "自己推薦AO入試。以下の英文を読み、人文科学と自然科学のアプローチの違いと相互補完性について日本語600字程度で論述しなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 600,
    field: "文化",
  ...
  },
  {
    ...
    theme: "人工知能（AI）の発展",
    description:
      "自己推薦AO入試。以下の英文を読み、AI が人間の労働に及ぼす影響について日本語600字程度で論述しなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 600,
    field: "科学技術",
  ...
  },
  {
    ...
    theme: "電子書籍と紙書籍の比較",
    description:
      "自己推薦AO入試。以下の英文を読み、デジタル時代における読書文化のあり方について日本語600字程度で論述しなさい。※サンプル英文は練習用に生成されたものです。",
    type: "past",
    questionType: "english-reading",
    wordLimit: 600,
    field: "文化",
  ...
  // ===== 獨協大学 =====
  {
    id: "pq-dokkyo-foreign-n1",
    universityId: "dokkyo-u",
    universityName: "獨協大学",
    facultyName: "外国語学部（総合型選抜・自己推薦入試）",
    year: 2025,
    theme: "TikTokアプリ禁止の是非",
    description:
      "総合型選抜。「TikTokアプリを禁止すべき」との主張について、あなたの考えを述べなさい。課題文型小論文。",
    type: "past",
    field: "社会",
  },
  {
    id: "pq-dokkyo-foreign-n2",
    universityId: "dokkyo-u",
    universityName: "獨協大学",
    facultyName: "外国語学部（総合型選抜・自己推薦入試）",
    year: 2024,
    theme: "オンライン上の言論空間のあるべき姿",
    description:
      "総合型選抜。オンライン上の言論空間のあるべき姿について、あなたの考えを論述しなさい。課題文型小論文。",
    type: "past",
    field: "社会",
  },
  {
    id: "pq-dokkyo-foreign-n3",
    universityId: "dokkyo-u",
    universityName: "獨協大学",
    facultyName: "外国語学部（総合型選抜・自己推薦入試）",
    year: 2023,
    theme: "「利他」についての考察",
    description:
      "総合型選抜。「利他」という概念について、あなたの考えを論述しなさい。課題文型小論文。",
    type: "past",
    field: "社会",
  },
  {
    id: "pq-dokkyo-intl-n1",
    universityId: "dokkyo-u",
    universityName: "獨協大学",
    facultyName: "国際教養学部（総合型選抜）",
    year: 2025,
    theme: "外国人バッシングとヘイトスピーチへの対処",
    description:
      "総合型選抜。外国人バッシングやヘイトスピーチの要因を考察し、その対処法について論述しなさい。テーマ型小論文。",
    type: "past",
    field: "国際",
  },
  {
    id: "pq-dokkyo-intl-n2",
    universityId: "dokkyo-u",
    universityName: "獨協大学",
    facultyName: "国際教養学部（総合型選抜）",
    year: 2024,
    theme: "地域における多文化共生の実現",
    description:
      "総合型選抜。地域における多文化共生の実現状況について、あなたの考えを論述しなさい。テーマ型小論文。",
    type: "past",
    field: "国際",
  },
  {
    id: "pq-dokkyo-intl-n3",
    universityId: "dokkyo-u",
    universityName: "獨協大学",
    facultyName: "国際教養学部（総合型選抜）",
    year: 2023,
    theme: "愛情の深さを数値で表すことの可能性",
    description:
      "総合型選抜。愛情の深さを数値で表すことは可能かについて、あなたの考えを論述しなさい。テーマ型小論文。",
    type: "past",
    field: "社会",
  },
  {
    id: "pq-dokkyo-econ-n1",
    universityId: "dokkyo-u",
    universityName: "獨協大学",
    facultyName: "経済学部（総合型選抜）",
    year: 2025,
    theme: "世界的な食糧問題の要因と因果関係",
    description:
      "総合型選抜。世界的な食糧問題の要因とその因果関係について論述しなさい。テーマ型小論文。",
    type: "past",
    field: "経済",
  },
  {
    id: "pq-dokkyo-econ-n2",
    universityId: "dokkyo-u",
    universityName: "獨協大学",
    facultyName: "経済学部（総合型選抜）",
    year: 2024,
    theme: "観光地活性化における外資系企業誘致の是非",
    description:
      "総合型選抜。観光地の活性化における外資系企業誘致の是非について論述しなさい。テーマ型小論文。",
    type: "past",
    field: "経済",
  },
  {
    id: "pq-dokkyo-econ-n3",
    universityId: "dokkyo-u",
    universityName: "獨協大学",
    facultyName: "経済学部（総合型選抜）",
    year: 2023,
    theme: "財・サービスの値上げの背景と理由",
    description:
      "総合型選抜。財・サービスの値上げをもたらした背景と理由について論述しなさい。テーマ型小論文。",
    type: "past",
    field: "経済",
  },
  {
    ...
    universityId: "dokkyo-u",
    universityName: "獨協大学",
    facultyName: "法学部（総合型選抜・自己推薦入試）",
    year: 2025,
    theme: "地方自治法改正案",
    description:
      "総合型選抜。地方自治法改正案に関する課題文を読み、あなたの考えを論述しなさい。課題文型小論文。",
    type: "past",
    field: "法律",
  },
  {
    ...
    theme: "ネット上の誹謗中傷と法規制",
    description:
      "総合型選抜。ネット上の誹謗中傷に関する社説を読み、あなたの考えを論述しなさい。課題文型小論文。",
    type: "past",
    field: "法律",
  },
  {
    ...
    theme: "侮辱罪の厳罰化",
    description:
      "総合型選抜。侮辱罪の厳罰化に関する課題文を読み、あなたの考えを論述しなさい。課題文型小論文。",
    type: "past",
    field: "法律",
  },
  ...
  // ===== 國學院大學 =====
  {
    id: "pq-kokugakuin-lit-jpn-n1",
    universityId: "kokugakuin-u",
    universityName: "國學院大學",
    facultyName: "文学部日本文学科（公募制自己推薦AO型）",
    year: 2024,
    theme: "古文読解に基づく論述",
    description:
      "筆者は「古典を読むとは、現在の自分のまなざしを点検し、見落としていた世界のあり方を取り戻す営みでもある」と述べている。この主張を踏まえ、あなた自身が古典文学（または他の古典的作品・文化）と関わった経験を挙げながら、現代において古典を学ぶ意義についてあなたの考えを1000字程度で論じなさい。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "文化",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-kokugakuin-lit-hist-n1",
    universityId: "kokugakuin-u",
    universityName: "國學院大學",
    facultyName: "文学部史学科（公募制自己推薦AO型）",
    year: 2024,
    theme: "歴史資料の読解と論述",
    description:
      "筆者は「史料の『沈黙』もまた、歴史的な事実である。なぜその沈黙が生じたのかを問うことで、当時の社会の構造が立ち現れる」と述べている。この主張を踏まえ、自分の関心のある時代や地域を例に挙げながら、史料の「沈黙」に向き合う営みについて2000字程度で論述しなさい。",
    type: "past",
    wordLimit: 2000,
    field: "文化",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-kokugakuin-lit-phil-n1",
    universityId: "kokugakuin-u",
    universityName: "國學院大學",
    facultyName: "文学部哲学科（公募制自己推薦AO型）",
    year: 2024,
    theme: "課題図書に基づく哲学的論述",
    description:
      "筆者は「『私』は一つの完成した実体ではなく、絶えず生成し続ける過程である」と述べている。(設問1)この主張に至るまでの、近代哲学と現代哲学・心理学それぞれの「私」の捉え方を整理しなさい。(設問2)筆者の主張を踏まえ、「私とは何か」についてあなた自身の考えを論述しなさい。1000字程度、90分。",
    type: "past",
    wordLimit: 1000,
    timeLimit: 90,
    field: "文化",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-kokugakuin-econ-n1",
    universityId: "kokugakuin-u",
    universityName: "國學院大學",
    facultyName: "経済学部（公募制自己推薦AO型）",
    year: 2024,
    theme: "経済・経営に関する文章読解と論述",
    description:
      "筆者は、商店街の再生において「地域における消費とつながりの場を、誰がどう設計し、どう維持するか」が本質的な問いだと述べ、補助金依存や観光特化型の失敗例も挙げている。この指摘を踏まえ、あなたが地方都市の自治体職員だとすれば、中心商店街の再生に向けてどのような政策を提案するか、1000〜1500字で論述しなさい。（90分）",
    type: "past",
    wordLimit: 1500,
    timeLimit: 90,
    field: "経済",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  },
  {
    ...
    theme: "経済データの分析と課題提起",
    description:
      "筆者は「短期的な所得格差が、長期的な機会格差へと転化していく」と述べ、データに表れないリスクとして次世代の階層固定化を挙げている。この主張を踏まえ、提示されたデータが示す経済課題の中でどの問題に政策として優先的に取り組むべきか、その理由とともに具体的な政策の方向性を1000〜1500字で論述しなさい。",
    type: "past",
    wordLimit: 1500,
    timeLimit: 90,
    field: "経済",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-kokugakuin-law-n1",
    universityId: "kokugakuin-u",
    universityName: "國學院大學",
    facultyName: "法学部法律専門職専攻（公募制自己推薦AO型）",
    year: 2024,
    theme: "法律に関する実用的文章の読解と論述",
    description:
      "筆者は「説明できない法的判断は信頼を得られない」と述べ、法的思考には論理と説明責任の両方が不可欠だと主張している。この主張を踏まえ、法律専門職を志す者として、あなた自身の経験や考えと結びつけながら、法律実務において「説明する力」がなぜ重要かを論述しなさい。",
    type: "past",
    field: "法律",
...
※本サンプル課題文は練習用に AI 生成されたものです。実際の出題内容を保証するものではありません。`,
  ...
  {
    id: "pq-kokugakuin-law-n2",
    universityId: "kokugakuin-u",
    universityName: "國學院大學",
    facultyName: "法学部（公募制自己推薦AO型）",
    year: 2023,
    theme: "現代社会の法的課題と市民の権利",
    description:
      "公募制自己推薦（AO型）。現代社会における法的課題について、市民の権利保障の観点から論述しなさい。",
    type: "past",
    field: "法律",
  },
  {
    id: "pq-kokugakuin-tourism-n1",
    universityId: "kokugakuin-u",
    universityName: "國學院大學",
    facultyName: "観光まちづくり学部（総合型選抜）",
    year: 2024,
    theme: "地域分析と課題解決策の提案",
    description:
      "総合型選抜。地域分析レポート（1200字以内）を提出し、地域の課題に対する解決策を提案シートにまとめる。地域理解力と企画力を評価。",
    type: "past",
    wordLimit: 1200,
    field: "社会",
  },
  {
    id: "pq-kokugakuin-shinto-n1",
    universityId: "kokugakuin-u",
    universityName: "國學院大學",
    facultyName: "神道文化学部（公募制自己推薦AO型）",
    year: 2024,
    theme: "日本の伝統文化と現代社会",
    description:
      "公募制自己推薦（AO型）。日本の伝統文化・神道文化が現代社会において果たす役割について論述しなさい。",
    type: "past",
    field: "文化",
  },
  ...
  // ===== 武蔵大学 =====
  {
    id: "pq-musashi-econ-n1",
    universityId: "musashi-u",
    universityName: "武蔵大学",
    facultyName: "経済学部（総合型選抜）",
    year: 2024,
    theme: "経済・時事問題に関する総合問題",
    description:
      "総合型選抜。二次選考で筆記試験（総合問題：基礎学力）80分と面接。経済や時事問題に関するテーマが出題される。",
    type: "past",
    timeLimit: 80,
    field: "経済",
  },
  {
    id: "pq-musashi-econ-n2",
    universityId: "musashi-u",
    universityName: "武蔵大学",
    facultyName: "経済学部（総合型選抜）",
    year: 2023,
    theme: "日本経済の課題と持続的成長",
    description:
      "総合型選抜。日本経済が直面する課題を取り上げ、持続的成長に向けた方策について論述しなさい。800字程度。",
    type: "past",
    wordLimit: 800,
    field: "経済",
  },
  {
    id: "pq-musashi-human-n1",
    universityId: "musashi-u",
    universityName: "武蔵大学",
    facultyName: "人文学部（総合型選抜）",
    year: 2024,
    theme: "文化・歴史・社会に関する小論文",
    description:
      "総合型選抜。二次選考で筆記試験（小論文含む）90分と面接。各学科が研究対象としている地域の文化・歴史・社会に関するテーマが出題される。",
    type: "past",
    timeLimit: 90,
    field: "文化",
  },
  {
    id: "pq-musashi-human-n2",
    universityId: "musashi-u",
    universityName: "武蔵大学",
    facultyName: "人文学部（総合型選抜）",
    year: 2023,
    theme: "異文化理解と地域研究",
    description:
      "総合型選抜。新聞記事や入門書を題材に、異文化理解や地域の文化・歴史について自分の考えを800字程度にまとめなさい。",
    type: "past",
    wordLimit: 800,
    field: "文化",
  },
  {
    id: "pq-musashi-soc-n1",
    universityId: "musashi-u",
    universityName: "武蔵大学",
    facultyName: "社会学部（総合型選抜）",
    year: 2024,
    theme: "社会情勢・文化に関する小論文",
    description:
      "総合型選抜。二次選考で筆記試験（小論文）80分と面接。社会情勢や文化に関するテーマについて論述。800字程度。",
    type: "past",
    wordLimit: 800,
    timeLimit: 80,
    field: "社会",
  ...
  {
    id: "pq-musashi-soc-n2",
    universityId: "musashi-u",
    universityName: "武蔵大学",
    facultyName: "社会学部（総合型選抜・ゼミ力重視方式）",
    year: 2023,
    theme: "現代社会の課題と市民の役割",
    description:
      "総合型選抜（ゼミ力重視方式・専願）。新聞の社説や記事の内容を要約し、現代社会の課題と市民の役割について自分の考えを800字程度にまとめなさい。",
    type: "past",
    wordLimit: 800,
    field: "社会",
  },
  {
    id: "pq-musashi-intl-n1",
    universityId: "musashi-u",
    universityName: "武蔵大学",
    facultyName: "国際教養学部（総合型選抜）",
    year: 2024,
    theme: "国際社会の課題と多文化共生",
    description:
      "総合型選抜。二次選考で筆記試験と面接。グローバルな社会課題や多文化共生に関するテーマが出題される。テーマは毎年変更。",
    type: "past",
    field: "国際",
  },
  {
    id: "pq-musashi-intl-n2",
    universityId: "musashi-u",
    universityName: "武蔵大学",
    facultyName: "国際教養学部（総合型選抜）",
    year: 2023,
    theme: "グローバル化と地域アイデンティティ",
    description:
      "総合型選抜。グローバル化が進む中での地域文化やアイデンティティの保持について論述しなさい。",
    type: "past",
    field: "国際",
  },
  ...
  {
    id: "pq-hokkaido-pharm-f1",
    universityId: "hokkaido-u",
    universityName: "北海道大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "創薬研究の意義と研究者の責任",
    description:
      "新しい薬を生み出す創薬研究が社会において果たす役割を説明したうえで、研究者が負うべき責任について、あなたの考えを800字以内で述べなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "薬学",
  ...
  {
    id: "pq-hokkaido-pharm-f2",
    universityId: "hokkaido-u",
    universityName: "北海道大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "薬剤耐性菌と抗菌薬の適正使用",
    description:
      "薬剤耐性菌の出現が世界的な問題となっている理由を説明し、抗菌薬の適正使用を進めるために医療者と社会が取り組むべきことを800字以内で論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "薬学",
  ...
  {
    id: "pq-tohoku-pharm-f1",
    universityId: "tohoku-u",
    universityName: "東北大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "災害時における医薬品の供給と薬剤師",
    description:
      "大規模災害の発生時に医薬品を必要な人へ届けるうえでどのような困難が生じるかを整理し、薬剤師が果たしうる役割について800字以内で論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "薬学",
  ...
  {
    id: "pq-tohoku-pharm-f2",
    universityId: "tohoku-u",
    universityName: "東北大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "研究者としての薬剤師の可能性",
    description:
      "薬学部を卒業した人材が研究職として社会に貢献する道について、臨床現場で働く薬剤師との違いを踏まえながら、あなたの考えを800字以内で述べなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "薬学",
  },
  {
    ...
    theme: "チーム医療のなかの薬剤師",
    description:
      "医師・看護師など他の医療専門職と協働するチーム医療において、薬剤師が担うべき固有の役割は何か。具体例を挙げて800字以内で論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "薬学",
  ...
  {
    id: "pq-chiba-pharm-f2",
    universityId: "chiba-u",
    universityName: "千葉大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "医薬品の承認審査とレギュラトリーサイエンス",
    description:
      "医薬品が承認されるまでに有効性と安全性がどのように評価されるかを説明し、迅速な承認と慎重な審査の両立について、あなたの考えを800字以内で述べなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "薬学",
  ...
  {
    id: "pq-nagoyacu-pharm-f1",
    universityId: "nagoya-cu",
    universityName: "名古屋市立大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "地域包括ケアと薬局の機能",
    description:
      "住み慣れた地域で暮らし続けるための地域包括ケアシステムにおいて、薬局と薬剤師に期待される機能について800字以内で論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "薬学",
  ...
  {
    id: "pq-nagoyacu-pharm-f2",
    universityId: "nagoya-cu",
    universityName: "名古屋市立大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "超高齢社会における在宅医療と服薬管理",
    description:
      "在宅で療養する高齢者の服薬管理にはどのような課題があるか。薬剤師が訪問して行える支援を含めて、800字以内であなたの考えを述べなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "薬学",
  ...
  {
    id: "pq-okayama-pharm-f1",
    universityId: "okayama-u",
    universityName: "岡山大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "個別化医療と薬物療法の最適化",
    description:
      "患者一人ひとりの体質や遺伝情報に応じて薬を選ぶ個別化医療について、その意義と課題を整理し、800字以内で論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "薬学",
  ...
  {
    id: "pq-okayama-pharm-f2",
    universityId: "okayama-u",
    universityName: "岡山大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "実診療データの活用と医薬品の評価",
    description:
      "日常の診療で蓄積されるデータを医薬品の有効性・安全性の評価に用いることの利点と、扱ううえで注意すべき点を800字以内で述べなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "薬学",
  },
  {
    ...
    theme: "ワクチンと公衆衛生",
    description:
      "ワクチンが感染症対策において果たしてきた役割を説明したうえで、接種をためらう人々に対して医療者はどのように向き合うべきか、800字以内で論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "薬学",
  },
  {
    ...
    theme: "世界の医薬品アクセス格差",
    description:
      "必要な医薬品が届かない地域が存在する理由を、価格・特許・流通の観点から分析し、格差を縮めるために何ができるかを800字以内で論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "薬学",
  },
  {
    ...
    theme: "人工知能を用いた創薬の展望",
    description:
      "人工知能の活用によって創薬研究がどのように変わりうるかを説明し、それでも人間の研究者が担い続ける役割について800字以内で述べなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "薬学",
  ...
  {
    id: "pq-kyushu-pharm-f2",
    universityId: "kyushu-u",
    universityName: "九州大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "再生医療等製品と新しい治療の実用化",
    description:
      "細胞や遺伝子を用いた新しい治療法について、従来の医薬品と異なる点を整理し、実用化にあたっての課題を800字以内で論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "薬学",
  ...
  {
    id: "pq-kumamoto-pharm-f1",
    universityId: "kumamoto-u",
    universityName: "熊本大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "薬害の教訓と医薬品の安全性確保",
    description:
      "過去に起きた薬害から医薬品の安全性確保のために何を学ぶべきか。再発を防ぐ仕組みに触れながら800字以内で論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "薬学",
  ...
  {
    id: "pq-kumamoto-pharm-f2",
    universityId: "kumamoto-u",
    universityName: "熊本大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "臨床試験における被験者の保護",
    description:
      "新薬の開発に不可欠な臨床試験において、被験者の人権と安全を守るために必要な配慮とは何か、800字以内であなたの考えを述べなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "薬学",
  ...
  {
    id: "pq-nagasaki-pharm-f1",
    universityId: "nagasaki-u",
    universityName: "長崎大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "国際保健と感染症対策への貢献",
    description:
      "感染症の流行が国境を越えて広がる現代において、日本の薬学研究や医療が国際社会に果たしうる貢献について800字以内で論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "薬学",
  ...
  {
    id: "pq-nagasaki-pharm-f2",
    universityId: "nagasaki-u",
    universityName: "長崎大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "新興感染症への備えと医薬品開発",
    description:
      "新たな感染症の出現に備えて、治療薬やワクチンの開発・備蓄・供給の体制をどのように整えるべきか、800字以内で述べなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "薬学",
  },
  {
    ...
    theme: "基礎研究が新薬を生むまで",
    description:
      "基礎的な科学研究の成果が実際の医薬品として患者に届くまでにはどのような過程があるか。その過程で生じる困難を含めて800字以内で論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "薬学",
  },
  {
    ...
    theme: "薬剤師に求められる資質",
    description:
      "これからの社会で薬剤師に求められる資質とは何か。あなたがそう考える理由とともに、800字以内で述べなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 60,
    field: "薬学",
  ...
  {
    id: "pq-teikyo-pharm-f1",
    universityId: "teikyo-u",
    universityName: "帝京大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "医療チームの一員としての薬剤師",
    description:
      "医療現場で薬剤師が他職種と連携して働くうえで大切にすべきことは何か。具体的な場面を想定して800字以内で述べなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 60,
    field: "薬学",
  ...
  {
    id: "pq-showa-pharm-f1",
    universityId: "showa-med-u",
    universityName: "昭和医科大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "患者との対話と信頼関係",
    description:
      "薬剤師が患者と信頼関係を築くために必要なことは何か。服薬指導の場面を例に挙げながら800字以内で論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 60,
    field: "薬学",
  },
  {
    ...
    theme: "副作用情報をどう伝えるか",
    description:
      "医薬品の副作用に関する情報を患者に伝える際、不安をあおらずに正しく理解してもらうにはどのような工夫が必要か、800字以内で述べなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 60,
    field: "薬学",
  ...
  {
    id: "pq-musashino-pharm-f1",
    universityId: "musashino-u",
    universityName: "武蔵野大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "セルフメディケーションと薬剤師の関与",
    description:
      "市販薬を用いて自分で健康管理を行うセルフメディケーションについて、その利点と危険性を整理し、薬剤師が関わる意義を800字以内で論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 60,
    field: "薬学",
  ...
  {
    id: "pq-juntendo-pharm-f1",
    universityId: "juntendo-u",
    universityName: "順天堂大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "健康寿命の延伸に薬学ができること",
    description:
      "平均寿命と健康寿命の差を縮めるために、薬学を学んだ人材はどのような貢献ができるか。予防の観点を含めて800字以内で論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 60,
    field: "薬学",
  ...
  {
    id: "pq-meijo-pharm-f1",
    universityId: "meijo-u",
    universityName: "名城大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "後発医薬品の使用と医療費",
    description:
      "後発医薬品の使用が推進される理由を説明したうえで、患者が安心して使えるようにするために必要なことを800字以内で述べなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 60,
    field: "薬学",
  },
  {
    id: "pq-agu-pharm-f1",
    universityId: "agu",
    universityName: "愛知学院大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "これからの薬局の役割",
    description:
      "処方箋にもとづく調剤だけでなく、地域の健康を支える拠点として薬局に期待される役割について、800字以内であなたの考えを述べなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 60,
    field: "薬学",
  ...
  {
    id: "pq-kinjo-pharm-f1",
    universityId: "kinjo-u",
    universityName: "金城学院大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "薬を飲み続けられない患者への支援",
    description:
      "処方された薬を患者が続けられなくなる要因を挙げ、薬剤師としてどのような支援ができるかを800字以内で具体的に述べなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 60,
    field: "薬学",
  ...
  {
    id: "pq-ritsumeikan-pharm-f1",
    universityId: "ritsumeikan-u",
    universityName: "立命館大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "医療のデジタル化と薬剤師の仕事",
    description:
      "電子処方箋やオンライン服薬指導など医療のデジタル化が進むなかで、薬剤師の仕事はどう変わるべきか。800字以内で論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "薬学",
  },
  {
    ...
    theme: "がん薬物療法を支える薬剤師",
    description:
      "がんの薬物療法において副作用を管理し治療の継続を支えるために、薬剤師が果たせる役割について800字以内で論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 90,
    field: "薬学",
  ...
  {
    id: "pq-setsunan-pharm-f1",
    universityId: "setsunan-u",
    universityName: "摂南大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "高齢者の多剤併用をどう減らすか",
    description:
      "高齢の患者が多くの薬を服用することで生じる問題を整理し、薬剤師がどのように関わるべきかを800字以内で述べなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 60,
    field: "薬学",
  ...
  {
    id: "pq-kobegakuin-pharm-f1",
    universityId: "kobe-gakuin-u",
    universityName: "神戸学院大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "医薬分業の意義を問い直す",
    description:
      "医師の処方と薬剤師の調剤を分ける医薬分業について、その目的と現在指摘されている課題を整理し、800字以内であなたの考えを述べなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 60,
    field: "薬学",
  ...
  {
    id: "pq-hyogomed-pharm-f1",
    universityId: "hyogo-med-u",
    universityName: "兵庫医科大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "緩和ケアにおける薬物療法",
    description:
      "終末期の患者の苦痛を和らげる緩和ケアについて、薬物療法の意義と、薬剤師が関わる際に大切にすべきことを800字以内で論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 60,
    field: "薬学",
  ...
  {
    id: "pq-fukuoka-pharm-f1",
    universityId: "fukuoka-u",
    universityName: "福岡大学",
    facultyName: "薬学部",
    year: 2025,
    theme: "医薬品の安定供給という課題",
    description:
      "医薬品の供給が滞ると医療現場や患者にどのような影響が生じるかを説明し、安定供給のために必要な取り組みを800字以内で論じなさい。",
    type: "frequent",
    wordLimit: 800,
    timeLimit: 60,
    field: "薬学",
...
export function isActionableQuestion(pq: PastQuestion): boolean {
  const jp =
    /論じ|述べ|分析し|提案[しをす]|提案を行[いう]|考察し|説明し|答え[なる]|書き|記述|論述|読み|読んで|議論|執筆|字以?内|字で|なさい/;
...
export function getPastQuestionsByUniversity(
  universityId: string
): PastQuestion[] {
  return PAST_QUESTIONS.filter(
    (pq) => pq.universityId === universityId || pq.universityId === ""
  );
}
...
export function needsSourceText(q: PastQuestion): boolean {
  ...
  if (
    q.questionType === "english-reading" ||
    q.questionType === "data-analysis" ||
...
export function getEnrichedPastQuestionById(
  id: string
