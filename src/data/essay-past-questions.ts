...
export const PAST_QUESTIONS: PastQuestion[] = [
  ...
  { id: "pq-hiroshima-igs-1", universityId: "hiroshima-u", universityName: "広島大学", facultyName: "総合科学部 国際共創学科（IGS国内選抜型）", year: 2024, theme: "Globalization and Local Identity", description: "IGS国内選抜型。英語によるエッセイ。グローバル化が地域のアイデンティティに与える影響について英語で論述しなさい。", type: "past", questionType: "english-reading", wordLimit: 600, timeLimit: 90, field: "国際" },
  ...
  // ===== 東京都立大学 =====
  { id: "pq-tmu-hum-1", universityId: "tmu", universityName: "東京都立大学", facultyName: "人文社会学部（ゼミナール入試・総合型選抜）", year: 2024, theme: "ゼミナール受講後レポート：社会と個人の関係", description: "ゼミナール入試。大学教員による講義・演習を受講後、社会と個人の関係性についてレポートを作成。グループワーク・プレゼンテーションも評価対象。", type: "past", questionType: "lecture", wordLimit: 800, timeLimit: 90, field: "社会" },
  ...
  { id: "pq-tmu-global-1", universityId: "tmu", universityName: "東京都立大学", facultyName: "人文社会学部（グローバル人材育成入試）", year: 2023, theme: "Global Citizenship and Local Responsibility", description: "グローバル人材育成入試（英検準1級程度必要）。グローバル市民としての責任と地域社会への貢献について英語と日本語で論述しなさい。", type: "past", questionType: "english-reading", wordLimit: 800, timeLimit: 90, field: "国際" },
