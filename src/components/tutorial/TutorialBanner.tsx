  ...
  return (
    <div className="sticky top-0 z-50 border-b bg-amber-50 dark:bg-amber-950/30 backdrop-blur">
      <div className="flex items-center justify-between px-4 py-2 text-sm">
        <div className="flex min-w-0 items-center gap-2 font-medium text-amber-900 dark:text-amber-200">
        ...
        <button
          type="button"
          onClick={handleExit}
          className="inline-flex shrink-0 items-center gap-1 whitespace-nowrap rounded-md px-2 py-1 text-amber-900 hover:bg-amber-100 dark:text-amber-200 dark:hover:bg-amber-900/40"
        >
