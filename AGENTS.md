...
- AI: Codex API (添削・面接) + OpenAI TTS/Whisper (音声面接)
...
## 7. Common Pitfalls
- Codex Vision APIのOCR精度: 手書きの崩し字は誤認識しやすい → 生徒に確認ステップ必須
...
- Phase 2A: AI模擬面接（型定義+API+プロンプト）完了
  ...
  - /api/interview/message: Codex APIでチャット応答
...
- 1C-3. Codex Vision API OCR連携（/api/essay/upload）
- 1C-4. OCR確認・修正画面
